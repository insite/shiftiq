...
public class SubrouteInheritancePermissionFlowTests
{
    ...
    public void MultipleChildren_AllInheritFromParent()
    {
        // Scenario from RouteSettings.json Rule 1:
        // Parent: "client/admin/records/gradebooks/*"
        // Children: ["api/progress/gradebooks/*", "api/progress/achievements/*", "api/events/*"]
        ...
        Assert.True(permissions.IsAllowedByRoute("api/events/retrieve", "Admin", DataAccess.Read));
    }
...
public class SubrouteRouteRegistrationTests
{
    ...
    {
        // From RouteSettings.json Rule 2:
        // Children: ["api/progress/gradebooks/retrieve", "api/progress/achievements/retrieve", "api/events/retrieve"]
        ...
        Assert.Contains("api/events/retrieve", routeUrls);
    }
