...
internal static class TestInitializer
{
    ...
    private static void CreateDatabaseObjects()
    {
        ...
        var scriptPath = Path.Combine(AppContext.BaseDirectory, "Schemas", "CreateDatabaseObjects.sql");
    ...
    {
        var scriptsPath = Path.Combine(AppContext.BaseDirectory, "Schemas", "Upgrades", "Scripts");
