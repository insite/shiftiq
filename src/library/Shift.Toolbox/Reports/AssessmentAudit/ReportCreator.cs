...
using PerformanceAreaScoreResult = Shift.Toolbox.Reports.PerformanceReport.Models.AreaScoreResult;
using PerformanceReportCreator = Shift.Toolbox.Reports.PerformanceReport.ReportCreator;
...
namespace Shift.Toolbox.Reports.AssessmentAudit
{
