...
public class QAchievementConfiguration : IEntityTypeConfiguration<QAchievementEntity>
{
    public void Configure(EntityTypeBuilder<QAchievementEntity> builder)
    {
        ...
        builder.Property(x => x.AchievementDescription).HasColumnName("AchievementDescription").IsUnicode(false);
