...
public class StandardAdapter : IEntityAdapter
{
    public void Copy(ModifyStandard modify, StandardEntity entity)
    {
        ...
        entity.BankIdentifier = modify.BankId;
        entity.BankSetIdentifier = modify.BankSetId;
        entity.CalculationArgument = modify.CalculationArgument;
        entity.CanvasIdentifier = modify.CanvasIdentifier;
        entity.CategoryItemIdentifier = modify.CategoryItemId;
        ...
        entity.DepartmentGroupIdentifier = modify.DepartmentGroupId;
        ...
        entity.ParentStandardIdentifier = modify.ParentStandardId;
    ...
    public StandardEntity ToEntity(CreateStandard create)
    {
        var entity = new StandardEntity
        {
            ...
            BankIdentifier = create.BankId,
            BankSetIdentifier = create.BankSetId,
            CalculationArgument = create.CalculationArgument,
            CanvasIdentifier = create.CanvasIdentifier,
            CategoryItemIdentifier = create.CategoryItemId,
            ...
            DepartmentGroupIdentifier = create.DepartmentGroupId,
