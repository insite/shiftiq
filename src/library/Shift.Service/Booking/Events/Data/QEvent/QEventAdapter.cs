...
public class QEventAdapter : IEntityAdapter
{
    public void Copy(ModifyEvent modify, QEventEntity entity)
    {
    ...
    public string Serialize(IEnumerable<EventModel> models, string format)
    {
        ...
        if (format.ToLower() == "csv")
        {
            ...
            var properties = typeof(EventModel)
    ...
    public QEventEntity ToEntity(CreateEvent create)
    {
        var entity = new QEventEntity
        {
    ...
    public IEnumerable<EventModel> ToModel(IEnumerable<QEventEntity> entities)
    {
        return entities.Select(ToModel);
    }

    public EventModel ToModel(QEventEntity entity)
    {
    ...
    public IEnumerable<EventMatch> ToMatch(IEnumerable<QEventEntity> entities)
    {
        return entities.Select(ToMatch);
    }

    public EventMatch ToMatch(QEventEntity entity)
    {
