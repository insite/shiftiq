...
public class QEventWriter : IEntityWriter
{
    private readonly IDbContextFactory<TableDbContext> _context;

    public QEventWriter(IDbContextFactory<TableDbContext> context)
    {
        _context = context;
    }

    public async Task<bool> CreateAsync(QEventEntity entity, CancellationToken cancellation = default)
    {
    ...
    public async Task<bool> ModifyAsync(QEventEntity entity, CancellationToken cancellation = default)
    {
        using var db = _context.CreateDbContext();
