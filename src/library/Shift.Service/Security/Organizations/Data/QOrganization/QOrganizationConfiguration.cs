...
public class QOrganizationConfiguration : IEntityTypeConfiguration<QOrganizationEntity>
{
    public void Configure(EntityTypeBuilder<QOrganizationEntity> builder) 
    {
        ...
        builder.HasKey(x => new { x.OrganizationIdentifier });
            ...
            builder.Property(x => x.CompanySummary).HasColumnName("CompanySummary").IsUnicode(false);
            ...
            builder.Property(x => x.OrganizationData).HasColumnName("OrganizationData").IsRequired().IsUnicode(false);
