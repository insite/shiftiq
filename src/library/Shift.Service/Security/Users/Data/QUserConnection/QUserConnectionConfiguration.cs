...
public class QUserConnectionConfiguration : IEntityTypeConfiguration<QUserConnectionEntity>
{
    public void Configure(EntityTypeBuilder<QUserConnectionEntity> builder) 
    {
