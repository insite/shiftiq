...
public class QUserConnectionWriter : IEntityWriter
{
    private readonly IDbContextFactory<TableDbContext> _context;

    public QUserConnectionWriter(IDbContextFactory<TableDbContext> context)
    {
        _context = context;
    }

    public async Task<bool> CreateAsync(QUserConnectionEntity entity, CancellationToken cancellation = default)
    {
    ...
    public async Task<bool> ModifyAsync(QUserConnectionEntity entity, CancellationToken cancellation = default)
    {
        using var db = _context.CreateDbContext();
