...
public class QUserWriter : IEntityWriter
{
    private readonly IDbContextFactory<TableDbContext> _context;

    public QUserWriter(IDbContextFactory<TableDbContext> context)
    {
        _context = context;
    }

    public async Task<bool> CreateAsync(QUserEntity entity, CancellationToken cancellation = default)
    {
    ...
    public async Task<bool> ModifyAsync(QUserEntity entity, CancellationToken cancellation = default)
    {
        using var db = _context.CreateDbContext();
