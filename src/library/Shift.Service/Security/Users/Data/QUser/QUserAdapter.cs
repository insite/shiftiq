...
public class QUserAdapter : IEntityAdapter
{
    public void Copy(ModifyUser modify, QUserEntity entity)
    {
    ...
    public QUserEntity ToEntity(CreateUser create)
    {
        var entity = new QUserEntity
        {
    ...
    public IEnumerable<UserModel> ToModel(IEnumerable<QUserEntity> entities)
    {
        return entities.Select(ToModel);
    }

    public UserModel ToModel(QUserEntity entity)
    {
    ...
    public IEnumerable<UserMatch> ToMatch(IEnumerable<QUserEntity> entities)
    {
        return entities.Select(ToMatch);
    }

    public UserMatch ToMatch(QUserEntity entity)
    {
