...
public class PersonConfiguration : IEntityTypeConfiguration<PersonEntity>
{
    public void Configure(EntityTypeBuilder<PersonEntity> builder)
    {
        ...
        builder.Property(x => x.MembershipStatusItemKey).HasColumnName("MembershipStatusItemKey");
        ...
        builder.Property(x => x.AccountStatusName).HasColumnName("AccountStatusName").IsUnicode(false).HasMaxLength(200);
