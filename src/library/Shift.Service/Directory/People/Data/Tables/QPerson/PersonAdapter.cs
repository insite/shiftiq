...
public class PersonAdapter : IEntityAdapter
{
    public void Copy(ModifyPerson modify, PersonEntity entity)
    {
        ...
        entity.MembershipStatusItemKey = modify.MembershipStatusItemKey;
        ...
        entity.AccountStatusName = modify.AccountStatusName;
    ...
    public PersonEntity ToEntity(CreatePerson create)
    {
        var entity = new PersonEntity
        {
            ...
            MembershipStatusItemKey = create.MembershipStatusItemKey,
            ...
            AccountStatusName = create.AccountStatusName,
    ...
    public PersonModel ToModel(PersonEntity entity)
    {
        var model = new PersonModel
        {
            ...
            MembershipStatusItemKey = entity.MembershipStatusItemKey,
            ...
            AccountStatusName = entity.AccountStatusName,
