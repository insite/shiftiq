...
public class QGroupAdapter : IEntityAdapter
{
    public void Copy(ModifyGroup modify, QGroupEntity entity)
    {
        ...
        entity.GroupStatus = modify.GroupStatus;
    ...
    public QGroupEntity ToEntity(CreateGroup create)
    {
        var entity = new QGroupEntity
        {
            ...
            GroupStatus = create.GroupStatus,
    ...
    public IEnumerable<GroupModel> ToModel(IEnumerable<QGroupEntity> entities)
    {
        return entities.Select(ToModel);
    }

    public GroupModel ToModel(QGroupEntity entity)
    {
    ...
    public IEnumerable<GroupMatch> ToMatch(IEnumerable<QGroupEntity> entities)
    {
        return entities.Select(ToMatch);
    }

    public GroupMatch ToMatch(QGroupEntity entity)
    {
