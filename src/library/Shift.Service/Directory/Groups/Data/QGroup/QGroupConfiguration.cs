...
public class QGroupConfiguration : IEntityTypeConfiguration<QGroupEntity>
{
    public void Configure(EntityTypeBuilder<QGroupEntity> builder) 
    {
        ...
        builder.HasKey(x => new { x.GroupIdentifier });
            ...
            builder.Property(x => x.GroupStatus).HasColumnName("GroupStatus").IsUnicode(false).HasMaxLength(100);
