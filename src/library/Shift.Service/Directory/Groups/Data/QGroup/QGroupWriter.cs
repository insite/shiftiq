...
public class QGroupWriter : IEntityWriter
{
    private readonly IDbContextFactory<TableDbContext> _context;

    public QGroupWriter(IDbContextFactory<TableDbContext> context)
    {
        _context = context;
    }

    public async Task<bool> CreateAsync(QGroupEntity entity, CancellationToken cancellation = default)
    {
    ...
    public async Task<bool> ModifyAsync(QGroupEntity entity, CancellationToken cancellation = default)
    {
        using var db = _context.CreateDbContext();
