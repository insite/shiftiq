...
public partial class AttemptEntity
{
    public ICollection<AttemptPinEntity> Pins { get; set; } = new List<AttemptPinEntity>();
    public ICollection<AttemptSectionEntity> Sections { get; set; } = new List<AttemptSectionEntity>();
    public ICollection<AttemptSolutionEntity> Solutions { get; set; } = new List<AttemptSolutionEntity>();
