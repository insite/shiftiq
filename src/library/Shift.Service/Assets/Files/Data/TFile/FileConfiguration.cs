...
public class FileConfiguration : IEntityTypeConfiguration<FileEntity>
{
    public void Configure(EntityTypeBuilder<FileEntity> builder) 
    {
        ...
        builder.Property(x => x.FileTag).HasColumnName("FileTag").IsUnicode(false).HasMaxLength(20);
        ...
        builder.HasOne(x => x.Organization)
            .WithMany(x => x.Files)
            .HasForeignKey(x => x.OrganizationIdentifier)
            .HasPrincipalKey(x => x.OrganizationIdentifier);
