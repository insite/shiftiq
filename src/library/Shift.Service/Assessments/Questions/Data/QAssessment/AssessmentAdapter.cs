...
public class AssessmentAdapter : IEntityAdapter
{
    public void Copy(ModifyAssessment modify, AssessmentEntity entity)
    {
    ...
    public AssessmentEntity ToEntity(CreateAssessment create)
    {
    ...
    public IEnumerable<AssessmentModel> ToModel(IEnumerable<AssessmentEntity> entities)
    {
        return entities.Select(ToModel);
    }

    public AssessmentModel ToModel(AssessmentEntity entity)
    {
    ...
    public IEnumerable<AssessmentMatch> ToMatch(IEnumerable<AssessmentEntity> entities)
    {
        return entities.Select(ToMatch);
    }

    public AssessmentMatch ToMatch(AssessmentEntity entity)
    {
        var match = new AssessmentMatch
        {
            FormIdentifier = entity.FormIdentifier
