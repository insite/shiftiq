...
public class AttemptService : IEntityService
{
    ...
    public async Task<bool> AssertAsync(Guid attempt, Guid? organization, CancellationToken cancellation = default)
    {
        return await _reader.AssertAsync(attempt, organization, cancellation);
    }
    ...
    {
        var entity = await _reader.RetrieveAsync(modify.AttemptId, cancellation);
