...
public class BankService : IEntityService
{
    ...
    public async Task<bool> AssertAsync(Guid bank, Guid? organization, CancellationToken cancellation = default)
    {
        return await _reader.AssertAsync(bank, organization, cancellation);
    }
    ...
    {
        var entity = await _reader.RetrieveAsync(modify.BankId, cancellation);
