...
namespace Shift.Common.Integration.Google
{
    ...
    public class TranslationClient : ITranslationClient
    {
        ...
        public string[] Translate(string from, string to, string[] inputs)
        {
            ...
            var postResult = Shift.Common.TaskRunner.RunSync(StaticHttpClient.Client.PostAsync, url, content);
            ...
            var apiResponseContent = Shift.Common.TaskRunner.RunSync(postResult.Content.ReadAsStringAsync);
