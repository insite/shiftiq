...
namespace Shift.Common
{
    public class ClaimConverter : IClaimConverter
    {
        ...
        public IEnumerable<Claim> ToClaims(IPrincipal principal)
        {
            ...
            claims.Add(ToClaim(ClaimName.Paging, principal.Claims.Paging.ToString()));
        ...
        public IPrincipal ToPrincipal(IEnumerable<Claim> claims)
        {
            ...
            principal.Claims.Paging = Boolean.TryParse(GetClaim(ClaimName.Paging), out bool paging) ? paging : true;
