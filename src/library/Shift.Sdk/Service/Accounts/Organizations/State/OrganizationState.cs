...
namespace InSite.Domain.Organizations
{
    ...
    public class OrganizationState : AggregateState
    {
        ...
        public void When(OrganizationAccountSettingsModified e)
        {
            ...
            accounts.HideAdminMyDashboard = e.Accounts.HideAdminMyDashboard;
        ...
        public void When(OrganizationAssessmentSettingsModified e)
        {
            ...
            assessments.TakerReport = e.Assessments.TakerReport;
        ...
        public void When(OrganizationGradebookSettingsModified e)
        {
            ...
            gradebooks.OperatorOnlyUnlockAfterMonths = Number.CheckRange(e.Gradebooks.OperatorOnlyUnlockAfterMonths, -1);
        }

        public void When(OrganizationLogbookSettingsModified e)
        {
            var logbooks = Toolkits.Logbooks;
            logbooks.DisplayTotalLogbookHours = e.Logbooks.DisplayTotalLogbookHours;
            logbooks.LogbookBulkEntry = e.Logbooks.LogbookBulkEntry;
        }
        ...
        public void When(OrganizationIdentificationModified e)
        {
            ...
            CustomerNumber = e.CustomerNumber.NullIfEmpty();
            CustomerCode = e.CustomerCode.NullIfEmpty();
        }
