...
namespace InSite.Domain.Messages
{
    ...
    public class MailoutRecipientEmail
    {
        ...
        public void AddVariables(IDictionary<string, string> other)
        {
            foreach (var kv in other)
                Variables.Add(kv.Key, kv.Value);
        }
    }
    ...
    public class MessageState : AggregateState
    {
        ...
        public void When(MailoutDrafted2 e)
        {
            Mailouts.Add(e.MailoutId, new MailoutState
            {
                ...
                Recipients = e.To
                    ...
                    {
                        Email = new MailoutRecipientEmail(x.Identifier, x.Address),
        ...
        public void When(SerializedChange e)
        {
            ...
            else if (e.ChangeType == ObsoleteChangeType.MailoutDrafted)
            {
                var v2 = MailoutDrafted2.Upgrade(e);
