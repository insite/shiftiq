...
namespace InSite.Application.Courses.Write
{
    public class CourseObjectCommandGenerator
    {
        ...
        public void CreateCourseGradebook(QCourse course, TUnit[] units, Guid gradebook, string gradebookName, string achievementType, string certificateLayout, decimal? passPercent)
        {
        ...
        private AddGradeItem CreateGradeCategory(Guid gradebook, Guid category, TUnit unit, int unitSequence, decimal? passPercent)
        {
            var id = UuidFactory.Create();
        ...
        private AddGradeItem CreateGradeCategory(Guid gradebook, Guid category, TUnit unit, TModule module, int unitSequence, int moduleSequence, decimal? passPercent)
        {
        ...
        private IEnumerable<ICommand> CreateGradeItem(Guid gradebook, Guid category, TActivity activity, int unitSequence, int moduleSequence, int activitySequence, decimal? passPercent)
        {
