...
namespace InSite.Application.Surveys.Read
{
    ...
    public class ResponseChangeProjector
    {
        ...
        public ResponseChangeProjector(IChangeQueue publisher, IChangeStore changeStore, ISurveyStore store)
        {
            _store = store;
            ...
            publisher.Subscribe<ResponseSessionCreated2>(Handle);
            ...
            {
                ObsoleteChangeType.ResponseSessionCreated1
            });
        }
        ...
        public void Handle(ResponseSessionCreated2 e)
        ...
        public void Handle(SerializedChange e)
        {
            ...
            if (e.ChangeType != ObsoleteChangeType.ResponseSessionCreated1)
            {
                var v2 = ResponseSessionCreated2.Upgrade(e);
