...
namespace InSite.Domain.Contacts
{
    internal static class PersonFieldList
    {
        private static readonly Dictionary<PersonField, IStateFieldMeta> _fields = new Dictionary<PersonField, IStateFieldMeta>
        {
            ...
            { PersonField.AccountStatusName, new StateFieldMeta { FieldType = StateFieldType.Text } },
            ...
            { PersonField.MembershipStatusItemKey, new StateFieldMeta { FieldType = StateFieldType.Int } },
