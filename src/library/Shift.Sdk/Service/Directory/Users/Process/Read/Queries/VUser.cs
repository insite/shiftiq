...
namespace InSite.Application.Contacts.Read
{
    public class VUser
    {
        ...
        public virtual ICollection<QSurveyRespondent> SurveyRespondents { get; set; }
        ...
        public virtual ICollection<TCourseUser> CourseUsers { get; set; }
        ...
        public VUser()
        {
            ...
            SurveyRespondents = new HashSet<QSurveyRespondent>();
            ...
            CourseUsers = new HashSet<TCourseUser>();
