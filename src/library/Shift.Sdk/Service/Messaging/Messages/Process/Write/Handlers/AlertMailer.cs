...
namespace InSite.Application.Messages.Write
{
    public class AlertMailer : IAlertMailer
    {
        ...
        public void Send(Guid organizationId, Guid userId, AlertRegistrationComplete alert, Guid[] to, string[] attachments)
            => SendAlert(organizationId, userId, userId, alert, NotificationType.RegistrationComplete, null, null, to, attachments);
