...
namespace InSite.Application.Surveys.Read
{
    public class QResponseSession : ISurveyResponse
    {
        ...
        [NotMapped]
        public string AssessorName { get => Respondent?.UserFullName; set { } }

        [NotMapped]
        public string AssessorNameFirst { get => Respondent?.UserFirstName; set { } }

        [NotMapped]
        public string AssessorNameLast { get => Respondent?.UserLastName; set { } }

        [NotMapped]
        public string AssessorEmail { get => Respondent?.UserEmail; set { } }
    ...
    public interface ISurveyResponse
    {
        ...
        string AssessorNameFirst { get; set; }
        string AssessorNameLast { get; set; }
        string AssessorEmail { get; set; }
    }
    ...
    public class VResponse : ISurveyResponse
    {
        ...
        public string AssessorNameFirst { get; set; }
        public string AssessorNameLast { get; set; }
