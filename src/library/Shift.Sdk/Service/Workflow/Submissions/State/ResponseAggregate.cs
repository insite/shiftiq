...
namespace InSite.Domain.Surveys.Sessions
{
    public class ResponseAggregate : AggregateRoot
    {
        ...
        public void CreateResponse(string source, Guid organization, Guid form, Guid assessor, Guid respondent)
        {
            Apply(new ResponseSessionCreated2(source, organization, form, assessor, respondent));
        }
