...
namespace InSite.Domain.Issues
{
    public class CaseAggregate : AggregateRoot
    {
        ...
        public void ModifyFileRequirement(string requestedFileCategory, string requestedFileSubcategory, string requestedFrom, string requestedFileDescription)
        {
            Apply(new CaseFileRequirementModified(requestedFileCategory, requestedFileSubcategory, requestedFrom, requestedFileDescription));
        }
