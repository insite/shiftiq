...
namespace InSite.Domain.Surveys.Forms
{
    public class SurveyAggregate : AggregateRoot
    {
        ...
        public void ChangeSurveyThirdPartyFormsSettings(bool enabled)
        {
            if (Data.Form.EnableThirdPartyForms == enabled)
                return;

            Apply(new SurveyThirdPartyFormsSettingsChanged(enabled));
        }
