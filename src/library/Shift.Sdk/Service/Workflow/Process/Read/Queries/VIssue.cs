        ...
        public string IssueStatusCategoryHtml
        {
            get
            {
                ...
                if (IssueStatusCategory == "Open")
                    sb.Append("<span class='badge bg-success'><i class='far fa-fw fa-circle me-1'></i>Open</span>");
                else if (IssueStatusCategory == "Closed")
                    sb.Append("<span class='badge bg-danger'><i class='fas fa-fw fa-circle me-1'></i>Closed</span>");
                else
