...
namespace InSite.Application.Records.Read
{
    ...
    public class GradebookChangeProjector
    {
        ...
        public GradebookChangeProjector(IChangeQueue publisher, IChangeStore changeStore, IRecordStore store)
        {
            ...
            publisher.Subscribe<GradeItemAchievementChanged2>(Handle);
            ...
            {
                ProgressCompleted2.ObsoleteChangeType,
                GradeItemAchievementChanged2.ObsoleteChangeType
            });
        }
        ...
        public void Handle(GradeItemAchievementChanged2 c)
            => _store.UpdateItem(c);
        ...
        public void Handle(SerializedChange e)
        {
            ...
            switch (e.ChangeType)
            {
                case ProgressCompleted2.ObsoleteChangeType:
                    Handle(ProgressCompleted2.Upgrade(e));
                    break;
                case GradeItemAchievementChanged2.ObsoleteChangeType:
                    Handle(GradeItemAchievementChanged2.Upgrade(e));
                    break;
            }
        }
