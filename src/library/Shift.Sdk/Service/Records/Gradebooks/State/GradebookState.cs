...
namespace InSite.Domain.Records
{
    ...
    public class GradebookState : AggregateState
    {
        ...
        public void When(GradeItemAchievementChanged2 e)
        {
            var item = FindItem(e.Item);
            if (item == null)
                return;
        ...
        public void When(SerializedChange e)
        {
            ...
            if (e.ChangeType != GradeItemAchievementChanged2.ObsoleteChangeType)
                return;

            var v2 = GradeItemAchievementChanged2.Upgrade(e);
