...
namespace InSite.Domain.Records
{
    ...
    public class GradeItemAchievement
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Include)]
        public TriggerEffectCommand WhenPassCommand { get; set; }

        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Include)]
        public TriggerEffectCommand WhenFailCommand { get; set; }
        ...
        public static bool Equals(GradeItemAchievement a, GradeItemAchievement b)
        {
            return (a == null && b == null)
                || (a != null && b != null
                    ...
                    && a.WhenPassCommand == b.WhenPassCommand
                    && a.WhenFailCommand == b.WhenFailCommand
