...
namespace InSite.Application.Records.Read
{
    public interface IJournalSearch
    {
        ...
        bool ExistsJournalSetupGroup(Guid journalSetupId, Guid groupId, JournalSetupUserRole groupRole);
        ...
        bool IsLogbookValidator(Guid journalSetupId, Guid userIdentifier);
        List<Guid> GetJournalSetupValidatorIds(Guid journalSetupId);
