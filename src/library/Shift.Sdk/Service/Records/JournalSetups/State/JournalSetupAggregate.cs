...
namespace InSite.Domain.Records
{
    public class JournalSetupAggregate : AggregateRoot
    {
        ...
        public void CreateGroup(Guid group, JournalSetupUserRole role)
        {
            Apply(new JournalSetupGroupCreated(group, role));
        }

        public void RemoveGroup(Guid group, JournalSetupUserRole role)
        {
            Apply(new JournalSetupGroupRemoved(group, role));
        }
