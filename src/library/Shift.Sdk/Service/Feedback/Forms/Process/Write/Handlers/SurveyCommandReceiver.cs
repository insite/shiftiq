...
namespace InSite.Application.Surveys.Write.Handlers
{
    public class SurveyCommandReceiver
    {
        ...
        public SurveyCommandReceiver(ICommandQueue commander, IChangeQueue publisher, IChangeRepository repository)
        {
            ...
            commander.Subscribe<AddSurveyRespondents>(Handle);
            ...
            commander.Subscribe<DeleteSurveyRespondents>(Handle);
        ...
        public void Handle(AddSurveyRespondents c)
        {
            _repository.LockAndRun<SurveyAggregate>(c.AggregateIdentifier, aggregate =>
            {
                aggregate.AddSurveyRespondents(c.Respondents);
                Commit(aggregate, c);
            });
        }
        ...
        public void Handle(DeleteSurveyRespondents c)
        {
            _repository.LockAndRun<SurveyAggregate>(c.AggregateIdentifier, aggregate =>
            {
                aggregate.DeleteSurveyRespondents(c.Respondents);
                Commit(aggregate, c);
            });
        }
