...
namespace InSite.Application.Surveys.Write
{
    public class SurveyCommandGenerator
    {
        ...
        /// </summary>
        public ICommand[] GetCommands(string source, SurveyForm form, Guid[] respondents, bool differentOrganizationUpload = false)
        {
            ...
            if (respondents.IsNotEmpty())
                script.Add(new AddSurveyRespondents(id, respondents));
