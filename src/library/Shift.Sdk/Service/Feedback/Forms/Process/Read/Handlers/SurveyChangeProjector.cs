...
namespace InSite.Application.Surveys.Read
{
    ...
    public class SurveyChangeProjector
    {
        ...
        public SurveyChangeProjector(IChangeQueue publisher, ISurveyStore store)
        {
            ...
            publisher.Subscribe<SurveyRespondentsAdded>(Handle);
            publisher.Subscribe<SurveyRespondentsDeleted>(Handle);
        ...
        public void Handle(SurveyRespondentsAdded e)
            => _store.UpdateSurvey(e);

        public void Handle(SurveyRespondentsDeleted e)
            => _store.UpdateSurvey(e);
