...
namespace InSite.Application.Surveys.Read
{
    public interface ISurveySearch
    {
        ...
        QSurveyRespondent GetSurveyRespondent(Guid survey, Guid user);
        List<QSurveyRespondent> GetSurveyRespondentsByUser(Guid user);
        List<QSurveyRespondent> GetSurveyRespondentsBySurvey(Guid user);
