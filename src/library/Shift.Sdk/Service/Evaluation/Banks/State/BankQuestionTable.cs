...
{
    public sealed class BankQuestionTable
    {
        #region Classes
        ...
        public static BankQuestionTable Build(IEnumerable<OptionColumn> layoutColumns, IEnumerable<string> options)
        {
            ...
            var table = new BankQuestionTable();
