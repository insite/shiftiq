...
namespace InSite.Application.Contacts.Read
{
    public class QUser
    {
        ...
        public virtual ICollection<QSurveyForm> CreatedSurveys { get; set; } = new HashSet<QSurveyForm>();
        public virtual ICollection<QSurveyForm> LastChangeSurveys { get; set; } = new HashSet<QSurveyForm>();
