...
namespace Shift.Sdk.UI
{
    public abstract class LayoutContentSection
    {
        ...
        public abstract class TextSection : LayoutContentSection
        {
        ...
        public sealed class SingleLineList : LayoutContentSection
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionSingleList.ascx";
        ...
        public sealed class TabList : LayoutContentSection
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionTabs.ascx";
        ...
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionDefault.ascx";
        ...
        public sealed class TileList : LayoutContentSection
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionTiles.ascx";

            public TileSize Size { get; set; }

            public IEnumerable<TextSection> Options { get; set; }
        ...
        public sealed class MarkdownAndHtml : LayoutContentSection
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionMdHtml.ascx";
        ...
        public sealed class WebPageTemplate : LayoutContentSection
        {
            public override string ControlPath => "~/UI/Layout/Common/Controls/Editor/SectionWebTemplate.ascx";
            public Guid ResourceId { get; set; }
            public MultilingualDictionary Value { get; set; }

            public WebPageTemplate(string id, Guid resourceId)
                : base(id)
            {
