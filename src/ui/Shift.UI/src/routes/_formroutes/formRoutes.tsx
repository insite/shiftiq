        ...
        children: [
            ...
            },
            {
                ...
                customBreadcrumbs: [
                    ...
                    {
                        title: "Sites",
                        path: "/ui/admin/sites/home",
                    },
                    {
                        title: "Search",
                        path: "/ui/admin/sites/pages/search",
                        category: "Pages"
                    },
                    {
                        title: "Outline",
                        path: "/ui/admin/sites/pages/outline",
                    },
                ],
            },
            {
                title: "Workshop",
                menuTitle: "Workshop",
                path: "/client/admin/assessment/forms/workshop/:id",
                element: <FormWorkshop />,
                customBreadcrumbs: [
                    {
                        title: "Admin",
                        path: "/client/admin/home",
                    ...
                    {
                        title: "Assessments",
                        path: "/ui/admin/assessments/home",
                    },
                    {
                        title: "Search",
                        path: "/ui/admin/assessments/banks/search",
                        category: "Banks"
                    },
                    {
                        title: "Outline",
            ...
            },
            {
                ...
                menuTitle: "Table of Specifications",
                path: "/client/admin/assessment/specs/workshop/:id",
                element: <SpecWorkshop />,
                customBreadcrumbs: [
                    {
                        title: "Admin",
                        path: "/client/admin/home",
