...
test("/api/records/periods: non-authenticated", async () => {
    await global.logout();
...
test("/api/records/periods/search: authenticated", async () => {
    await global.login();
...
test("/api/records/periods/retrieve: authenticated", async () => {
    await global.login();
