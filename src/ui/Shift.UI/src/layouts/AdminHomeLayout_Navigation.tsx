...
import { IS_LOCAL } from "@/helpers/constants";
                ...
                <div className="container-fluid">
                    ...
                    <nav className="collapse navbar-collapse">
                        <ul className="navbar-nav ms-auto">
                                ...
                                <>
                                    <li className="nav-item">
                                        <ActionLink className="nav-link text-info" href="/client/react/home">
                                            <i className="fas fa-fw fa-brands fa-react me-2"></i>React {siteSetting.OrganizationCode ? `(${siteSetting.OrganizationCode})` : ""}
                                        </ActionLink>
                                    </li>
                                    <li className="nav-item">
                            ...
                            {siteSetting.IsCmds && (
                                <li className="nav-item">
                                    <ActionLink className="nav-link" href={siteSetting.CmdsHomeLink}><i className="fas fa-fw fa-boxes me-2"></i>CMDS</ActionLink>
                                </li>
                            )}
                            <li className="nav-item">
                                <ActionLink className="nav-link" href="/ui/portal/home"><i className="fas fa-fw fa-layer-group me-2"></i>Portal</ActionLink>
                            </li>
                            <li className="nav-item d-none">
                                <ActionLink className="d-none nav-link" href="/client/admin/home"><i className="fas fa-fw fa-cog me-2"></i>Admin</ActionLink>
                            </li>
                            <li className="nav-item">
                                <div className="nav-link disabled text-border px-1">|</div>
                            </li>
                                ...
                                <>
                                    <li className="nav-item">
                                        <ActionLink className="nav-link text-danger" href="/ui/portal/accounts/users/impersonate">
                                            <i className="fas fa-fw fa-user-secret me-2"></i>
                                            {siteSetting.ImpersonatorName}
                                        </ActionLink>
                                    </li>
                                    <li className="nav-item">
                            ...
                            {siteSetting.UserName && (
                                <>
                                    <li className="nav-item">
                                        <ActionLink className="nav-link" href="/ui/portal/support" target="_blank"><i className="fas fa-envelope me-2"></i>Support</ActionLink>
                                    </li>
                                    <li className="nav-item">
                                        <div className="nav-link disabled text-border px-1">|</div>
                                    </li>
