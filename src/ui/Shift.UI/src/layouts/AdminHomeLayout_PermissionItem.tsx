...
export default function AdminHomeLayout_PermissionItem() {
    ...
    return (
        <li className="nav-item dropdown">
            <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i className="fas fa-cogs me-2"></i>Utilities</a>
