            ...
            <div className="admin-simplebar-content">
                ...
                <nav className="widget-nav nav nav-light flex-column">
                    ...
                    <div className="text-body-secondary fs-sm mt-3">
                        <div className="mb-1">
                            <i className="fa-fw far fa-stopwatch me-2"></i>Session <SessionTimer />
                        </div>
                        <div className="mb-1">
                            <i className="fa-fw far fa-globe me-2"></i>{siteSetting.UserHostAddress}
                        </div>
                        <div className="mb-1">
                            <i className="fa-fw far fa-copyright me-2"></i>{new Date().getFullYear()} InSite
                        </div>
                    </div>
                </nav>
