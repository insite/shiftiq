...
namespace Shift.Hub
{
    ...
    {
        public static void AddDocumentation(this IServiceCollection services, IHubConfiguration config)
        {
        ...
        public static void UseDocumentation(this WebApplication app, IHubConfiguration config)
        {
