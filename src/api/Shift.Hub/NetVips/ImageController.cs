...
using global::NetVips;
using global::NetVips.Extensions;
...
using Endpoints = Shift.Common.Integration.ImageMagick.Endpoints;
...
namespace Shift.Hub.NetVips
{
    ...
    [ApiController]
    [Route("imagemagick")]
    [ApiExplorerSettings(GroupName = "Integration: NetVips")]
