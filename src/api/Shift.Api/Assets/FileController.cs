...
[ApiController]
[ApiExplorerSettings(GroupName = "Assets API: Files")]
public class FileController : ShiftControllerBase
{
    ...
    /// </summary>
    [HttpHead("api/assets/files/{file:guid}")]
    [HybridPermission("content/files", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [EndpointName("assertFile")]
    public async Task<ActionResult> AssertAsync([FromRoute] Guid file, CancellationToken cancellation = default)
    {
    ...
    /// </summary>
    [HttpPost("api/assets/files/collect")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("collectFiles")]
    public async Task<ActionResult<IEnumerable<FileModel>>> PostCollectAsync([FromBody] CollectFiles query, CancellationToken cancellation = default)
    {
        return await CollectAsync(query, cancellation);
    }

    [HttpGet("api/assets/files")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("collectFiles_get")]
    [AliasFor("collectFiles")]
    [ApiExplorerSettings(IgnoreApi = true)]
    public async Task<ActionResult<IEnumerable<FileModel>>> GetCollectAsync([FromQuery] CollectFiles query, CancellationToken cancellation = default)
    {
        return await CollectAsync(query, cancellation);
    }

    private async Task<ActionResult<IEnumerable<FileModel>>> CollectAsync(CollectFiles query, CancellationToken cancellation)
    {
        var principal = _identityService.GetPrincipal();
    ...
    /// </summary>
    [HttpPost("api/assets/files/count")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("countFiles")]
    public async Task<ActionResult<CountResult>> PostCountAsync([FromBody] CountFiles query, CancellationToken cancellation = default)
    {
        return await CountAsync(query, cancellation);
    }

    [HttpGet("api/assets/files/count")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("countFiles_get")]
    [AliasFor("countFiles")]
    [ApiExplorerSettings(IgnoreApi = true)]
    public async Task<ActionResult<CountResult>> GetCountAsync([FromQuery] CountFiles query, CancellationToken cancellation = default)
    {
        return await CountAsync(query, cancellation);
    }

    private async Task<ActionResult<CountResult>> CountAsync(CountFiles query, CancellationToken cancellation)
    {
        var principal = _identityService.GetPrincipal();
    ...
    /// </summary>    
    [HttpPost("api/assets/files/download")]
    [HybridPermission("content/files", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    ...
    [HttpGet("api/assets/files/download")]
    [HybridPermission("content/files", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [Produces("application/octet-stream")]
    ...
    /// </summary>
    [HttpGet("api/assets/files/{file:guid}")]
    [HybridPermission("content/files", DataAccess.Read)]
    [ProducesResponseType(typeof(FileModel), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [EndpointName("retrieveFile")]
    public async Task<ActionResult<FileModel>> RetrieveAsync([FromRoute] Guid file, CancellationToken cancellation = default)
    {
        var principal = _identityService.GetPrincipal();
    ...
    /// </summary>
    [HttpPost("api/assets/files/search")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("searchFiles")]
    public async Task<ActionResult<IEnumerable<FileMatch>>> PostSearchAsync([FromBody] SearchFiles query, CancellationToken cancellation = default)
    {
        return await SearchAsync(query, cancellation);
    }

    [HttpGet("api/assets/files/search")]
    [HybridPermission("content/files", DataAccess.Read)]
    [EndpointName("searchFiles_get")]
    [AliasFor("searchFiles")]
    [ApiExplorerSettings(IgnoreApi = true)]
    public async Task<ActionResult<IEnumerable<FileMatch>>> GetSearchAsync([FromQuery] SearchFiles query, CancellationToken cancellation = default)
    {
        return await SearchAsync(query, cancellation);
    }

    private async Task<ActionResult<IEnumerable<FileMatch>>> SearchAsync(SearchFiles query, CancellationToken cancellation)
    {
        var principal = _identityService.GetPrincipal();
    ...
    [HttpDelete("api/assets/files/{file:guid}")]
    ...
    [HttpPut("api/assets/files/{file:guid}")]
    [HybridPermission("content/files", DataAccess.Update)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType<ValidationFailure>(StatusCodes.Status400BadRequest, "application/json")]
    ...
    /// </returns>
    [HttpGet("api/assets/files/{id:guid}/{name}")]
