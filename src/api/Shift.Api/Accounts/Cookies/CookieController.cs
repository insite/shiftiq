...
public partial class CookieController : ShiftControllerBase
{
    ...
    [HttpPost("login")]
    [ProducesResponseType(typeof(CookieToken), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<CookieToken>> LoginAsync(string organizationCode, string email, string? impersonatorOrganizationCode, string? impersonatorUserEmail)
    {
    ...
    /// </remarks>
    [HttpPost("create")]
    [ProducesResponseType(typeof(CookieValueResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<CookieValueResponse>> CreateAsync(string? name, int? lifetime)
    {
        ...
        return Ok(new CookieValueResponse { Value = value });
    }
    ...
    [HttpPost("generate")]
    [ProducesResponseType(typeof(CookieGenerateResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<CookieGenerateResponse>> GenerateAsync()
    {
        var environment = _appSettings.Release.GetEnvironment();
        ...
        return Ok(new CookieGenerateResponse { Token = token });
    }
    ...
    [ProducesResponseType(typeof(CookieToken), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<CookieToken>> ValidateAsync()
    {
        var token = string.Empty;
