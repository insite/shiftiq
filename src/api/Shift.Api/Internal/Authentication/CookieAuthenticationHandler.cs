...
public class CookieAuthenticationHandler : AuthenticationHandler<CookieAuthenticationOptions>
{
    ...
    ClaimsPrincipal? ToClaimsPrincipal(CookieToken claims, string authenticationType)
    {
        ...
        var authority = claims.IsOperator
            ? AuthorityAccess.Operator
            : claims.IsAdministrator
                ? AuthorityAccess.Administrator
        ...
        var list = new List<Claim>
            {
                ...
                _converter.ToClaim(ClaimName.Authority, authority.ToString())
            };
        ...
        {
            list.Add(_converter.ToClaim(ClaimName.RoleId, role.ToString()));
        }
