...
[ApiController]
[ApiExplorerSettings(GroupName = "Evaluation API: Questions")]
public class BankController : ShiftControllerBase
{
    ...
    /// </summary>
    [HttpHead("api/evaluation/banks/{bank:guid}")]
    ...
    /// </summary>
    [HttpPost("api/evaluation/banks/collect")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    ...
    /// </summary>
    [HttpPost("api/evaluation/banks/count")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    ...
    [HttpGet("api/evaluation/banks/count")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    [ProducesResponseType<CountResult>(StatusCodes.Status200OK)]
    ...
    /// </summary>    
    [HttpPost("api/evaluation/banks/download")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    ...
    [HttpGet("api/evaluation/banks/download")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [Produces("application/octet-stream")]
    ...
    /// </summary>
    [HttpGet("api/evaluation/banks/{bank:guid}")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    ...
    /// </summary>
    [HttpPost("api/evaluation/banks/search")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    ...
    [HttpGet("api/evaluation/banks/search")]
    [HybridPermission("evaluation/banks", DataAccess.Read)]
    [ProducesResponseType<IEnumerable<BankMatch>>(StatusCodes.Status200OK)]
