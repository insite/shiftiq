...
public class CaseStatusController : ControllerBase
{
    ...
    [HttpGet("api/workflows/cases-statuses/{statusId:guid}")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    [ProducesResponseType(typeof(CaseStatusModel), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    ...
    [HttpGet("api/workflows/cases-statuses/count")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpPost("api/workflows/cases-statuses/count")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpGet("api/workflows/cases-statuses")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpPost("api/workflows/cases-statuses/collect")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpGet("api/workflows/cases-statuses/search")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpPost("api/workflows/cases-statuses/search")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    ...
    [HttpPost("api/workflows/cases-statuses")]
    ...
    [HttpPut("api/workflows/cases-statuses/{statusId:guid}")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Update)]
    [ProducesResponseType(typeof(CaseStatusModel), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    ...
    [HttpDelete("api/workflows/cases-statuses/{statusId:guid}")]
    ...
    [HttpGet("api/workflows/cases-statuses/download")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    ...
    [HttpPost("api/workflows/cases-statuses/download")]
    [HybridPermission("workflow/cases-statuses", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [Produces("application/octet-stream")]
