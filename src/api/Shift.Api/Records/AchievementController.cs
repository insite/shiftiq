...
[ApiController]
[ApiExplorerSettings(GroupName = "Records API: Achievements")]
public class AchievementController : ShiftControllerBase
{
    ...
    /// </summary>
    [HttpHead("api/records/achievements/{achievement:guid}")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [EndpointName("assertAchievement")]
    public async Task<ActionResult> AssertAsync([FromRoute] Guid achievement, CancellationToken cancellation = default)
    {
    ...
    /// </summary>
    [HttpPost("api/records/achievements/collect")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [EndpointName("collectAchievements")]
    public async Task<ActionResult<IEnumerable<AchievementModel>>> PostCollectAsync([FromBody] CollectAchievements query, CancellationToken cancellation = default)
    {
        return await CollectAsync(query, cancellation);
    }

    [HttpGet("api/records/achievements")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [EndpointName("collectAchievements_get")]
    [AliasFor("collectAchievements")]
    [ApiExplorerSettings(IgnoreApi = true)]
    public async Task<ActionResult<IEnumerable<AchievementModel>>> GetCollectAsync([FromQuery] CollectAchievements query, CancellationToken cancellation = default)
    {
        return await CollectAsync(query, cancellation);
    }

    private async Task<ActionResult<IEnumerable<AchievementModel>>> CollectAsync(CollectAchievements query, CancellationToken cancellation)
    {
        var principal = _principalProvider.GetPrincipal();
    ...
    /// </summary>
    [HttpPost("api/records/achievements/count")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [EndpointName("countAchievements")]
    public async Task<ActionResult<CountResult>> PostCountAsync([FromBody] CountAchievements query, CancellationToken cancellation = default)
    {
        return await CountAsync(query, cancellation);
    }

    [HttpGet("api/records/achievements/count")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [EndpointName("countAchievements_get")]
    [AliasFor("countAchievements")]
    [ApiExplorerSettings(IgnoreApi = true)]
    public async Task<ActionResult<CountResult>> GetCountAsync([FromQuery] CountAchievements query, CancellationToken cancellation = default)
    {
        return await CountAsync(query, cancellation);
    }

    private async Task<ActionResult<CountResult>> CountAsync(CountAchievements query, CancellationToken cancellation)
    {
        var principal = _principalProvider.GetPrincipal();
    ...
    /// </summary>    
    [HttpPost("api/records/achievements/download")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    ...
    [HttpGet("api/records/achievements/download")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [Produces("application/octet-stream")]
    ...
    /// </summary>
    [HttpGet("api/records/achievements/{achievement:guid}")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    ...
    /// </summary>
    [HttpPost("api/records/achievements/search")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    [EndpointName("searchAchievements")]
    public async Task<ActionResult<IEnumerable<AchievementMatch>>> PostSearchAsync([FromBody] SearchAchievements query, CancellationToken cancellation = default)
    {
        return await SearchAsync(query, cancellation);
    }

    [HttpGet("api/records/achievements/search")]
    [HybridPermission("progress/achievements", DataAccess.Read)]
    ...
    private async Task<ActionResult<IEnumerable<AchievementMatch>>> SearchAsync(SearchAchievements query, CancellationToken cancellation)
    {
        var principal = _principalProvider.GetPrincipal();
