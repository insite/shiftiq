...
public class PartitionFieldController : ControllerBase
{
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Assert)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Retrieve)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Count)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Collect)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Search)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Create)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Modify)]
    ...
    [HybridAuthorize(Policies.Platform.Partitions.PartitionField.Delete)]
    [ProducesResponseType(typeof(void), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(void), StatusCodes.Status404NotFound)]
