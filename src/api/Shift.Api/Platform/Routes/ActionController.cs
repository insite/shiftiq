...
public class ActionController : ControllerBase
{
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Assert)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Retrieve)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Count)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Collect)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Search)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Create)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Modify)]
    ...
    [HybridAuthorize(Policies.Platform.Routes.Action.Delete)]
    [ProducesResponseType(typeof(void), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(void), StatusCodes.Status404NotFound)]
