...
[ApiController]
[ApiExplorerSettings(GroupName = "Settings API: Routing")]
[Route("api/settings/routing")]
[HybridAuthorize]
public class RouteController : ShiftControllerBase
{
    ...
    [HttpGet("policies")]
    public ActionResult<IEnumerable<PolicyResult>> Policies()
    {
    ...
    [HttpGet("problems")]
    public ActionResult<ProblemsResult> Problems()
    {
        ...
        else
        {
            ...
            foreach (var apiSpec in apiSpecs)
            {
                ...
                foreach (var policy in policies)
                {
                    ...
                    var resourceRoute = item.Routes.FirstOrDefault(x => x == route);
    ...
    {
        public List<string> ApiEndpointResourcesMissingFromPermissionMatrix { get; set; } = new List<string>();
        public List<string> PermissionMatrixResourcesNotUsedByAnyApiEndpoint { get; set; } = new List<string>();
    }
}
