...
namespace InSite.Api.Controllers
{
    ...
    public class AuthenticationController : ApiOpenController
    {
        ...
        {
            var secret = ServiceLocator.PersonSecretSearch.GetBySecretValue(secretValue, x => x.Person, x => x.Person.User.Memberships);
            ...
            var principal = new Principal
            {
                ...
                Organization = new Model { Identifier = person.OrganizationIdentifier }
            };
            ...
            principal.Roles = ServiceLocator.GroupSearch.BindGroups(
                ...
                .Select(x => new Role { Identifier = x.GroupIdentifier, Name = x.GroupName })
                .ToList();
        ...
        private Principal GetRootProxy(string secret, Guid? organizationId, string ipAddress, string whitelist)
        {
            ...
            if (IsRootSecret(secret, root.Secret))
            {
                ...
                {
                    identity.Organization = new Model { Identifier = organizationId.Value };
                }
                else
                {
