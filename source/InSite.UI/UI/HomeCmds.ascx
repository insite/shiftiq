...
<section class="pb-5 mb-md-2">
    ...
    <div class="btn-toolbar mb-4" role="toolbar" aria-label="Shortcut toolbar">
        <div class="btn-group me-2 mb-2" role="group" aria-label="Shortcut buttons">
            ...
            <a href="/ui/portal/learning/catalog" class="btn btn-success"><i class="fa-solid fa-books me-2"></i>eLearning</a>
            ...
            <a href="/ui/portal/learning/plan" class="btn btn-secondary"><i class="fa-solid fa-map-marked-alt me-2"></i>Training Plan</a>
            <a href="/ui/cmds/portal/achievements/credentials/search" class="btn btn-secondary"><i class="fa-solid fa-graduation-cap me-2"></i>Education &amp; Training</a>
    ...
    <div class="card border-0 shadow-lg">
        <div class="card-body">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div runat="server" id="ProfilesAndCertificatesPanel" class="col">
                    ...
                    <div class="card card-tile shadow">
                        <div class="card-body text-center">
                            <i class='far fa-users-class fa-3x mb-3'></i>
                    ...
                    <div class="card card-tile shadow mt-4">
                        <div class="card-body text-center">
                            <i class='far fa-university fa-3x mb-3'></i>
                ...
                <div runat="server" id="CompetenciesPanel" class="col">
                    <div class="card card-tile shadow">
                        <div class="card-body text-center">
                ...
                <div class="col">
                    <div class="card card-tile shadow">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><i class="fas fa-caret-right fa-fw me-1"></i><a href="/ui/cmds/admin/uploads/outline?achievementType=Human+Resources+Document">Human Resources Documents</a></li>
                            <li class="list-group-item"><i class="fas fa-caret-right fa-fw me-1"></i><a href="/ui/cmds/admin/uploads/outline?achievementType=Safe+Operating+Practice" runat="server" id="SopAnchor">Safe Operating Practices</a></li>
                            <li class="list-group-item"><i class="fas fa-caret-right fa-fw me-1"></i><a href="/ui/cmds/admin/uploads/outline?achievementType=Site-Specific+Operating+Procedure" runat="server" id="OppAnchor">Operating Procedures</a></li>
                            <li class="list-group-item"><i class="fas fa-caret-right fa-fw me-1"></i><a href="/ui/cmds/admin/uploads/outline?achievementType=Training+Guide" runat="server" id="TrdAnchor">Training Documents</a></li>
