...
<head>
    ...
    <title>HTTP 410 - Gone / Not Found</title>
...
<body>
    ...
    <uc:ErrorPageBody runat="server" ID="ErrorBody">
        <ContentTemplate>
            ...
            <h1 class="display-5">Gone / Not Found</h1>
            <p runat="server" id="ErrorBody" class="fs-3 pb-1">It seems we can't find the resource you are looking for.</p>
