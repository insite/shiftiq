...
<asp:Content runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <insite:ResourceLink runat="server" Type="Css" Url="/UI/Layout/Common/Styles/Shift.css" />
                    ...
                    <div class="badge-info">
                        ...
                        <div class="form-group mb-3">
                            <div class="float-end opacity-70">
                                <a href="#" title="Email" target="_blank" class="me-1 output-issuer-email"><i class="far fa-fw fa-envelope"></i></a>
                                <a href="#" title="Website" target="_blank" class="me-1 output-issuer-url"><i class="far fa-fw fa-globe-pointer"></i></a>
                            </div>
                            <label class="form-label">
                                Issuer
                            </label>
