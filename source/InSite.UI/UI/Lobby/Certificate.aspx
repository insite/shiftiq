...
<asp:Content runat="server" ContentPlaceHolderID="SideContent">
    ...
    <div class="p-4">
        ...
        <div runat="server" id="ControlPannel" style="margin: auto" class="text-center">
            ...
            <asp:HyperLink runat="server" ID="FaceBook" Target="_blank"><i class='fab fa-fw fa-facebook me-1' title="Share on Facebook"></i></asp:HyperLink>
            <asp:HyperLink runat="server" ID="Twitter" Target="_blank"><i class='fab fa-fw fa-twitter me-1' title="Share on Twitter"></i></asp:HyperLink>
            <asp:HyperLink runat="server" ID="LinkedIn" Target="_blank"><i class='fab fa-fw fa-linkedin me-1' title="Share on LinkedIn"></i></asp:HyperLink>
            <asp:HyperLink runat="server" ID="Mail" Target="_blank"><i class='fas fa-fw fa-paper-plane me-1' title="Send Via Email"></i></asp:HyperLink>
        </div>
