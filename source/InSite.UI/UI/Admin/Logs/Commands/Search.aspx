<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Logs.Commands.Search" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <asp:Button runat="server" ID="TestButton" Text="Schedule Test Command" Visible="false" />
</asp:Content>
