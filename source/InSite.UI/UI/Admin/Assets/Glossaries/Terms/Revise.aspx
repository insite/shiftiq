<%@ Page Language="C#" CodeBehind="Revise.aspx.cs" Inherits="InSite.Admin.Assets.Glossaries.Terms.Forms.Revise" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <div class="mb-3">
        <insite:SaveButton runat="server" ID="SaveButton" ValidationGroup="GlossaryTerm" />
