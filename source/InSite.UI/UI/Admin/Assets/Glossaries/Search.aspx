<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Assets.Glossaries.Search" %>
<%@ Register Src="./Terms/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="./Terms/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
