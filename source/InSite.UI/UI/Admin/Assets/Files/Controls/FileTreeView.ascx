...
<div class="mb-2">
    <insite:Button runat="server" ID="NewFolderButton" ButtonStyle="Default" Text="New Folder" Icon="fas fa-fw fa-folder-plus" />
    <insite:Button runat="server" ID="RenameFolderButton" ButtonStyle="Default" style="display:none;" Text="Rename Folder" Icon="fas fa-fw fa-pencil" />
    <insite:Button runat="server" ID="DeleteFolderButton" ButtonStyle="Default" style="display:none;" Text="Delete Folder" Icon="fas fa-fw fa-trash" />

    <insite:Button runat="server" ID="UploadFileButton" ButtonStyle="Default" Text="Upload File" Icon="fas fa-fw fa-upload" />
    <insite:Button runat="server" ID="RenameFileButton" ButtonStyle="Default" style="display:none;" Text="Rename File" Icon="fas fa-fw fa-pencil" />
    <insite:Button runat="server" ID="DeleteFileButton" ButtonStyle="Default" style="display:none;" Text="Delete File" Icon="fas fa-fw fa-trash" />

    <insite:Button runat="server" ID="DownloadButton" ButtonStyle="Default" style="display:none;" Text="Download File" Icon="fas fa-fw fa-download" target="_blank" />
</div>
...
<insite:Modal runat="server" ID="UploadWindow" Title="Upload File" Width="600px">
    <ContentTemplate>
        <div class="row mb-2">
            <div class="col-lg-12">
                <insite:FileUploadV1 runat="server" ID="FileUpload" LabelText="Select and Upload File:" />
            </div>
        </div>
