...
namespace InSite.UI.Admin.Assets.Files.Controls
{
    public partial class UploadDetail : BaseUserControl
    {
        ...
        public void UpdateFile(Guid fileIdentifier)
        {
            ...
            if (file.ObjectType == FileObjectType.Issue && !string.Equals(file.Properties.DocumentName, properties.DocumentName))
            {
                var command = new RenameAttachmentFile(file.ObjectIdentifier, file.Properties.DocumentName, properties.DocumentName);
