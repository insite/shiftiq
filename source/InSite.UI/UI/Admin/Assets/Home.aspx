    ...
    <section class="pb-5 mb-md-2">    
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/assets/glossaries/terms/upload"><i class="fas fa-fw fa-upload me-1"></i>Upload Glossary</a>
                    </div>
                </div>
    ...
    <section class="pb-5 mb-md-2" runat="server" id="FilesSection">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a runat="server" id="FileBrowserLink" class="me-3" href="/ui/admin/assets/files/browse"><i class="far fa-fw fa-folder-tree me-2"></i> Browse Shared Library Files</a>
                    </div>
                </div>
