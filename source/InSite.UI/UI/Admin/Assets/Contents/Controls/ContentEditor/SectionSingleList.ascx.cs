...
namespace InSite.Admin.Assets.Contents.Controls.ContentEditor
{
    public partial class SectionSingleList : SectionBase
    {
        ...
        private Phonetics _phonetics = new Phonetics();
        ...
        private void Repeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            var options = (AssetContentSection.SingleLine)e.Item.DataItem;
        ...
        {
            if (options is AssetContentSection.SingleLineList singleList)
            {
                ...
                AddButton.Icon = "far fa-plus";
                AddButton.Text = $"Add {Shift.Common.Humanizer.TitleCase(EntityName)}";
        ...
        {
            Repeater.DataSource = values.Select((x, i) => new AssetContentSection.SingleLine("Item" + i)
            {
