...
<div class="form-group content-field" id="<%= ClientID %>">
    ...
    <div>
        ...
        <div style="margin-top:3px;">
            ...
            <insite:Button runat="server" ID="CleanTextButton" ButtonStyle="Default" Size="ExtraSmall" ToolTip="Clean Text" Icon="fas fa-fw fa-sparkles" Text="Clean" PostBackEnabled="false" Visible="false" />
        </div>
