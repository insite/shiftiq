...
<insite:Accordion runat="server" ID="MainAccordion">
    ...
    <insite:AccordionPanel runat="server" ID="UploadDocumentPanel" Title="Microsoft Word Document" Icon="fas fa-fw fa-file-word">
        <div class="row">
            <div class="col-lg-6">
                <insite:FileUploadV1 runat="server" ID="DocumentUpload" LabelText="Select Document" />
            </div>
            <div class="row">
    ...
    <insite:AccordionPanel runat="server" ID="MarkdownPanel" Title="Markdown Conversion" Icon="fas fa-fw fa-file-code">
        <div class="row">
            <div class="col-md-12">
    ...
    <insite:AccordionPanel runat="server" ID="CoursesPanel" Title="Course" Icon="fas fa-fw fa-chalkboard-teacher" Visible="true">
        <div class="row">
            <div class="col-lg-6">
