    ...
    <ContentTemplate>
        <asp:Repeater runat="server" ID="RowRepeater">
            ...
            <ItemTemplate>
                ...
                <tr>
                    <td><%# Eval("Title") %></td>
                    <td class="text-center"><asp:CheckBox runat="server" ID="IsVisible" /></td>
                    <td runat="server" id="RequiredData" class="text-center"><asp:CheckBox runat="server" ID="IsRequired" /></td>
                    <td runat="server" id="MaskedData" class="text-center"><asp:CheckBox runat="server" ID="IsMasked" /></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
    </ContentTemplate>
