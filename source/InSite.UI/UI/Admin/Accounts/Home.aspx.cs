...
namespace InSite.UI.Admin.Accounts
{
    public partial class Home : AdminBasePage
    {
        ...
        protected void BindModelToControls()
        {
            ...
            var developerCount = ServiceLocator.PersonSecretSearch.Count();
            LoadCounter(DeveloperCounter, DeveloperCount, insite, developerCount, DeveloperLink, "/ui/admin/accounts/developers/search");
