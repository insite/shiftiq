<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="B5Guideline.aspx.cs" Inherits="InSite.UI.Admin.Foundations.B5Guideline" %>
    ...
    &lt;insite:Button runat="server" Icon="fas fa-cloud-upload" Text="Save" ButtonStyle="Success" /&gt;
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ToolTip="Upgrade" ButtonStyle="Danger" Text="Upgrade" Icon="fas fa-fw fa-sort-shapes-up" />
                        </td>
                        <td>Upgrade</td>
                        <td>fas fa-fw fa-sort-shapes-up</td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" Text="Loading ..." Icon="fa fa-spinner fa-pulse fa-3x fa-fw" IconPosition="AfterText" ButtonStyle="Primary" />
                        </td>
                        <td>Loading ...</td>
                        <td>fa fa-spinner fa-pulse fa-3x fa-fw</td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" Icon="fa fa-passport" Text="Skills Passport" ButtonStyle="None" CssClass="btn btn-gray" />
                        </td>
                        <td>Shift iQ</td>
                        <td>fa fa-passport</td>
                    </tr>
            ...
            <div>
                ...
                <table style="padding: 8px; margin: 10px;">
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Migrate" Icon="far fa-fw fa-file-export" />
                        </td>
                        <td>
                            <p>Move</p>
                            <p>Migrate</p>
                        </td>
                        <td>far fa-fw fa-file-export</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Move to Addendum" Icon="fas fa-reply fa-fw" />
                        </td>
                        <td>Move to Addendum</td>
                        <td>fas fa-reply fa-fw</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fas fa-arrows-alt-v fa-fw" Text="Cell Move" />
                        </td>
                        <td>Cell Move</td>
                        <td>fas fa-arrows-alt-v fa-fw</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fas fa-fw fa-chevron-down" Text="Expand All" />
                        </td>
                        <td>Expand All</td>
                        <td>fas fa-fw fa-chevron-down</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fas fa-fw fa-chevron-up" Text="Collapse All" />
                        </td>
                        <td>Collapse All</td>
                        <td>fas fa-fw fa-chevron-up</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="far fa-eye-slash fa-fw" Text="Hide Legend" />
                        </td>
                        <td>Hide Legend</td>
                        <td>far fa-eye-slash fa-fw</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="far fa-eye fa-fw" Text="Show Legend" />
                        </td>
                        <td>Show Legend</td>
                        <td>far fa-eye fa-fw</td>
                    </tr>

                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fa fa-fw fa-search-plus" Text="Zoom In" />
                        </td>
                        <td>Zoom In</td>
                        <td>fa fa-fw fa-search-plus</td>
                    </tr>

                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fa fa-fw fa-search-minus" Text="Zoom Out" />
                        </td>
                        <td>Zoom Out</td>
                        <td>fa fa-fw fa-search-minus</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Icon="fa fa-fw fa-search" Text="Actual Size" />
                        </td>
                        <td>
                            <p>Actual Size</p>
                            <p>Review (Feedback)</p>
                        </td>
                        <td>fa fa-fw fa-search</td>
                    </tr>

                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Select All" Icon="far fa-fw fa-square" />
                        </td>
                        <td>Select All</td>
                        <td>far fa-fw fa-square</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Deselect All" Icon="far fa-fw fa-check-square" />
                        </td>
                        <td>Deselect All</td>
                        <td>far fa-fw fa-check-square</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Outline" Icon="fas fa-fw fa-sitemap" />
                        </td>
                        <td>Outline</td>
                        <td>fas fa-fw fa-sitemap</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Workshop" Icon="far fa-fw fa-industry-alt" />
                        </td>
                        <td>Workshop</td>
                        <td>far fa-fw fa-industry-alt</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Text (.csv)" Icon="fas fa-fw fa-file-csv" />
                        </td>
                        <td>Text (.csv)</td>
                        <td>fas fa-fw fa-file-csv</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="PDF Document" Icon="fas fa-fw fa-file-pdf" />
                        </td>
                        <td>PDF Document</td>
                        <td>fas fa-fw fa-file-pdf</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="XML Report (*.xml)" Icon="far fa-fw fa-file-code" />
                        </td>
                        <td>XML Report (*.xml)</td>
                        <td>far fa-fw fa-file-code</td>
                    </tr>
                    <tr>
                        <td>
                            <insite:Button runat="server" ButtonStyle="Default" Text="Images" Icon="fas fa-fw fa-image" />
                        </td>
                        <td>Images</td>
                        <td>fas fa-fw fa-image</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
...
&lt;insite:FindSurveyForm runat="server" MaxSelectionCount="0" /&gt;
...
&lt;insite:FindEvent runat="server" MaxSelectionCount="0" /&gt;
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <br />
                    <insite:FindSurveyForm runat="server" ID="FindSurvey1" MaxSelectionCount="0" />
                    Find multiple surveys<br />
                    <br />
                ...
                <div class="col-md-4">
                    ...
                    <br />
                    <insite:FindSurveyForm runat="server" ID="FindSurvey2" />
                    Find one survey only<br />
                    <br />
                ...
                <div class="col-md-4">
                    ...
                    <br />
                    <insite:FindSurveyForm runat="server" ID="FindSurvey3" MaxSelectionCount="3" />
                    Find at most 3 surveys<br />
                    <br />
...
&lt;insite:InSiteValidationSummary runat="server" /&gt;
        ...
        <insite:NavItem runat="server" Title="Page">
            ...
            <b>Surveys</b>
            <insite:Accordion runat="server">
                <insite:AccordionPanel runat="server" Icon="far fa-check-square" Title="Surveys">
                    Surveys -> check-square
                </insite:AccordionPanel>
                ...
                <insite:AccordionPanel runat="server" Icon="far fa-poll-people" Title="Survey Responses">
                    Survey Responses, Voter responses (registrations)  -> poll-people
                </insite:AccordionPanel>
                ...
                <insite:AccordionPanel runat="server" Icon="far fa-clone" Title="Multiple Submissions per Survey Respondent">
                    Multiple Submissions per Survey Respondent -> clone
                </insite:AccordionPanel>
            </insite:Accordion>
