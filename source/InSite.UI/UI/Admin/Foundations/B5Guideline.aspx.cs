...
{
    public partial class B5Guideline : AdminBasePage
    {
        public string AroundHomeUrl => "#";
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            FindAchievement1.Filter.OrganizationIdentifier = Organization.Identifier;
            FindAchievement2.Filter.OrganizationIdentifier = Organization.Identifier;
            FindAchievement3.Filter.OrganizationIdentifier = Organization.Identifier;
        ...
        private class ProgressExample
        {
            ...
            private B5Guideline Page;

            #endregion

            #region Initialization and Loading

            public ProgressExample(B5Guideline page)
            {
                Page = page;
            }
