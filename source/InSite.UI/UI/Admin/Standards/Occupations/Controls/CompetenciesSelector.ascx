<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompetenciesSelector.ascx.cs" Inherits="InSite.Admin.Standards.Occupations.Controls.CompetenciesSelector" %>

<%@ Register TagPrefix="uc" TagName="Repeater" Src="~/UI/Admin/Standards/Occupations/Controls/CompetenciesSelectorRepeater.ascx" %>

<insite:UpdateProgress runat="server" AssociatedUpdatePanelID="UpdatePanel" />

<insite:UpdatePanel runat="server" ID="UpdatePanel">
    <ContentTemplate>
        <insite:FindStandard runat="server" ID="FrameworkSelector" EmptyMessage="Framework" Width="400" />
        ...
        <div style="padding-top:5px;">
            <insite:Button runat="server" ID="ExpandAllButton" ButtonStyle="Default" Icon="fas fa-fw fa-chevron-down" Text="Expand All" />
            <insite:ComboBox runat="server" ID="ExpandLevelSelector" ButtonSize="Small" Width="80px" />
            <insite:Button runat="server" ID="CollapseAllButton" ButtonStyle="Default" Icon="fas fa-fw fa-chevron-up" Text="Collapse All" />
        </div>
...
<insite:PageHeadContent runat="server" ID="CommonStyle">
    ...
    <link type="text/css" rel="stylesheet" href="/UI/Admin/standards/standards/content/styles/outline.css">
        ...
        (function () {
            ...
            function onLoad() {
                inSite.common.treeView.init($('#<%= Container.ClientID %> > .tree-view'), {
                    ...
                    state: 'admin.standards.documents.treeView.state.all'
                });
