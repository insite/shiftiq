        ...
        <insite:Nav runat="server">
            <insite:NavItem runat="server" ID="CompetenciesTab" Title="Competencies">
                ...
                <div id="CommandButtons" runat="server" class="reorder-trigger reorder-hide pb-2">
                    <insite:Button runat="server" ID="SelectAllButton" ButtonStyle="Default" ToolTip="Select All" Icon="far fa-fw fa-square" />
                    <insite:Button runat="server" ID="UnselectAllButton" ButtonStyle="Default" ToolTip="Deselect All" style="display:none;" Icon="far fa-fw fa-check-square" />
                    <insite:Button runat="server" ID="PreDeleteButton" ButtonStyle="Default" ToolTip="Delete Selected Competencies" Icon="fas fa-fw fa-trash-alt" />
                </div>
