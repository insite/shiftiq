    ...
    <section class="pb-5 mb-md-2" runat="server">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/standards/upload" runat="server" id="UploadStandardsRow"><i class="fas fa-fw fa-upload me-1"></i>Upload Standards</a>
                        <a class="me-3" href="/ui/admin/standards/troubleshoot" runat="server" id="TroubleshootStanradrs"><i class="fas fa-fw fa-screwdriver-wrench me-1"></i>Troubleshoot Standards</a>
                    </div>
                </div>
    ...
    <section class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body"> 
                ...
                <div class="row mt-4">
                <div class="col-lg-12">
                    <a class="me-3" href="/ui/admin/standards/documents/analysis"><i class="fas fa-fw fa-file-search me-1"></i>Documents Analysis</a>
                </div>
            </div>
            </div>
