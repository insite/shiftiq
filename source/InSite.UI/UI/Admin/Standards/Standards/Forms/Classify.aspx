            ...
            <section>
                ...
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body">
                        ...
                        <div class="row pb-3">
                            <div class="col-md-6">
                                <button id="expand-all" type="button" class="btn btn-sm btn-default"><i class="fas fa-fw fa-chevron-down me-1"></i>Expand All</button>
                                <select id="expand-level" data-width="100px" class="insite-combobox"></select>
                                <button id="collapse-all" type="button" class="btn btn-sm btn-default"><i class="fas fa-fw fa-chevron-up me-1"></i>Collapse All</button>
                            </div>
                                        ...
                                        <div>
                                            <div>
                                                <div class="node-title">
                                                    <span class='text'>
                                                        <%# Eval("StandardTypeIcon") == null ? string.Empty : Eval("StandardTypeIcon", "<i class='align-middle fa-fw {0}'></i>") %>
