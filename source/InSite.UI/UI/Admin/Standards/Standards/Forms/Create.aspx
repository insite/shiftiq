                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div>
                                                            <div class="input-group">
                                                                ...
                                                                <button class="btn btn-icon btn-outline-secondary" data-upload="#<%= MarkdownFileUpload.ClientID %>" title="Browse" type="button"><i class="far fa-fw fa-folder-open"></i></button>
                                                                ...
                                                                <ItemTemplate>
                                                                    <div class="mt-1">
                                                                        ...
                                                                        <asp:Label runat="server" AssociatedControlID="LoadOutline" Style="cursor: pointer;">
                                                                            <span class="btn btn-sm btn-default mr-1"><i class='far fa-fw fa-folder-open'></i></span>
                                                                            <%# Eval("Name") %>
                                                                        </asp:Label>
                                                                    </div>
                                                                </ItemTemplate>
                            ...
                            <div>
                                <div>
                                    <div class="node-title">
                                        <div class="pre-text">
                                            <%# Eval("Icon") == null ? string.Empty : Eval("Icon", "<i class='fa-fw {0}'></i>") %>
