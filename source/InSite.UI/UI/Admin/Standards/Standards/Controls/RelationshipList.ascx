        ...
        <div runat="server" id="SectionControl">
            <div style="padding-bottom:10px; height:40px;">
                <div id="CommandButtons2" runat="server" class="reorder-trigger reorder-hide" style="padding-bottom: 10px;">
                    <insite:Button runat="server" ID="SelectAllButton" ButtonStyle="Default" ToolTip="Select All" style="padding:5px 8px;" Icon="far fa-fw fa-square" />
                    <insite:Button runat="server" ID="UnselectAllButton" ButtonStyle="Default" ToolTip="Deselect All" style="display:none; padding:5px 8px;" Icon="far fa-fw fa-check-square" />
                    <insite:Button runat="server" ID="ReorderButton" ButtonStyle="Default" ToolTip="Reorder" style="padding:5px 8px;" Icon="fas fa-fw fa-sort" />
                    <insite:Button runat="server" ID="CreateRelationshipButton" ButtonStyle="Default" ToolTip="Add Relationship" style="padding: 5px 8px;" Icon="fas fa-fw fa-plus-circle" />
                    <insite:Button runat="server" ID="PreDeleteButton" ButtonStyle="Default" ToolTip="Delete Selected Relationships" style="padding:5px 8px;" Icon="fas fa-fw fa-trash-alt" />
                </div>
            </div>
