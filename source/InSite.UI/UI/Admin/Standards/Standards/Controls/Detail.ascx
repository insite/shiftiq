        ...
        <div class="card border-0 shadow-lg mt-3">
            <div class="card-body">
                <div style="position: absolute; z-index: 1; right: 15px;">
                    ...
                    <insite:Button runat="server" ID="OutlineLink" ToolTip="Outline" ButtonStyle="Default" Text="Outline" Icon="fas fa-fw fa-sitemap" />
                    <insite:Button runat="server" ID="ClassifyLink" ToolTip="Classify" ButtonStyle="Default" Text="Classify" Icon="fas fa-fw fa-tag" />
                </div>
