...
<div class="row settings">
        ...
        <div class="row settings my-4">
            ...
            <div class="col-lg-4">
                ...
                <insite:Grid runat="server" ID="ProgramNames" HeaderStyle-CssClass="d-none" Caption="Program Name">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Value" ItemStyle-CssClass="number" />
                    </Columns>
                </insite:Grid>
            ...
            <div class="col-lg-4">
                ...
                <insite:Grid runat="server" ID="LearnerReferrers" HeaderStyle-CssClass="d-none" Caption="Referrer Name" EnablePaging="false">
                    <Columns>
                        <asp:BoundField DataField="Name" />
                        <asp:BoundField DataField="Value" ItemStyle-CssClass="number" />
                    </Columns>
            ...
            <div class="col-lg-4">
                ...
                <h3>Immigration Summaries</h3>

                <insite:Grid runat="server" ID="ImmigrationStatuses" HeaderStyle-CssClass="d-none" Caption="Immigration Status">
                    <Columns>
                        <asp:BoundField DataField="Name" />
                        <asp:BoundField DataField="Value" ItemStyle-CssClass="number" />
                    </Columns>
                ...
                <insite:Grid runat="server" ID="ImmigrationDestinations" HeaderStyle-CssClass="d-none" Caption="Immigration Destination" EnablePaging="false">
                    <Columns>
                        <asp:BoundField DataField="Name" />
                        <asp:BoundField DataField="Value" ItemStyle-CssClass="number" />
                    </Columns>
