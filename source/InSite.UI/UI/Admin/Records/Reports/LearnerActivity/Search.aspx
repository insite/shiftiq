<%@ Page Language="C#" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Records.Reports.LearnerActivity.Search" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <insite:Nav runat="server">
        ...
        <insite:NavItem runat="server" ID="SummaryTab" Icon="fas fa-download" Title="Summaries" Visible="false">
