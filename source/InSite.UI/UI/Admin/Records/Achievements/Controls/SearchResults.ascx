...
<insite:Grid runat="server" ID="Grid" DataKeyNames="AchievementIdentifier">
    <Columns>
        ...
        <asp:TemplateField ItemStyle-Wrap="false">
            <ItemTemplate>
                <asp:HyperLink runat="server" Text='<i class="fas fa-fw fa-pencil"></i>' ToolTip="View Achievement Template"
                    NavigateUrl='<%# Eval("AchievementIdentifier", "/ui/admin/records/achievements/outline?id={0}") %>' />
                <asp:HyperLink runat="server" Text='<i class="fas fa-fw fa-trash-alt"></i>' ToolTip="Delete Achievement Template"
