<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScoreDetail.ascx.cs" Inherits="InSite.Admin.Records.Items.Controls.ScoreDetail" %>
        ...
        <div class="card border-0 shadow-lg h-100">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-text">The descriptive title for this score item.</div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div>
                        <asp:RadioButtonList runat="server" ID="ItemFormat" RepeatLayout="Table">
                    ...
                    <div class="form-text">The display format of the score item.</div>
                </div>

                <div class="form-group mb-3" runat="server" id="PassPercentField">
                    <label class="form-label">
                        Passing Score (%)
                    </label>
                    <div>
                ...
                <div class="form-group mb-3" runat="server" id="MaxPointField">
                    <label class="form-label">
                        Max Point
                    </label>
                    <div>
                        <insite:NumericBox runat="server" ID="MaxPoint" DecimalPlaces="1" MinValue="0" MaxValue="100000" Width="120" style="text-align:right;" />
                    </div>
                </div>
    ...
    <div class="col-md-6">
        ...
        <div class="card border-0 shadow-lg mb-3">
            <div class="card-body">
                ...
                <h3>Credential Trigger</h3>
                <uc:AchievementPanel runat="server" ID="AchievementPanel" />

            </div>
        </div>

        <div runat="server" id="StandardsCard" class="card border-0 shadow-lg mb-3">
            <div class="card-body">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
				    <label class="form-label">Progress Completed - notification to administrator</label>
				    <div>
                        <insite:FindMessage runat="server" ID="ProgressCompletedMessageIdentifier" />
                    </div>
                    <div class="form-text">
                        Choose a notification from the Messages toolkit to be sent to administrator(s) 
                        when a learner completes progress on this grade item.
                    </div>
                </div>
...
<insite:PageFooterContent runat="server">
    <script>
        (function () {
            $("#<%= ItemFormat.ClientID %> input").on("change", function () {
                if ($(this).val() === "Point")
                    $("#<%= MaxPointField.ClientID %>").show();
                else
                    $("#<%= MaxPointField.ClientID %>").hide();
            });
        })();
    </script>
