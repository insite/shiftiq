    ...
    <section runat="server" id="GradebooksSection" class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="#recent-changes"><i class="fas fa-fw fa-history me-1"></i>Recent Changes</a>
                        <a class="me-3" href="/ui/admin/records/reports/learner-activity" runat="server" id="A4"><i class="fas fa-fw fa-file-chart-line me-1"></i>Learner Activity Report</a>
                        <a class="me-3" href="/ui/admin/records/reports/engagement-prompt" runat="server" id="A3"><i class="fas fa-fw fa-paper-plane me-1"></i>Engagement Prompts</a>
                        <a class="me-3" href="/ui/admin/records/reports/learning-mastery" runat="server" id="LearningMastery"><i class="fas fa-fw fa-ruler-triangle me-1"></i>Learning Mastery</a>
                        <a class="me-3" href="/ui/admin/records/reports/academic-year" runat="server" id="AcademicYear"><i class="fas fa-fw fa-ruler-triangle me-1"></i>Academic Year</a>
                    </div>
                </div>
    ...
    <section runat="server" id="ProgramsSection" class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a href="/ui/admin/learning/programs/enrollments/assign"><i class="fas fa-fw fa-layer-plus me-1"></i>Assign Programs to Learners</a>
                    </div>
                </div>
