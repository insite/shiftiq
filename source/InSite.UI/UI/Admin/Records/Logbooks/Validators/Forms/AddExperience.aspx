<%@ Page Language="C#" CodeBehind="AddExperience.aspx.cs" Inherits="InSite.UI.Admin.Records.Validators.Forms.AddExperience" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register TagPrefix="uc" TagName="FieldList" Src="~/UI/Portal/Records/Logbooks/Controls/FieldList.ascx" %>
<%@ Register TagPrefix="uc" TagName="CompetencyList" Src="~/UI/Portal/Records/Logbooks/Controls/CompetencyList.ascx" %>
        ...
        <insite:NavItem ID="InstructionTab" runat="server" Title="Instructions" Icon="far fa-book-open">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        <insite:NextButton runat="server" ID="NextButton1" CausesValidation="false"/>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        ...
                        <insite:NextButton runat="server" ID="NextButton2" ValidationGroup="Journal" />
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        ...
                        <insite:SaveButton runat="server" ID="SaveButton3" ValidationGroup="Journal" />
