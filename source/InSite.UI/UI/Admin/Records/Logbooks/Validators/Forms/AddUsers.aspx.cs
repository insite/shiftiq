...
namespace InSite.UI.Admin.Records.Validators.Forms
{
    public partial class AddUsers : AdminBasePage, IHasParentLinkParameters
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            AddUsersControl.SearchUrl = "/ui/admin/records/logbooks/validators/search";
            AddUsersControl.OutlineUrl = "/ui/admin/records/logbooks/validators/outline";
            AddUsersControl.ScreenUrl = "/ui/admin/records/logbooks/validators/add-users";
        }
