<%@ Page Language="C#" CodeBehind="ViewExperience.aspx.cs" Inherits="InSite.UI.Admin.Records.Validators.Entries.ViewExperience" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<%@ Register TagPrefix="uc" TagName="CompetencyGrid" Src="~/UI/Admin/Records/Logbooks/Entries/Controls/LogEntryCompetencyGrid.ascx" %>
<%@ Register TagPrefix="uc" TagName="CommentList" Src="~/UI/Admin/Records/Logbooks/Entries/Controls/LogEntryComments.ascx" %>
