<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Records.Validators.SearchJournal.Search" %>
<%@ Register Src="~/UI/admin/records/logbooks/validators/Controls/JournalSearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Records/Logbooks/Controls/JournalSearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
