        ...
        <asp:Repeater runat="server" ID="Repeater">
            <ItemTemplate>
                ...
                <div class="commands float-end">
                    ...
                    <a runat="server" id="DeleteLink"  href='<%# Eval("CommentIdentifier", "/admin/records/logbooks/validators/delete-journal-comment?comment={0}") %>' title="Delete Comment" class="scroll-send"><i class="icon fas fa-trash-alt"></i></a>
