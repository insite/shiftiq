<%@ Page Language="C#" CodeBehind="Delete.aspx.cs" Inherits="InSite.UI.Admin.Records.Validators.Competencies.Delete" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/Admin/Records/Logbooks/Competencies/Controls/CompetencyDetail.ascx" TagPrefix="uc" TagName="CompetencyDetail" %>
    ...
    <div class="row settings">
        <div class="col-lg-6">
            ...
            <div class="alert alert-danger" role="alert">
                ...
                Are you sure you want to delete this logged competency?	
            </div>
