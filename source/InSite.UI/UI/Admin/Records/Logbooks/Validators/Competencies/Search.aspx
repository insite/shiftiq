<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Records.Validators.Competencies.Search" %>
<%@ Register Src="./Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Records/Logbooks/Competencies/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
