<%@ Page Language="C#" CodeBehind="BulkEntry.aspx.cs" Inherits="InSite.UI.Admin.Records.Logbooks.Validators.BulkEntry" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register TagPrefix="uc" TagName="FieldList" Src="~/UI/Portal/Records/Logbooks/Controls/FieldList.ascx" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Nav runat="server" ID="Nav">
        <insite:NavItem ID="SearchTab" runat="server" Title="Search" Icon="far fa-search">
        ...
        <insite:NavItem ID="FieldsTab" runat="server" Title="Fields" Icon="far fa-list" Visible="false">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pt-3">
                        <insite:SaveButton runat="server" ID="SaveButton" ValidationGroup="Journal" DisableAfterClick="true" />
    ...
    <insite:PageFooterContent runat="server">
        <script type="text/javascript">
            (function () {
                var instance = assign = window.assign || {};
