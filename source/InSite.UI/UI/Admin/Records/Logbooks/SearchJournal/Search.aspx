<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Records.Logbooks.SearchJournal.Search" %>
<%@ Register Src="../Controls/JournalSearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="../Controls/JournalSearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
