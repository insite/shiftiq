<%@ Page Language="C#" CodeBehind="Content.aspx.cs" Inherits="InSite.Admin.Records.Logbooks.Content" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <section runat="server" ID="GeneralSection" class="mb-3">
        <h2 class="h4 mb-3">
            ...
            Change Logbook Content
        </h2>

        <div class="card border-0 shadow-lg">
            <div class="card-body">
            <uc:ContentEditor runat="server" ID="ContentEditor" ValidationGroup="JournalSetup" />
            </div>
        </div>
    </section>
