...
<div id="journal-tree-accordion-panel">
    <div class="row">
        <div class="col-md-6">
            <button id="grade-expand-all" type="button" class="btn btn-default"><i class="fas fa-fw fa-chevron-down me-1"></i>Expand All</button>
            <button id="grade-collapse-all" type="button" class="btn btn-default"><i class="fas fa-fw fa-chevron-up me-1"></i>Collapse All</button>
        </div>
    </div>
