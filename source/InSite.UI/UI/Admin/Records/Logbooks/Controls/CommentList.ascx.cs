    ...
    public partial class CommentList : BaseUserControl
    {
            ...
            )
        {
            var commentUrl = experienceIdentifier == null
                ? $"/ui/admin/records/logbooks/create-journal-comment?journalSetup={journalSetupIdentifier}&user={userIdentifier}"
                : $"/ui/admin/records/logbooks/create-journal-comment?experience={experienceIdentifier}";
        ...
        private void Repeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            changeLink.HRef = _returnUrl
                .GetRedirectUrl($"/ui/admin/records/logbooks/change-journal-comment?comment={commentIdentifier}", "panel=comments");

            var deleteLink = (HtmlAnchor)e.Item.FindControl("DeleteLink");
            deleteLink.HRef = _returnUrl
                .GetRedirectUrl($"/ui/admin/records/logbooks/delete-journal-comment?comment={commentIdentifier}", "panel=comments");
