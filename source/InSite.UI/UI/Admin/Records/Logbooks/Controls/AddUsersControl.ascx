<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddUsersControl.ascx.cs" Inherits="InSite.UI.Admin.Records.Logbooks.Controls.AddUsersControl" %>
                    ...
                    <div class="card-body">
                        ...
                        <insite:UpdatePanel runat="server" ID="CriteriaUpdatePanel">
                            <ContentTemplate>
                                ...
                                <div runat="server" id="CriteriaEventIdentifierField" class="form-group mb-3">
                                    <label class="form-label">
                                        Class
                                    </label>
                                    <insite:FindEvent runat="server" ID="CriteriaEventIdentifier" ShowPrefix="false" />
                                </div>
                            </ContentTemplate>
                        </insite:UpdatePanel>
