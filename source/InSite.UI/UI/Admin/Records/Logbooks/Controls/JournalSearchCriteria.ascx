<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JournalSearchCriteria.ascx.cs" Inherits="InSite.Admin.Records.Logbooks.Controls.JournalSearchCriteria" %>
