<%@ Page Language="C#" CodeBehind="UserJournal.aspx.cs" Inherits="InSite.Admin.Records.Logbooks.UserJournal" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="Controls/UserJournalTree.ascx" TagName="UserJournalTree" TagPrefix="uc" %>
<%@ Register Src="Controls/UserCompetencySummary.ascx" TagName="UserCompetencySummary" TagPrefix="uc" %>
