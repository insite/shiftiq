...
{
    public partial class OutlineJournal : AdminBasePage
    {
        ...
        private void LoadData()
        {
            ...
            {
                HttpResponseHelper.Redirect("/ui/admin/records/logbooks/searchjournal/search");
                return;
            }
            ...
            LogbookDetail.BindLogbook(JournalSetupIdentifier, journalSetup, User.TimeZone, false);
                ...
                .Select(x =>
                {
                    ...
                    return new
                    {
                        ...
                        ViewExperienceUrl = returnUrl
                            .GetRedirectUrl($"/ui/admin/records/logbooks/entries/view-experience?experience={x.ExperienceIdentifier}"),
                        DeleteUrl = $"/ui/admin/records/logbooks/entries/delete?experience={x.ExperienceIdentifier}"
                    };
                })
