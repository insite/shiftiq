                ...
                <div class="card-body">
                    ...
                    <asp:Panel runat="server" ID="GradePanel">
                        <div id="grade-tree-accordion-panel">
                            <div class="row">
                                <div class="col-md-12">
                                    <button id="grade-expand-all" type="button" class="btn btn-sm btn-default d-inline"><i class="fas fa-fw fa-chevron-down me-1"></i>Expand All</button>
                                    <button id="grade-collapse-all" type="button" class="btn btn-sm btn-default d-inline"><i class="fas fa-fw fa-chevron-up me-1"></i>Collapse All</button>
                                </div>
                            </div>
