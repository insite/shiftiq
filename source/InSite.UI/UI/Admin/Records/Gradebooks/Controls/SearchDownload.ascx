...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <h4>Other</h4>
        <div>
            <insite:Button runat="server" ID="OutcomeSummaryReportButton" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-file-excel" Text="Outcome Summary (*.xlsx)" />
        </div>
