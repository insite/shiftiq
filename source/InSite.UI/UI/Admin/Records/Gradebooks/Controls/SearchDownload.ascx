<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchDownload.ascx.cs" Inherits="InSite.Admin.Records.Gradebooks.Controls.SearchDownload" %>
...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <h4>Other</h4>
        <div>
            <insite:Button runat="server" ID="OutcomeSummaryReportButton" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Outcome Summary (*.xlsx)" />
        </div>
