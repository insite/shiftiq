    ...
    <Columns>
        ...
        <asp:TemplateField ItemStyle-Width="100px">
            <ItemTemplate>
                ...
                <asp:HyperLink runat="server" Text='<i class="fas fa-fw fa-pencil"></i>' ToolTip="View Achievement" 
                    NavigateUrl='<%# Eval("CredentialIdentifier", "/ui/admin/records/credentials/outline?id={0}") %>' />

                <asp:HyperLink runat="server" Text='<i class="fas fa-fw fa-trash-alt"></i>' ToolTip="Delete Achievement"
                    NavigateUrl='<%# Eval("CredentialIdentifier", "/ui/admin/records/credentials/delete?id={0}") %>' />

                <asp:HyperLink runat="server" Text='<i class="fas fa-fw fa-award"></i>' ToolTip="Download Certificate"
                ...
                <insite:IconButton runat="server" Name="fas fa-fw fa-award" ToolTip="Download Badge"
