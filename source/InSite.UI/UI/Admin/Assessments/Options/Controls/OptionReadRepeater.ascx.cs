...
";
        ...
        protected string GetTrueOrFalseOptionIcon(decimal value) => value > 0
            ? $"<i class='text-{FlagType.Green.GetContextualClass()} far fa-fw fa-check-circle'></i>"
            : $"<i class='text-{FlagType.Red.GetContextualClass()} far fa-fw fa-times-circle text-danger'></i>";
        ...
        protected string GetMultipleCorrectOptionIcon(bool? isTrue) =>
            !isTrue.HasValue
                ? "<i class='far fa-fw fa-exclamation-triangle text-warning' title='Not Configured'></i>"
                : isTrue.Value
