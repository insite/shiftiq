<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultipleCorrectOptionRepeater.ascx.cs" Inherits="InSite.Admin.Assessments.Options.Controls.MultipleCorrectOptionRepeater" %>

<h3 class="table-write-header">
    <span style="width:381px;">
        <span style="width:155px;">Correct</span>
        <span>Cut Score (%)</span>
    </span>
    Options
</h3>
    ...
    <ItemTemplate>
        <tr data-id='<%# Eval("Sequence") %>'>
            ...
            <td style="width:155px;">
                <insite:ComboBox runat="server" ID="PointsFor" CssClass="w-75">
                    <Items>
                ...
                <insite:RequiredValidator runat="server" ID="PointsForRequiredValidator" FieldName="Option Points For" ControlToValidate="PointsFor" />
            </td>
