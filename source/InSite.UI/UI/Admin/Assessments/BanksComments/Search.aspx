<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Assessments.BanksComments.Search" %>
<%@ Register Src="./Controls/BankCommentaryCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="./Controls/BankCommentaryResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
