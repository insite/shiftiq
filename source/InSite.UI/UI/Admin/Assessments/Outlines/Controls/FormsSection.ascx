    ...
    <ContentTemplate>
        <div class="row mb-3">
            ...
            <div class="col-lg-6 text-end">
                ...
                <insite:Button runat="server" ID="ReorderFieldsButton" ButtonStyle="Default" ToolTip="Reorder the questions on this form" Text="Reorder" Icon="fas fa-fw fa-sort" />
                ...
                <insite:Button runat="server" ID="FormWorkshopButton" ButtonStyle="Default" ToolTip="Workshop" Text="Workshop" Icon="far fa-fw fa-industry-alt" />
