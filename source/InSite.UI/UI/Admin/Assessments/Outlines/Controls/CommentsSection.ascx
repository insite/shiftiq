    ...
    <ItemTemplate>
        ...
        <h5 class="mb-0">
            ...
            <div class="d-inline-block ms-3 fs-6">
                ...
                <a runat="server" visible='<%# CanWrite %>' href='<%# GetRedirectUrl("/admin/assessments/comments/delete?bank={0}&comment={1}&return=bank", Eval("BankID"), Eval("CommentID")) %>' title="Delete Comment" class="scroll-send"><i class="icon fas fa-fw fa-trash-alt"></i></a>
                <a runat="server" visible='<%# CanWrite %>' href='<%# GetRedirectUrl("/ui/admin/assessments/comments/revise?bank={0}&comment={1}&return=bank", Eval("BankID"), Eval("CommentID")) %>' title="Revise Comment" class="scroll-send"><i class="icon fas fa-fw fa-pencil"></i></a>
