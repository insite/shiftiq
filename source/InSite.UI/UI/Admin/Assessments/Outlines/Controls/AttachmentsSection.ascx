...
<div class="row" style="padding-bottom:18px;">
    ...
    <div class="col-lg-6 text-end">
        <insite:Button runat="server" id="AddAttachmentButton" ButtonStyle="Default" ToolTip="Add Attachment" Text="Add Attachment" Icon="fas fa-fw fa-plus-circle" />
        <insite:Button runat="server" id="ScanImagesLink" ButtonStyle="Default" ToolTip="Scan Images" Text="Scan Images" Icon="fas fa-fw fa-images" />
    </div>
</div>
