<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PerformanceReportGrid.ascx.cs" Inherits="InSite.UI.Admin.Assessments.Attempts.Controls.PerformanceReportGrid" %>
    ...
    <script>
        (function () {
            ...
            function enableButtons() {
                ...
                <%-- Selects report buttons from PerformanceReport --%>
