...
<div runat="server" ID="NoResponsesMessage" Visible="false">
    No responses to this survey have been submitted.
</div>
        ...
        <ContentTemplate>
                ...
                <div class="text-center mt-3 chart-date-selector">
                    <div class="d-inline-block">
                        <div class="input-group">
                            <insite:Button runat="server" ID="PagePrevButton" Icon="fas fa-fw fa-chevron-left" ButtonStyle="OutlineSecondary" />
                            <insite:TextBox runat="server" ID="PageTitle" ReadOnly="true" CssClass="text-center bg-white form-control-sm" />
                            <insite:Button runat="server" ID="PageNextButton" Icon="fas fa-fw fa-chevron-right" ButtonStyle="OutlineSecondary" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div runat="server" id="ChartContainer" class="mt-3">
                <div class="mb-2 text-center zoom-selector mb-3">
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-action="zoom-in"><i class="fa fa-fw fa-search-plus me-1"></i>Zoom In</button>
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-action="zoom-out"><i class="fa fa-fw fa-search-minus me-1"></i>Zoom Out</button>
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-action="zoom-actual"><i class="fa fa-fw fa-search me-1"></i>Actual Size</button>
                </div>
