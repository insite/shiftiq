<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ResultStatisticExam.ascx.cs" Inherits="InSite.Admin.Assessments.Attempts.Controls.ResultStatisticExam" %>
...
<div class="row bell-curve-stats mb-3">
    <div class="col-md-6">
        ...
        <table class="table table-striped mb-0">
            <tr>
                <td class="text-end">Attempts Started:</td>
                <td class="text-start"><asp:Literal runat="server" ID="AttemptStartedCount" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-end">Maximum Possible Points:</td>
                <td class="text-start"><asp:Literal runat="server" ID="FormPoints" /></td>
            </tr>
            <tr>
    ...
    <div class="col-md-6">
        ...
        <table class="table table-striped mb-0">
            ...
            <tr>
                <td class="text-end">Cronbach-&alpha; Test Reliability:</td>
                <td class="text-start"><asp:Literal runat="server" ID="TestReliability" /></td>
            </tr>
        </table>
