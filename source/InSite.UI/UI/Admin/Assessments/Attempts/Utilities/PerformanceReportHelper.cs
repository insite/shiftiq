...
namespace InSite.UI.Admin.Assessments.Attempts.Utilities
{
    static class PerformanceReportHelper
    {
        ...
        public static void SaveReportToCase(ReportConfig reportConfig, VPerformanceReportFilter filter, bool useAlternateFramework, Guid issueId)
        {
            ...
            var props = CreatePRFileProps(reportConfig, filter, useAlternateFramework);
        ...
        private static FileProperties CreatePRFileProps(ReportConfig reportConfig, VPerformanceReportFilter filter, bool useAlternateFramework)
        {
        ...
        {
            var tags = JsonConvert.DeserializeObject<List<Tuple<string, List<string>>>>(questionTags);
