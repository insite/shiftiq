                            ...
                            <div runat="server" id="FileUploadField" class="form-group mb-3">
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-secondary btn-icon" data-upload="#<%= FileUpload.ClientID %>" title="Browse" type="button"><i class="far fa-fw fa-folder-open"></i></button>
                                        <insite:Button runat="server" ID="FileUploadButton" ToolTip="Upload" ButtonStyle="OutlineSecondary" Size="Default" Icon="far fa-fw fa-upload"
