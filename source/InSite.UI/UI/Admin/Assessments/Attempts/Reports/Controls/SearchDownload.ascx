...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <h4>Other</h4>
        <div>
            <insite:Button runat="server" ID="AttemptsQTIButton" ButtonStyle="Default" style="width:100%; text-align:left;" Text="Attempts QTI Format (*.xml)" Icon="far fa-file-code" />
        </div>
