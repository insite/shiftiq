    ...
    <section runat="server" id="AttemptSection" class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="mt-4">
                    <a class="me-3" href="/ui/admin/assessments/attempts/ad-hoc"><i class="fas fa-fw fa-chart-bar me-1"></i>Ad-Hoc Attempt Report</a>
                    <%-- <a class="me-3" href="/ui/admin/assessments/attempts/advanced-analytics" runat="server" id="A1"><i class="fas fa-fw fa-chart-network me-1"></i>Advanced Analytics</a> --%>
                    <%-- <a class="me-3" href="/admin/assessments/reports/attempt-comments" runat="server" id="SearchAttemptsRow"><i class="fas fa-fw fa-comments me-1"></i>Attempt Comments</a> --%>
                    <a class="me-3" href="/ui/admin/assessments/attempts/upload" runat="server" id="UploadAttemptsRow"><i class="fas fa-fw fa-upload me-1"></i>Upload Attempts</a>
                    <a class="me-3" href="/ui/admin/assessments/attempts/performance-report" runat="server" id="PerformanceReportLink">
                        <i class="fas fa-fw fa-balance-scale me-1"></i>
                        Performance Report
                    </a>
