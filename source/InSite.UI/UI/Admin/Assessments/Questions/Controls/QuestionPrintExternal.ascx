    ...
    <style type="text/css">
        ...
        table.question {
            ...
            table.question > tbody > tr > td > .table-boolean {
                ...
                table.question > tbody > tr > td > .table-boolean > tbody > tr > td > i.fa-fw {
                    font-size: 1.4em;
                    color: #ddd;
                }
            ...
            table.question > tbody > tr > td > .table-likert {
                ...
                table.question > tbody > tr > td > .table-likert > tbody > tr > td.ovalue {
                    ...
                    table.question > tbody > tr > td > .table-likert > tbody > tr > td.ovalue > i.fa-fw {
                        font-size: 1.4em;
                        color: #ddd;
                    }
            ...
            table.question > tbody > tr > td > .table-ordering {
                ...
                table.question > tbody > tr > td > .table-ordering > tbody > tr > td {
                    ...
                    table.question > tbody > tr > td > .table-ordering > tbody > tr > td.oicon {
                        ...
                        table.question > tbody > tr > td > .table-ordering > tbody > tr > td.oicon > i.fa-fw {
                            font-size: 1.4em;
                            color: #ddd;
                        }
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <asp:Repeater runat="server" ID="LikertOptionRepeater">
                                                            <ItemTemplate>
                                                                <td class="ovalue"><i class="fal fa-fw fa-square"></i></td>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                    </tr>
                                                </ItemTemplate>
