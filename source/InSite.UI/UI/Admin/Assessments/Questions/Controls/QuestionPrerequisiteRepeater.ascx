    ...
    <div class="col-lg-6">
        ...
        <div class="card border-0 shadow-lg h-100">
            <div class="card-body">
                ...
                <div>
                    <insite:Button runat="server" ID="AddPrerequisiteButton" CausesValidation="false" ButtonStyle="Default" ToolTip="Add New Prerequisite" Text="New Prerequisite" Icon="fas fa-fw fa-plus-circle" />
                </div>
                <div>
