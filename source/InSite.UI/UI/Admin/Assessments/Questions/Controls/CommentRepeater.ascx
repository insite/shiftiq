            ...
            <div class="row">
                ...
                <div class="col-md-1 text-end">
                    ...
                    <insite:Container runat="server" visible='<%# AllowEdit %>'>
                        <a href='<%# GetRedirectUrl("/ui/admin/assessments/comments/revise?bank={0}&comment={1}", Eval("BankID"), Eval("CommentID")) %>' title="Revise Comment" class="scroll-send d-block mb-1"><i class="icon fas fa-fw fa-pencil"></i></a>
                        <a runat="server" data-action="hide" data-id='<%# Eval("CommentID") %>' visible='<%# AllowHide %>' class="d-block mb-1"><i class="icon fas fa-fw"></i></a>
                        <a href='<%# GetRedirectUrl("/admin/assessments/comments/delete?bank={0}&comment={1}", Eval("BankID"), Eval("CommentID")) %>' title="Delete Comment" class="scroll-send d-block mb-1"><i class="icon fas fa-fw fa-trash-alt"></i></a>
                    </insite:Container>
                </div>
            </div>
        </div>
