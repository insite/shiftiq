<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuestionPreviewTrueOrFalse.ascx.cs" Inherits="InSite.Admin.Assessments.Questions.Controls.QuestionPreviewTrueOrFalse" %>
