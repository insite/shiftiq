<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Assessments.Publications.Forms.Search" %>

<%@ Register Src="~/UI/Admin/Assessments/Publications/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Assessments/Publications/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
