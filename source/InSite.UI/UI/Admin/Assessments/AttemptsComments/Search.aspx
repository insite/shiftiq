<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Assessments.AttemptsComments.Search" %>
<%@ Register Src="./Controls/AttemptCommentsCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="./Controls/AttemptCommentsResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
