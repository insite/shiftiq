<%@ Page Language="C#" CodeBehind="Content.aspx.cs" Inherits="InSite.UI.Admin.Assessments.Criteria.Forms.Content" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <section class="mb-3">
        ...
        <h2 class="h4 mb-3">
            ...
            Change Question Criterion Content
        </h2>
