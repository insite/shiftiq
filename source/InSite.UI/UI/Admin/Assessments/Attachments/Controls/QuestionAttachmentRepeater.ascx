...
<asp:Repeater runat="server" ID="Repeater">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td class="text-end">
                <insite:Button runat="server" NavigateTarget="_blank" NavigateUrl='<%# (string)Eval("Url") + "?download=1" %>' ButtonStyle="Primary" ToolTip="Download" Icon="fas fa-fw fa-download" />
            </td>
        </tr>
    </ItemTemplate>
</asp:Repeater>
