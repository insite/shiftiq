                                    ...
                                    <tr>
                                        ...
                                        <td class="info-value">
                                            ...
                                            <div class="d-inline-block float-end">
                                                <a runat="server" visible="<%# CanWrite %>" title="Edit Attachment" href='<%# GetEditUrl() %>'><i class="far fa-fw fa-pencil"></i></a>
                                                <a runat="server" visible="<%# CanWrite %>" title="Delete Attachment" href='<%# GetRemoveUrl() %>'><i class="far fa-fw fa-trash-alt text-danger"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="info-value">
                                                ...
                                                <div class="d-inline-block ms-2">
                                                    <a title="View Change History" href='<%# GetHistoryUrl() %>'><i class="fas fa-fw fa-history"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </insite:Container>
                                    <insite:Container runat="server" Visible='<%# (int)Eval("QuestionsCount") > 0 %>'>
                                        <tr>
                                            ...
                                            <td class="info-value">
                                                <%# Eval("QuestionsCount") %>
                                                <div class="d-inline-block ms-2">
                                                    <a title="View Usage Statistic" href='<%# GetUsageUrl() %>'><i class="fas fa-fw fa-chart-pie"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    </insite:Container>
