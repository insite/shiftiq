                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-end">
                                                <insite:Button runat="server" ID="AddAllButton" Icon="fas fa-fw fa-plus-circle" ButtonStyle="Default" ToolTip="Add All Attachments"
                                ...
                                <tr>
                                    ...
                                    <td class="img-cmd">
                                        <insite:Button runat="server" visible='<%# Eval("FileSize") != null %>' NavigateUrl='<%# Eval("Url") %>' ButtonStyle="Primary" NavigateTarget="_blank" 
                                            ToolTip="Download" Icon="fas fa-fw fa-download" />
                                        <insite:Button runat="server" ID="AddOneButton" ToolTip="Add Attachment" Icon="fas fa-fw fa-plus-circle" ButtonStyle="Default"
