<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchCriteria.ascx.cs" Inherits="InSite.Admin.Assessments.Forms.Controls.SearchCriteria" %>
        ...
        <div id="toolbox" class="toolbox-section">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="mb-2">
                        <insite:ComboBox runat="server" ID="Status" EmptyMessage="Publication Status" />
                    </div>
                </div>
            </div> 
        </div>
