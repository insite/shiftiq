<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormPopupSelector.ascx.cs" Inherits="InSite.Admin.Assessments.Forms.Controls.FormPopupSelector" %>

<%@ Register Src="FormPopupSelectorWindow.ascx" TagName="PopupWindow" TagPrefix="uc" %>

<insite:PageHeadContent runat="server" ID="StyleLiteral">
    <style type="text/css">
        .bankform-popup-selector-input {
        }

            .bankform-popup-selector-input input[type="text"] {
                background-color: #fff !important;
            }

            .bankform-popup-selector-input a.btn-open,
            .bankform-popup-selector-input a.btn-clear {
                display: block;
                position: absolute;
                line-height: 44px;
                padding: 0 6px;
...
<div>
    <div style="position: relative;" class="bankform-popup-selector-input">
    ...
    <script type="text/javascript">
        (function () {
            ...
            function onPopupOpenClick(e) {
                ...
                bankFormPopupSelectorWindow.<%= PopupWindow.ClientID %>.open({
