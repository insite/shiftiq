<%@ Page Language="C#" CodeBehind="ChangeFormNotification.aspx.cs" Inherits="InSite.Admin.Assessments.Forms.Forms.ChangeFormNotification" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body">
                        <h3>Update Form Attempt Notifications</h3>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div>
                                <insite:FindMessage runat="server" ID="WhenAttemptStartedNotifyAdminMessageIdentifier" />
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div>
                                <insite:FindMessage runat="server" ID="WhenAttemptCompletedNotifyAdminMessageIdentifier" />
                            </div>
                        </div>
