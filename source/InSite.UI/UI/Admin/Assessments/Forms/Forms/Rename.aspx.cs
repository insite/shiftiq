...
namespace InSite.Admin.Assessments.Forms.Forms
{
    public partial class Rename : AdminBasePage, IHasParentLinkParameters
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!CanEdit)
            {
                ShowAlert(a => a.ShowPermissionDenied("rename assessment forms"));
                return;
            }
        ...
        private void Save()
        {
            ServiceLocator.SendCommand(new ChangeFormName(BankID, FormID, Name.FormNameInput));
