<%@ Page Language="C#" CodeBehind="Modify.aspx.cs" Inherits="InSite.Admin.Issues.Comments.Forms.Revise" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
                ...
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <insite:DeleteButton runat="server" ID="RemoveButton" Visible="false" />
