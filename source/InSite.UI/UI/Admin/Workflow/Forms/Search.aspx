<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.Admin.Workflow.Forms.Search" %>

<%@ Register Src="~/UI/Admin/Workflow/Forms/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Workflow/Forms/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
