<%@ Page Language="C#" CodeBehind="Search.aspx.cs" Inherits="InSite.Admin.Workflow.Forms.Submissions.Search" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/Admin/Workflow/Forms/Submissions/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Workflow/Forms/Submissions/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
