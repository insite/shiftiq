<%@ Page Language="C#" CodeBehind="Unlock.aspx.cs" Inherits="InSite.Admin.Workflow.Forms.Submissions.Unlock" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Alert runat="server" ID="ConfirmAlert" Indicator="Information">
        Are you sure you want to unlock this form submission?
    </insite:Alert>
