<%@ Page CodeBehind="SendEmail.aspx.cs" Inherits="InSite.UI.Admin.Issues.Outlines.Forms.SendEmail" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
    ...
    <insite:UpdatePanel runat="server" ID="UpdatePanel">
        <ContentTemplate>
            ...
            <insite:Nav runat="server">
                        ...
                        <div class="card border-0 shadow-lg">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3" runat="server" id="ShowMessageTemplate" visible="false">
                                            <label class="form-label">
                                                Message Template
                                            </label>
                ...
                <insite:NavItem runat="server" ID="ConfirmTab" Icon="far fa-envelope-open-text" Title="Confirm">
                    <section class="my-3">
                        <div class="card border-0 shadow-lg">
                            <div class="card-body">
