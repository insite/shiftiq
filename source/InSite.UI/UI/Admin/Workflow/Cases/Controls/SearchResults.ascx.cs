...
namespace InSite.Admin.Issues.Controls
{
    public partial class SearchResults : SearchResultsGridViewController<QIssueFilter>
    {
        ...
        private Dictionary<Guid, bool> SelectedItems
        {
            get
            {
                if (ViewState["SelectedItems"] == null)
                    ViewState["SelectedItems"] = new Dictionary<Guid, bool>();

                return (Dictionary<Guid, bool>)ViewState["SelectedItems"];
            }
            set
            {
        ...
        public bool IsCheckboxColumnVisible
        {
            get
            {
                if (ViewState["IsCheckboxColumnVisible"] == null)
                    ViewState["IsCheckboxColumnVisible"] = false;

                return (bool)ViewState["IsCheckboxColumnVisible"];
            }
            set
            {
                ViewState["IsCheckboxColumnVisible"] = value;
            }
        }
        #endregion
        ...
        private void Grid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            CheckBox chkSelect = (CheckBox)e.Row.FindControl("SelectCase");
            Guid itemId = (Guid)Grid.DataKeys[e.Row.RowIndex].Value;
        ...
        private void SaveBulkButton_Click(object sender, EventArgs e)
        {
            ...
            Guid? issueStatusId = GetIssueStatusId();
        ...
        protected void SelectAllCases_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                CheckBox chkSelect = (CheckBox)row.FindControl("SelectCase");
                if (chkSelect != null)
                {
        ...
        {
            string scrollPosition = hfScrollPosition.Value;
