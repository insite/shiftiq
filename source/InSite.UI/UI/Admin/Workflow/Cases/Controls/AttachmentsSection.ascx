...
<div class="mt-4 mb-4">
    <insite:Button runat="server" ID="AddAttachmentButton" ButtonStyle="Default" Text="Attach Document" Icon="fas fa-fw fa-upload" />
    <insite:Button runat="server" ID="AddRequestButton" ButtonStyle="Default" Text="Request Document" Icon="fas fa-fw fa-upload" />
</div>
