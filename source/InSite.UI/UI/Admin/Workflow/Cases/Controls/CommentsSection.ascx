                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id='item-collapse-<%# Eval("CommentIdentifier") %>' aria-labelledby='item-header-<%# Eval("CommentIdentifier") %>' data-bs-parent="#orders-accordion" style="">
                                <div class="accordion-body bg-secondary rounded-top-0 rounded-3">
                                    ...
                                    <div>
                                        <a href='<%# string.Format("/ui/admin/workflow/comments/modify?case={0}&comment={1}", Eval("IssueIdentifier"), Eval("CommentIdentifier")) %>' title="Revise Comment"><i class="icon fas fa-fw fa-pencil"></i></a>
                                        <a href='<%# string.Format("/ui/admin/workflow/comments/delete?case={0}&comment={1}", Eval("IssueIdentifier"), Eval("CommentIdentifier")) %>' title="Delete Comment"><i class="icon fas fa-fw fa-trash-alt"></i></a>
                                    </div>
