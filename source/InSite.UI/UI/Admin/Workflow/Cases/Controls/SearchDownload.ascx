<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchDownload.ascx.cs" Inherits="InSite.UI.Admin.Workflow.Cases.Controls.SearchDownload" %>
...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <div runat="server" id="CustomReportPanel" visible="false">
            <h4>Other</h4>

            <div class="mb-2">
                <insite:Button runat="server" ID="TimeSpentInStatusButton" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-file-excel" Text="Time spent in status (*.csv)" />
            </div>
        </div>
