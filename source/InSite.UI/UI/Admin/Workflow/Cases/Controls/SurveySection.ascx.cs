...
{
    public partial class SurveySection : BaseUserControl
    {
        ...
        protected ResponseSessionNavigator Navigator { get; set; }
        ...
        public void BindModelToControls(Guid issueIdentifier, Guid responseSessionIdentifier)
        {
            ...
            ResponseSessionControl.LoadCurrentStateObjects(Current, Navigator);
