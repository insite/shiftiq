...
namespace InSite.UI.Admin.Workflow.Cases.Controls
{
    public partial class SearchDownload : BaseSearchDownload
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            TimeSpentInStatusButton.Click += TimeSpentInStatusButton_Click;
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (IsPostBack)
                ...
                CustomReportPanel.Visible = Identity.IsOperator;
        }
        ...
        private void TimeSpentInStatusButton_Click(object sender, EventArgs e)
        {
            var reportCreator = new CaseTimeInStatusReport(
                ServiceLocator.IssueSearch,
                ServiceLocator.ChangeStore,
                ServiceLocator.PersonSearch,
                ServiceLocator.OrganizationSearch,
                ServiceLocator.StorageService
            );

            var csv = reportCreator.Create(Organization.Identifier, new[] { "IEN Application", "IEN Application-HCA" });

            Response.SendFile("Time spent in status", "csv", csv);
        }
