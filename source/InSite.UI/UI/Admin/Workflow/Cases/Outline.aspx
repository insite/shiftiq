...
<%@ Register TagPrefix="uc" TagName="SurveySection" Src="./Controls/SurveySection.ascx" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
	...
	<insite:Nav runat="server" ID="NavPanel">
		...
		<insite:NavItem runat="server" ID="SurveyNavItem" Title="Surveys" Icon="fas fa-check-square" Visible="false">
