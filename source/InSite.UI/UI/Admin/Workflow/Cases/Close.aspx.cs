...
{
    public partial class Close : AdminBasePage, IHasParentLinkParameters
    {
        #region Properties

        private Guid? CaseIdentifier => Guid.TryParse(Request["case"], out Guid result) ? result : (Guid?)null;
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            CloseIssueButton.Click += CloseIssueButton_Click;
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            CaseInfo.BindIssue(issue, User.TimeZone, false);

            IssueStatus.IssueType = issue.IssueType;
            IssueStatus.DataBind();
        ...
        private void CloseIssueButton_Click(object sender, EventArgs e)
        {
            if (!Page.IsValid)
                return;

            ServiceLocator.SendCommand(new CloseIssue(CaseIdentifier.Value));
