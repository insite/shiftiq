...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-3">
            ...
            <div class="row">
                <div class="col-md-4"><insite:RouteTypeComboBox runat="server" ID="ActionType" AllowBlank="False" /></div>
                <div class="col-md-8"><insite:TextBox runat="server" ID="ControllerPath" EmptyMessage="Controller Path" /></div>
            </div>
        </div>
