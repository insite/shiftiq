<%@ Page Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master"  CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Reports.Search" %>

<%@ Register TagPrefix="uc" TagName="SearchCriteria" Src="~/UI/Admin/Reports/Controls/SearchCriteria.ascx" %>
<%@ Register TagPrefix="uc" TagName="SearchResults" Src="~/UI/Admin/Reports/Controls/SearchResults.ascx" %>
