...
namespace InSite.UI.Admin.Reports.Dashboards
{
    public partial class DashboardContainer : BaseUserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            _folderPath = ServiceLocator.FilePaths.GetPhysicalPathToShareFolder($@"Files\Organizations\{Organization.Identifier}\Reports\Dashboards\");
        ...
        public int UploadModel(Stream fileStream)
        {
            ...
            using (var archive = new ZipArchive(fileStream, ZipArchiveMode.Read))
            {
                ...
                var jsonFilePath = _folderPath + jsonFile.Name;
                ...
                var sqlFolderPath = _folderPath + title + "\\";
        ...
        public void DeleteModel()
        {
            ...
            var folderPath = _folderPath + Path.GetFileNameWithoutExtension(_model.File);
