            ...
            <div class="col-md-6">
                ...
                <asp:Repeater runat="server" ID="SelectedColumnRepeater">
                    ...
                    <ItemTemplate>
                        <li class="item-column">
                            ...
                            <insite:Button runat="server" Icon="far fa-fw fa-trash-alt" ToolTip='<%# Translate("Delete Column") %>'
                ...
                <div style="margin-bottom:10px">
                    ...
                    <div class="reorder-remove">
                        <insite:Button ID="ReorderColumnStartButton" runat="server" Icon="fas fa-fw fa-sort" Text="Reorder"
