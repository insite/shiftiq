<%@ Control Language="C#" CodeBehind="ProgramEnrollmentsCriteria.ascx.cs" Inherits="InSite.UI.Admin.Reports.Controls.ProgramEnrollmentsCriteria" %>
...
<insite:CustomValidator runat="server" ID="FindProgramValidator" ErrorMessage="At least one program must be selected." Display="None" />
...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="form-group mb-3">
            ...
            <insite:FindProgram runat="server" ID="FindProgram" MaxSelectionCount="0" />
        </div>
