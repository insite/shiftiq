<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StatisticsAccommodationsPivotTable.ascx.cs" Inherits="InSite.Admin.Events.Reports.Controls.StatisticsAccommodationsPivotTable" %>

<div class="row">
    <div class="col-lg-12">
        <div runat="server" id="PivotError" class="alert alert-danger" visible="false"></div>
...
<insite:PageFooterContent runat="server">
    <script type="text/javascript">
        (function () {
            ...
            var accommodationMapping = getOptionMapping(dimensionsData.accommodation);
            ...
            var $dimensionsOutput = (function () {
                ...
                for (var i = 0; i < tableData.length; i++) {
                    ...
                    if (data.accommodation !== null && accommodationMapping.hasOwnProperty(data.accommodation)) {
                        key += String(data.accommodation) + ';';
                        ...
                        .each(function () {
                            ...
                            if (filterValue && filterValue.length > 2) {
                                ...
                                if (!isNaN(entityId)) {
                                    ...
                                    if (filterName === 'Accommodation') {
                                        if (valueId === 'a:' && accommodationMapping.hasOwnProperty(entityId)) {
                                            filterText = accommodationMapping[entityId];

                                            for (var i = 0; i < tableData.length; i++) {
                                                var data = tableData[i];
                                                if (data.accommodation === entityId)
                                                    filterCount += data.count;
                                            }
                                        }
                                    } else if (filterName === 'Attendance') {
                                        if (valueId === 'b:' && attendanceMapping.hasOwnProperty(entityId)) {
                                        ...
                                        if (valueId === 'c:' && formatMapping.hasOwnProperty(entityId)) {
                                        ...
                                        if (valueId === 'd:' && examTypeMapping.hasOwnProperty(entityId)) {
                                        ...
                                        if (valueId === 'e:' && levelTypeMapping.hasOwnProperty(entityId)) {
                ...
                function inputFunc(callback) {
                    if (!hasAccommodation && !hasAttendance && !hasFormat && !hasExamType && !hasLevelType && !hasVenue)
                        return;
                    ...
                    if (hasAccommodation) {
                        var objArr = [];
                        for (var i = 0; i < dimensionsData.accommodation.length; i++)
                            objArr.push({ Accommodation: dimensionsData.accommodation[i].value });
                    ...
                    for (var i = 0; i < records.length; i++) {
                        ...
                        if (hasAccommodation && record.Accommodation) {
                            key += String(record.Accommodation) + ';';
                            record.Accommodation = 'a:' + record.Accommodation;
                        } else {
                            key += 'null;';
                        }
                        ...
                        if (hasAttendance && record.Attendance) {
                            ...
                            record.Attendance = 'b:' + record.Attendance;
                        } else {
                            key += 'null;';
                        }
                        ...
                        if (hasExamType && record['Exam Type']) {
                            ...
                            record['Exam Type'] = 'd:' + record['Exam Type'];
                        } else {
                            key += 'null;';
                        }
                        ...
                        if (hasLevelType && record['Level Type']) {
                            ...
                            record['Level Type'] = 'e:' + record['Level Type'];
                        } else {
                            key += 'null;';
                        }
                ...
                function setEntityTitle($el, html) {
                    ...
                    if (valueId === 'a:') {
                        if (accommodationMapping.hasOwnProperty(entityId))
                            result = accommodationMapping[entityId];
                    } else if (valueId === 'b:') {
