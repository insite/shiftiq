            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="text-nowrap text-end">
                        <insite:Button runat="server" Icon="fas fa-fw fa-edit" ToolTip='<%# Translate("Edit Condition") %>'
                            CommandName="EditCondition" />
                        <insite:Button runat="server" Icon="far fa-fw fa-trash-alt" ToolTip='<%# Translate("Delete Condition") %>'
