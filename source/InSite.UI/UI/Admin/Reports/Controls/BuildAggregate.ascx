            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="text-nowrap text-end">
                        <insite:Button runat="server" Icon="fas fa-fw fa-edit" ToolTip='<%# Translate("Edit Column") %>' CommandName="EditAggregate" />
                        <insite:Button runat="server" Icon="far fa-fw fa-trash-alt" ToolTip='<%# Translate("Delete Column") %>' CommandName="DeleteAggregate" />
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
