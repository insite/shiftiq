        ...
        <insite:AccordionPanel ID="AggregateSection" runat="server" Title="Summary Statistic" Icon="far fa-function" Visible="false">
            ...
            <insite:UpdatePanel runat="server" ID="AggregateUpdatePanel">
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <insite:Button runat="server" ID="AddAggregateButton" Icon="far fa-fw fa-plus-circle" Text="Add Column" ButtonStyle="Success" CausesValidation="false" />
                            <insite:NextButton runat="server" ID="NextButtonAggregate" ValidationGroup="Aggregate" />

                            <insite:Button runat="server" ID="SaveAggregateButton" Icon="fas fa-fw fa-cloud-upload" Text="Save Column" ButtonStyle="Success" ValidationGroup="AggregateEdit" />
                            <insite:Button runat="server" ID="CancelSaveAggregateButton" Icon="fas fa-fw fa-times" Text="Close" ButtonStyle="Default" CausesValidation="false" />
                        </div>
                    </div>
                </ContentTemplate>
            </insite:UpdatePanel>
        ...
        <insite:AccordionPanel ID="ConditionSection" runat="server" Title="Conditions" Icon="far fa-filter" Visible="false">
            ...
            <insite:UpdatePanel runat="server" ID="ConditionUpdatePanel">
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <insite:Button runat="server" ID="AddConditionButton" Icon="far fa-fw fa-plus-circle" Text="Add Condition" ButtonStyle="Success" CausesValidation="false" />
                            <insite:NextButton runat="server" ID="NextButtonCondition" ValidationGroup="Condition" />

                            <insite:Button runat="server" ID="SaveConditionButton" Icon="fas fa-fw fa-cloud-upload" Text="Save Condition" ButtonStyle="Success" ValidationGroup="ConditionEdit" />
                            <insite:Button runat="server" ID="CancelSaveConditionButton" Icon="fas fa-fw fa-times" Text="Close" ButtonStyle="Default" CausesValidation="false" />
                        </div>
                    </div>
                </ContentTemplate>
            </insite:UpdatePanel>
