<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Contacts.Memberships.Search" %>
...
<%@ Register Src="./Controls/SummaryTables.ascx" TagName="SummaryTables" TagPrefix="uc" %>
...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <insite:Nav runat="server">
        ...
        <insite:NavItem runat="server" ID="SummaryTab" Icon="fas fa-download" Title="Summaries">
            <uc:SummaryTables runat="server" ID="SummaryTables" />
        </insite:NavItem>
    </insite:Nav>
</asp:Content>
