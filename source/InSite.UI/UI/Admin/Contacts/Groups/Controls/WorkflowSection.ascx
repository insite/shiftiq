...
<div class="row outline">
    ...
    <div class="col-6">
        ...
        <div class="form-group mb-3">
            <div class="float-end">
                <insite:IconLink Name="pencil" runat="server" ID="ChangeMandatorySurveyFormIdentifier" ToolTip="Change Mandatory Survey Response" NavigateUrl="#" />
            </div>
			<label class="form-label">Mandatory Survey Response</label>
			<div>
                <asp:Literal runat="server" ID="MandatorySurveyFormIdentifier" />
            </div>
            <div class="form-text">Every user who joins this group must submit a response to the selected survey.</div>
        </div>
