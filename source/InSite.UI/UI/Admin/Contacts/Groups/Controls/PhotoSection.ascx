                            ...
                            <ContentTemplate>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <div class="input-group">
                                                ...
                                                <button runat="server" id="ImageOpenUpload" class="btn btn-icon btn-outline-secondary" title="Browse" type="button"><i class="far fa-fw fa-folder-open"></i></button>
                                            </div>
                                            <div class="d-none">
                                ...
                                <div class="mt-3">
                                    <insite:Button runat="server" ID="UploadButton" ButtonStyle="OutlinePrimary"
                                        Icon="fas fa-fw fa-upload" Text="Upload"
