...
<div class="row" style="padding-bottom: 18px;">
    ...
    <div class="col-md-6 text-end">
        <insite:Button runat="server" ButtonStyle="Default" OnClientClick="roleGrid.onViewMembershipHistoryClick(); return false;" Text="Group Membership History" Icon="fas fa-fw fa-history" />
