...
namespace InSite.UI.Admin.Contacts.Groups.Controls
{
    public partial class PhotoSection : UserControl
    {
        ...
        private string DataUploadPath => $@"{ServiceLocator.FilePaths.FileStoragePath}\Tenants\{CurrentSessionState.Identity.Organization.OrganizationCode}\Contacts\Groups\{GroupIdentifier}\Photos\";
