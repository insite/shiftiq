<%@ Page Language="C#" CodeBehind="Merge.aspx.cs" Inherits="InSite.UI.Admin.Contacts.Groups.Forms.Merge" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-3">Employer 1</h4>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-3">Employer 2</h4>
    ...
    <div class="row">
        <div class="col-lg-6">
            <insite:Button runat="server" ID="MergeButton" CssClass="disabled" Text="Merge" Icon="fas fa-cloud-upload" ButtonStyle="Success" />
    ...
    <insite:PageFooterContent runat="server">
        <script type="text/javascript">
            (function () {
                var $mergeButton = $('#<%= MergeButton.ClientID %>').on('click', function (e) {
                    if ($(this).hasClass('disabled') === true || !confirm('Are you sure to merge these employers?')) {
                        e.preventDefault();
                        e.stopPropagation();
                    }
                });
                ...
                function onChangeRadio() {
                    ...
                    if (totalCount == checkedCount)
                        $mergeButton.removeClass('disabled');
                    else
                        $mergeButton.addClass('disabled');
                }
            })();
        </script>
