                                        ...
                                        <insite:MultiField runat="server">
                                            ...
                                            <insite:MultiFieldView runat="server" ID="GroupStatusItemSelectorView" Inputs="GroupStatusItemIdentifier">
                                                ...
                                                <insite:Button runat="server" OnClientClick='inSite.common.multiField.nextView(this); return false;'
                                                    ButtonStyle="Default" Icon="far fa-fw fa-keyboard" ToolTip="Enter a value manually" />
                                            ...
                                            <insite:MultiFieldView runat="server" ID="GroupStatusItemTextView" Inputs="GroupStatusItemText">
                                                ...
                                                <insite:Button runat="server" OnClientClick='inSite.common.multiField.nextView(this); return false;'
                                                    ButtonStyle="Default" Icon="far fa-fw fa-list-ul" ToolTip="Select an option from the list" />
                                            </insite:MultiFieldView>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-lg mb-3">
                        <div class="card-body">
                            <h4 class="card-title mb-3">Surveys</h4>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-text">
                                    Every user who joins this group must submit a response to the selected survey.
                                </div>
                            </div>
                        </div>
                    </div>
