...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Nav runat="server">
        <insite:NavItem runat="server" ID="OutlineTab" Icon="fas fa-sitemap" Title="Outline">
            ...
            <div class="pb-3">
                <button id="expand-all" type="button" class="btn btn-outline-secondary"><i class="fas fa-fw fa-chevron-down me-1"></i> Expand All</button>
                <select id="expand-level" class="insite-combobox form-select"></select>
                <button id="collapse-all" type="button" class="btn btn-outline-secondary"><i class="fas fa-fw fa-chevron-up me-1"></i> Collapse All</button>
            </div>
