    ...
    <section class="pb-4 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/contacts/people/upload"><i class="fas fa-fw fa-upload me-2"></i>Upload Contacts</a>
                        <a runat="server" id="DownloadXLSXSection" class="me-3" href="/ui/admin/contacts/reports/tax-form-t2202"><i class="fas fa-fw fa-download me-2"></i>Canada Revenue Agency (CRA) Tax Form T2202</a>
                        <a class="me-3" href="/ui/admin/contact/persons/anomalies"><i class="fas fa-fw fa-triangle-exclamation me-2"></i>Data Anomalies</a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="v1a" role="tabpanel">
                        ...
                        <div class="row mt-4">
		                    <div class="col-lg-12">
			                    <a class="me-3" href="/ui/admin/contacts/groups/manage"><i class="fas fa-fw fa-sitemap me-2"></i>Manage Groups</a>
			                    <a class="me-3" href="/ui/admin/contacts/reports/employers"><i class="fas fa-fw fa-chart-bar me-2"></i>Employers Report</a>
		                    </div>
	                    </div>
