                    ...
                    <div class="card border-0 shadow-lg h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <insite:FileUploadV1 runat="server" ID="ImportFile" AllowedExtensions=".txt,.csv" LabelText="" />
                                <div class="form-text">
                                </div>
                            </div>
                                ...
                                <insite:MultiField runat="server">
                                    ...
                                    <insite:MultiFieldView runat="server" ID="GroupSelectorView">
                                        ...
                                        <insite:Button runat="server" OnClientClick='inSite.common.multiField.nextView(this); return false;'
                                            ButtonStyle="OutlineSecondary" Icon="far fa-fw fa-keyboard" ToolTip="Enter a value manually" />
                                    ...
                                    <insite:MultiFieldView runat="server" ID="GroupTextView">
                                        ...
                                        <insite:Button runat="server" OnClientClick='inSite.common.multiField.nextView(this); return false;'
                                            ButtonStyle="OutlineSecondary" Icon="far fa-fw fa-list-ul" ToolTip="Select an option from the list" />
                                    </insite:MultiFieldView>
