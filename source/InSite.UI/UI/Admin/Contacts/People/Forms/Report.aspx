...
<asp:Content ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="mb-3">
        <insite:Button runat="server" ID="TrainingRecordsPrintButton" ButtonStyle="Default" CssClass="no-print" Icon="far fa-fw fa-print" Text="Print Training Records" />
        <insite:Button runat="server" ID="PrintButton" ButtonStyle="Default" CssClass="no-print" icon="far fa-fw fa-print" Text="Print BCPVPA Membership Summary" />
    </div>

    <section runat="server" id="BCPVPAMembershipSection" class="pb-5 mb-md-2">

        <h2 class="h4 mb-3">BCPVPA Membership Summary</h2>
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div runat="server" id="BCPVPASchool" class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100">
                            <div class="card-body">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <asp:Literal runat="server" ID="MembershipStatus" />
                                    </div>
                                </div>
            ...
            <div class="card-body">
                ...
                <asp:Panel runat="server" ID="GradePanel">
                    <div id="grade-tree-accordion-panel">
                        <div class="row">
                            <div class="col-md-3">
                                <button id="grade-expand-all" type="button" class="btn btn-sm btn-default"><i class="fas fa-fw fa-chevron-down me-1"></i>Expand All</button>
                                <button id="grade-collapse-all" type="button" class="btn btn-sm btn-default"><i class="fas fa-fw fa-chevron-up me-1"></i>Collapse All</button>
                            </div>
                            <div class="col-md-9">
                            </div>
                        </div>
    ...
    <section runat="server" id="SurveySection" class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <asp:Literal runat="server" ID="NoSurveys" Text="No surveys to display." />
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div>
                                            <span runat="server" visible='<%# !(bool)Eval("IsLocked") %>' class='badge bg-success'>
                                                <i class='fas fa-fw fa-lock-open'></i>&nbsp;Unlocked
                                            </span>
                                            <span runat="server" visible='<%# Eval("IsLocked") %>' class='badge bg-danger'>
                                                <i class='fas fa-fw fa-lock'></i>&nbsp;Locked
                                            </span>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
