...
<%@ Register Src="~/UI/Admin/Surveys/Responses/Controls/SearchResults.ascx" TagName="SurveyResponses" TagPrefix="uc" %>
            ...
            <div class="card border-0 shadow-lg mt-3">
                <div class="card-body">
                    ...
                    <div class="float-end text-end mb-3">
                        <insite:Button runat="server" ButtonStyle="Default" OnClientClick="personEditor.onViewMembershipHistoryClick(); return false;" Text="History" Icon="fas fa-fw fa-history" />
                    </div>
            ...
            <div class="card border-0 shadow-lg mt-3">
                <div class="card-body">
                    <insite:Nav runat="server">
                        ...
                        <insite:NavItem runat="server" ID="SurveySubTab" Title="Surveys" Icon="far fa-check-square" IconPosition="BeforeText">
                            ...
                            <insite:UpdatePanel runat="server" ID="SurveyResponseUpdatePanel">
                                <ContentTemplate>
                                    <uc:SurveyResponses runat="server" ID="SurveyResponseGrid" />
                                </ContentTemplate>
                            </insite:UpdatePanel>
                        </insite:NavItem>
