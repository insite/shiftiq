...
namespace InSite.UI.Admin.Contacts.People.Controls
{
    public partial class EditTabOther : BaseUserControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (Organization.OrganizationIdentifier == OrganizationIdentifiers.BCPVPA)
                OrganizationMultiView.SetActiveView(BcpvpaView);
            else if (Organization.IsIndustrySpecialist())
                OrganizationMultiView.SetActiveView(IecbcView);
        ...
        public void SetInputValues(QPerson person)
        {
            ...
            ReferrerOther.Text = person.ReferrerOther;
            EducationLevel.Text = person.EducationLevel;
            ConsentConsultation.Text = person.ConsentConsultation;
            Citizenship.Text = person.Citizenship;
            ImmigrationNumber.Text = person.ImmigrationNumber;
            ImmigrationDestination.Text = person.ImmigrationDestination;
            ImmigrationLandingDate.Value = person.ImmigrationLandingDate;
            ImmigrationApplicant.Text = person.ImmigrationApplicant;
            ImmigrationCategory.Text = person.ImmigrationCategory;
            ImmigrationDisability.Text = person.ImmigrationDisability;
        ...
        public void GetInputValues(QUser user, QPerson person)
        {
            ...
            person.Referrer = Referrer.Text;
            person.ReferrerOther = ReferrerOther.Text;
            person.EducationLevel = EducationLevel.Text;
            person.ConsentConsultation = ConsentConsultation.Text;
            person.Citizenship = Citizenship.Text;
            person.ImmigrationNumber = ImmigrationNumber.Text;
            person.ImmigrationDestination = ImmigrationDestination.Text;
            person.ImmigrationLandingDate = ImmigrationLandingDate.Value;
            person.ImmigrationApplicant = ImmigrationApplicant.Text;
            person.ImmigrationCategory = ImmigrationCategory.Text;
            person.ImmigrationDisability = ImmigrationDisability.Text;
