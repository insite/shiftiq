...
<div class="float-end text-end mb-3">
    ...
    <insite:Button runat="server" ButtonStyle="Default" OnClientClick="personEditor.onViewPersonHistoryClick(); return false;" Text="History" Icon="fas fa-fw fa-history" />
</div>
