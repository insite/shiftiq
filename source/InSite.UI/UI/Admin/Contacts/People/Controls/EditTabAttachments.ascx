...
<div class="float-end text-end mb-3">
    <insite:Button runat="server" ID="UploadFileButton" ButtonStyle="Default" Text="Add Document" Icon="fas fa-fw fa-upload" />
</div>
...
<div runat="server" id="ResponsesCard" class="card mb-3">
    <div class="card-body">
        <h3 id="survey-attachments">Survey Attachments</h3>
