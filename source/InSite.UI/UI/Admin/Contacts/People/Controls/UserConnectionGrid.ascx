...
<asp:Panel ID="CommandButtons" runat="server" CssClass="pb-3" Visible="false">
    <insite:Button runat="server" ID="SelectAllButton" ButtonStyle="OutlinePrimary" ToolTip="Select All" style="padding:5px 8px;" Icon="far fa-fw fa-square" />
    <insite:Button runat="server" ID="UnselectAllButton" ButtonStyle="OutlinePrimary" ToolTip="Deselect All" style="display:none; padding:5px 8px;" Icon="far fa-fw fa-check-square" />
    <insite:Button  runat="server" ID="AddConnectionButton" ButtonStyle="OutlinePrimary" ToolTip="New Connection" style="padding:5px 8px;" Icon="fas fa-fw fa-plus-circle" />
    <insite:Button runat="server" ID="PreDeleteButton" ButtonStyle="OutlinePrimary" ToolTip="Delete Selected Users" style="padding:5px 8px;" Icon="fas fa-fw fa-trash-alt" />
</asp:Panel>
