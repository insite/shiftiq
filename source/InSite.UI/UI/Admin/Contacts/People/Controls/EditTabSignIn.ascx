...
<div class="float-end text-end mb-3">
    <insite:Button runat="server" ID="ImpersonateAnchor" ButtonStyle="Default" Text="Impersonate User" Icon="fas fa-fw fa-user-secret" />
    <insite:Button runat="server" ID="ResetPassword" ButtonStyle="Default" ToolTip="Reset Password" OnClientClick="personEditor.onResetPasswordClick(); return false;" Text="Reset Password" Icon="fas fa-fw fa-sync" />
</div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <div runat="server" id="JobsAccessField">
                        <label class="form-label">
                            Jobs Access
                        </label>
                        <div>
                            <insite:CheckBox ID="IsJobsApproved" runat="server" Text="Job Profile Reviewed and Approved" />
                            <p class="px-5"><asp:Literal runat="server" ID="IsJobsApprovedDateTime" Visible="false"  /></p>
                        </div>
                    </div>
                </div>
