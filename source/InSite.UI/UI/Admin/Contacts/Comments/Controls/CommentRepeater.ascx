...
<asp:Repeater runat="server" ID="Repeater">
    <ItemTemplate>
        ...
        <div>
            <a runat="server" href='<%# GetRedirectUrl("/ui/admin/contacts/comments/revise?contact={0}&comment={1}", UserIdentifier, Eval("CommentIdentifier")) %>' title="Revise Comment"><i class="icon fas fa-fw fa-pencil"></i></a>
            <a runat="server" href='<%# GetRedirectUrl("/ui/admin/contacts/comments/delete?contact={0}&comment={1}", UserIdentifier, Eval("CommentIdentifier")) %>' title="Remove Comment"><i class="icon fas fa-fw fa-trash-alt"></i></a>
        </div>
