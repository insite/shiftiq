    ...
    <section class="pb-4 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/sales/reports/event-registration-payments" runat="server" id="A4"><i class="fas fa-fw fa-file-chart-line me-1"></i>Event Registration Payments</a>
                    </div>
                </div>
    ...
    <section class="pb-4 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/sales/taxes/search"><i class="fas fa-fw fa-badge-percent me-1"></i>Taxes</a>
                    </div>
                </div>
