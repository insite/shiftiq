<%@ Page Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" CodeBehind="DashboardAuditor.aspx.cs" Inherits="InSite.UI.Admin.Prototype.DashboardAuditor" %>
                ...
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" href="#result1" data-bs-toggle="tab" role="tab" aria-controls="result1" aria-selected="true"><i class="far fa-users me-2"></i>People</a></li>
                            <li class="nav-item"><a class="nav-link" href="#result2" data-bs-toggle="tab" role="tab" aria-controls="result1" aria-selected="true"><i class="far fa-spell-check me-2"></i>Gradebooks</a></li>
                            <li class="nav-item"><a class="nav-link" href="#result3" data-bs-toggle="tab" role="tab" aria-controls="result2" aria-selected="true"><i class="far fa-award me-2"></i>Achievements</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
    ...
    <section class="pt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="col">
                    <a class="card card-hover card-tile border-1 shadow" href="/ui/admin/contacts/groups/search?label=Auditors">
                        <div class="card-body text-center text-danger">
                            <span id="ctl00_ctl00_BodyContent_BodyContent_ctl02_ShortcutRepeater_ctl02_CardIcon"><i class="far fa-users fa-3x mb-3"></i></span>
                            <h3 class="h5 nav-heading mb-2 ">Auditors</h3>
                        </div>
                    </a>
                </div>
