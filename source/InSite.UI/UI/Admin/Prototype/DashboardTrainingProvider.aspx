<%@ Page Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" CodeBehind="DashboardTrainingProvider.aspx.cs" Inherits="InSite.UI.Admin.Prototype.DashboardTrainingProvider" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <a class="card card-hover card-tile border-1 shadow" href="/ui/admin/contacts/groups/search?label=Trainers">
                            <div class="card-body text-center text-danger">
                                <span id="ctl00_ctl00_BodyContent_BodyContent_ctl02_ShortcutRepeater_ctl05_CardIcon"><i class="fas fa-users fa-3x mb-3"></i></span>
                                <h3 class="h5 nav-heading mb-2 ">Trainers</h3>
                            </div>
                        </a>
                    </div>
