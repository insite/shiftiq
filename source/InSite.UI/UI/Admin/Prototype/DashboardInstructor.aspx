<%@ Page Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" CodeBehind="DashboardInstructor.aspx.cs" Inherits="InSite.UI.Admin.Prototype.DashboardInstructor" %>
                ...
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" href="#result0" data-bs-toggle="tab" role="tab" aria-controls="result1" aria-selected="true"><i class="far fa-users me-2"></i>Learners</a></li>
                            <li class="nav-item"><a class="nav-link" href="#result1" data-bs-toggle="tab" role="tab" aria-controls="result1" aria-selected="true">Classes</a></li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="result0" role="tabpanel">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4">
                    ...
                    <div class="col">
                        <a class="card card-hover card-tile border-1 shadow" href="/ui/admin/courses/home">
                            <div class="card-body text-center">
                                <span id="ctl00_ctl00_BodyContent_BodyContent_ctl02_ToolkitRepeater_ctl03_CardIcon"><i class="fas fa-users-class fa-3x mb-3"></i></span>
                                <h3 class="h5 text-nowrap nav-heading mb-2 ">Courses</h3>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col">
                        <a class="card card-hover card-tile border-1 shadow" href="/ui/admin/records/gradebooks/instructors/search">
                            <div class="card-body text-center">
                                <span id="ctl00_ctl00_BodyContent_BodyContent_ctl02_ToolkitRepeater_ctl07_CardIcon"><i class="fas fa-spell-check fa-3x mb-3"></i></span>
                                <h3 class="h5 text-nowrap nav-heading mb-2 ">Gradebooks</h3>
                            </div>
                        </a>
                    </div>
