<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" AutoEventWireup="true" CodeBehind="LoginHistory.aspx.cs" Inherits="InSite.UI.Admin.Reporting.LoginHistory" %>

<%@ Register Src="~/UI/Admin/Reporting/Controls/LoginHistorySearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Reporting/Controls/LoginHistorySearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
