...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByGroupStatus" ButtonStyle="Default" style="width:100%; text-align:left;" Text="Classes by Employer Status (*.pdf)" Icon="far fa-fw fa-file-pdf" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByAchievement" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Classes by Achievement (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByAchievementXlsx" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Classes by Achievement (*.xlsx)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByTrade" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Classes by Trade (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByTradeXlsx" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Classes by Trade (*.xlsx)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByCertificateaAndVenue" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Classes by Certificates and Venue (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportByCertificateaAndVenueXlsx" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Classes by Certificates and Venue (*.xlsx)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportStudentsByTrade" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Students by Trade (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportStudentsByTradeXlsx" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Students by Trade (*.xlsx)" />
        </div>
    </div>
