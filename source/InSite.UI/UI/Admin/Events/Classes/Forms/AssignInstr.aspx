<%@ Page Language="C#" CodeBehind="AssignInstr.aspx.cs" Inherits="InSite.Admin.Events.Classes.Forms.AssignInstr" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
                    ...
                    <div class="card border-0 shadow-lg mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 criteria-field">
                                ...
                                <insite:GroupTypeComboBox runat="server" ID="CriteriaGroupType" ClientEvents-OnChange="assignInstr.onGroupTypeChanged" />
                            </div>
                            ...
                            <div class="form-group mb-3 criteria-field">
                                ...
                                <insite:TextBox runat="server" ID="CriteriaGroupLabel" ClientEvents-OnChange="assignInstr.onGroupLabelChanged();" />
                            </div>

                            <div runat="server" id="CriteriaGroupIdentifierField" class="form-group mb-3 criteria-field">
                                <label class="form-label">
                                    Group
                                </label>
                                                ...
                                                <asp:Repeater runat="server" ID="SearchResultRepeater">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a runat="server" visible='<%# (Guid?)Eval("EmployerOrganizationIdentifier") == Organization.OrganizationIdentifier %>' href='<%# Eval("EmployerIdentifier", "/ui/admin/contacts/groups/edit?contact={0}") %>'><%# Eval("EmployerName") %></a>
                                                                <asp:Literal runat="server" Visible='<%# (Guid?)Eval("EmployerOrganizationIdentifier") != Organization.OrganizationIdentifier %>' Text='<%# Eval("EmployerName") %>' />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
    ...
    <insite:PageFooterContent runat="server">
        <script type="text/javascript">
            (function () {
                var instance = assignInstr = window.assignInstr || {};

                $(document).ready(function () {
                    onGroupTypeChanged();
                });

                instance.onGroupTypeChanged = function () {
                    onGroupTypeChanged();
                    onGroupIdentifierParametersChanged();
                };

                instance.onGroupLabelChanged = function () {
                    onGroupIdentifierParametersChanged();
                };
                ...
                function onGroupIdentifierParametersChanged() {
                    document.getElementById('<%= CriteriaGroupIdentifier.ClientID %>').clearSelection();
                }
            })();
