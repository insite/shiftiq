...
namespace InSite.Admin.Events.Classes.Forms
{
    public partial class Create : AdminBasePage
    {
        ...
        private List<IChange> CreateOneChanges()
        {
            ...
            changes.Add(new ClassScheduled2(Organization.OrganizationIdentifier, OneEventTitle.Text, "Active", number, start, end, (int)duration, "Day", null));
        ...
        private List<Command> CreateCopyCommands(Guid id)
        {
            ...
            {
                new ScheduleClass(id, Organization.OrganizationIdentifier, CopyEventTitle.Text, "Active", number, start, end, (int)duration, "Day", @event.CreditHours)
            };
