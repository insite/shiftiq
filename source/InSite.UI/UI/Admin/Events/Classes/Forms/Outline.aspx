                                ...
                                <div class="row content-details">
                                    <div class="col-md-12">
                                        ...
                                        <insite:Nav runat="server" ID="ContentNavigation">
                                            ...
                                            <insite:NavItem runat="server" ID="ContentSurveyTab" Title="Surveys">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <insite:UpdatePanel runat="server" ID="ContentSurveyUpdatePanel">
                                                            <ContentTemplate>
                                                                <div class="form-group mb-3">
                                                                    <asp:Label runat="server" AssociatedControlID="MandatorySurveyFormIdentifier" Text="Mandatory Survey Response" CssClass="form-label" />
                                                                    <div>
                                                                        <insite:FindSurveyForm runat="server" ID="MandatorySurveyFormIdentifier" />
                                                                    </div>
                                                                    <div class="form-text">
                                                                        If a mandatory survey is added, users must submit a response before proceeding with their registration.
                                                                    </div>
                                                                </div>
                                                            </ContentTemplate>
                                                        </insite:UpdatePanel>
