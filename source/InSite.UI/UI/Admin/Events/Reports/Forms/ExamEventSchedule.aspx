<%@ Page Language="C#" CodeBehind="ExamEventSchedule.aspx.cs" Inherits="InSite.Admin.Events.Reports.Forms.ExamEventSchedule" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="../Controls/ExamEventScheduleCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="../Controls/ExamEventScheduleResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
