<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SeatGrid.ascx.cs" Inherits="InSite.Admin.Events.Exams.Controls.SeatGrid" %>
...
<insite:Grid runat="server" ID="Grid">
    ...
    <Columns>
        ...
        <asp:TemplateField ItemStyle-Width="100px">
            <ItemTemplate>
                <insite:IconLink runat="server" Name="pencil" ID="EditSeat" Type="Regular" Visible="<%# CanWrite %>"
                    ToolTip='Edit Seat' />
                <insite:IconLink runat="server" Visible="<%# CanWrite %>"
                    Name="trash-alt" Type="Regular" ID="DeleteSeat"
                    ToolTip="Delete Seat" />
            </ItemTemplate>
        </asp:TemplateField>
