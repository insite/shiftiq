    ...
    <section class="pb-5 mb-md-2" runat="server" id="ClassesPanel">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <asp:LinkButton runat="server" class="me-3" ID="DownloadClassesLearningCenterButton"><i class="far fa-fw fa-download me-1"></i>Download Classes Learning Center</asp:LinkButton>
                    </div>
                </div>
    ...
    <section class="pb-5 mb-md-2" runat="server" id="ExamsPanel">
        ...
        <h2 class="h4 mb-3">Exams</h2>
            ...
            <div class="card border-0 shadow-lg">
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/admin/events/exams/create-bulk" runat="server" id="NewExamBulkLink"><i class="far fa-fw fa-calendar-alt me-1"></i>Bulk Schedule the New Exam Events</a>
                        <a class="me-3" href="/ui/admin/events/reports/exam-event-schedule" runat="server" id="ExamEventScheduleRow"><i class="far fa-fw fa-calendar-alt me-1"></i>View the Exam Event Schedule</a>
                        <asp:LinkButton runat="server" class="me-3"  ID="DownloadExamSessionsScheduled"><i class="far fa-fw fa-download me-1"></i>Download Exam Sessions Scheduled</asp:LinkButton>
                        <asp:LinkButton runat="server" class="me-3"  ID="DownloadExamsWrittenByType"><i class="far fa-fw fa-download me-1"></i>Download Exams Written by Type</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="/ui/admin/reports/events" class="btn btn-info btn-sm"><i class="far fa-fw fa-file-chart-line me-2"></i> Summaries</a>
                    </div>
                </div>
            </div>
        </div>
