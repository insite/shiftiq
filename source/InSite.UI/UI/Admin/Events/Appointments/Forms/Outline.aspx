                ...
                <div class="card border-0 shadow-lg">
                    <div class="card-body">
                        ...
                        <dl>
                            ...
                            <dt>
                                <a runat="server" id="EventTitleLink" href="#" title="Rename appointment" class="float-end"><i class="fas fa-fw fa-pencil ms-1"></i></a>
                            ...
                            <dt>
                                <a runat="server" id="AppointmentTypeLink" href="#" title="Change appointment type" class="float-end"><i class="fas fa-fw fa-pencil ms-1"></i></a>
                            ...
                            <dt>
                                <a runat="server" id="AppointmentCalendarColorLink" href="#" title="Change appointment calendar color" class="float-end"><i class="fas fa-fw fa-pencil ms-1"></i></a>
                            ...
                            <dt>
                                <a runat="server" id="ChangeEventScheduledStart" title="Change start time" class="float-end"><i class="fas fa-fw fa-pencil ms-1"></i></a>
                            ...
                            <dt>
                                <a runat="server" id="ChangeEventScheduledEnd" title="Change end time" class="float-end"><i class="fas fa-fw fa-pencil ms-1"></i></a>
