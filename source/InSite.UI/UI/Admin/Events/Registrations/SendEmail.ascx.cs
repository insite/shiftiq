...
using RecipientInfo = InSite.UI.Admin.Events.Registrations.SendEmailModel.RecipientInfo;
...
namespace InSite.UI.Admin.Events.Registrations
{
    public partial class SendEmail : BaseUserControl
    {
        ...
        private void DraftAndSendEmail(TSender sender, RecipientInfo recipient)
        {
