<%@ Page Language="C#" CodeBehind="Add.aspx.cs" Inherits="InSite.Admin.Events.Candidates.Forms.Add" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
                    ...
                    <div class="card border-0 shadow-lg mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <insite:FindGroup runat="server" ID="CriteriaEmployer" CurrentOrganizationOnly="true" />
                            </div>

                            <div runat="server" id="CriteriaContactCodeField" class="form-group mb-3">
                                <label class="form-label">
                                    <insite:ContentTextLiteral runat="server" ContentLabel="Person Code"/>
                                </label>
                                <insite:TextBox ID="CriteriaContactCode" runat="server" Width="100%" TextMode="MultiLine" Rows="2" />
                            </div>

                            <div class="form-group mb-3">
                                <asp:CheckBox runat="server" ID="CriteriaForceRegistration" Text="Force Registration" />
                            </div>
                                                ...
                                                <asp:Repeater runat="server" ID="SearchResultRepeater">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <%# (string)Eval("FullName")=="Not Found" ? "<i class='fas fa-exclamation-circle text-danger'></i>" : "" %>
