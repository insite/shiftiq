<%@ Page Language="C#" CodeBehind="Add.aspx.cs" Inherits="InSite.Admin.Events.Registrations.Forms.Add" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <div class="card border-0 shadow-lg mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <insite:FindGroup runat="server" ID="CriteriaEmployer" />
                            </div>
                    ...
                    <div class="card border-0 shadow-lg mb-3">
                        <div class="card-body">
                            ...
                            <insite:UpdateProgress runat="server" AssociatedUpdatePanelID="PaymentUpdatePanel" />

                            <insite:UpdatePanel runat="server" ID="PaymentUpdatePanel">
                                <ContentTemplate>

                                    <div runat="server" id="AssessmentPanel" class="form-group mb-3">
                                        <label class="form-label">
                                            Assessment
                                        </label>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <insite:ItemNameComboBox runat="server" ID="ApprovalStatus" Value="Registered">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <insite:ComboBox runat="server" ID="PaymentSeat" />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <insite:NumericBox runat="server" ID="PaymentRegistrationFee" DecimalPlaces="2" CssClass="w-50" MinValue="0" MaxValue="1000000" />
                                        <div class="mt-2">
                                            <asp:CheckBox runat="server" ID="IncludeInT2202" Text="Include in T2202 tax form" Checked="true" />
                                        </div>
                                        <div class="form-text">
                                    ...
                                    <div runat="server" id="BillingToCustomerField" class="form-group mb-3">
                                        <label class="form-label">
                                            Billing To
                                        </label>
                                        <insite:ComboBox runat="server" ID="BillingToCustomer" />
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <insite:FindGroup runat="server" ID="PaymentEmployer" />
                                    </div>
                    ...
                    <div class="card border-0 shadow-lg">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <insite:CloseButton runat="server" ID="SearchResultCloseButton" ConfirmText="Are you sure to cancel?" />
                            </div>
