...
<div class="row settings">
    ...
    <div class="col-md-4">
        ...
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportRegistrationReport" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Registration Report (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportAverageAgeByAchievement" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Average Age by Achievements (*.pdf)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportApprenticeScores" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-excel" Text="Apprentice Scores(*.xlsx)" />
        </div>
        <div class="mb-2">
            <insite:Button runat="server" ID="ExportApprenticeCompletionRate" ButtonStyle="Default" style="width:100%; text-align:left;" Icon="far fa-fw fa-file-pdf" Text="Apprentice Completion Rate (*.pdf)" />
        </div>
