...
namespace InSite.Admin.Events.Registrations.Reports
{
    public static class ApprenticeScoresReport
    {
        ...
        {
            var achievements = ServiceLocator.AchievementSearch.GetAchievements(new QAchievementFilter { OrganizationIdentifier = CurrentSessionState.Identity.Organization.OrganizationIdentifier, AchievementLabel = "Level" });
