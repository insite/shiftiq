    ...
    <section class="pb-5 mb-md-2">
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">               
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a class="me-3" href="/ui/cmds/admin/messages/assign-subscribers"><i class="fas fa-fw fa-envelope-open-text me-1"></i>Notification Subscribers</a>
                        <a class="me-3" href="/ui/cmds/admin/messages/assign-followers"><i class="fas fa-fw fa-user-headset me-1"></i>Notification Followers</a>
                        <a runat="server" id="OverrideCompetenciesLink" class="me-3" href="/ui/cmds/admin/validations/competencies/search"><i class="fas fa-fw fa-ruler-triangle me-1"></i>Override Competencies</a>
                    </div>
                </div>
            ...
            <div class="card-body">               
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        ...
                        <a runat="server" id="SearchCategoriesLink" class="me-3" href="/ui/admin/learning/categories/search"><i class="fas fa-fw fa-tags me-1"></i>Achievement Categories</a>
                        
                        <a runat="server" id="CompareProfilesLink" class="me-3" href="/ui/cmds/admin/standards/profiles/compare"><i class="fas fa-fw fa-id-badge me-1"></i>Compare Profiles</a>
