<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaskGrid.ascx.cs" Inherits="InSite.Cmds.Admin.Records.Programs.TaskGrid" %>
...
<asp:Repeater ID="AchievementTypes" runat="server">
    <ItemTemplate>
        <div class="mb-3">
            ...
            <asp:Repeater ID="AchievementSettings" runat="server">
                <HeaderTemplate>
