    ...
    public partial class Duplicate : AdminBasePage, ICmdsUserControl, IHasParentLinkParameters
    {
        ...
        private void CategoryRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            itemRepeater.DataSource = dataItem.Select((x, i) => new
            {
                x.Title,
                IconHtml = x.IsValid
                    ? "<i class='far fa-fw fa-check-square text-success' title='The achievement is assigned to the selected department'></i>"
                    : "<i class='far fa-fw fa-exclamation-square text-danger' title='The achievement is NOT assigned to the selected department'></i>",
