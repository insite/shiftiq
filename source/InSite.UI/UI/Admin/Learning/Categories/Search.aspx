<%@ Page Language="C#" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Learning.Categories.Search" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/Admin/Learning/Categories/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Learning/Categories/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
