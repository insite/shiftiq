<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportCorrelationSearchResults.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportCorrelationSearchResults" %>

<%@ Register TagPrefix="uc" Assembly="InSite.UI" Namespace="InSite.Admin.Surveys.Forms.Controls" %>
