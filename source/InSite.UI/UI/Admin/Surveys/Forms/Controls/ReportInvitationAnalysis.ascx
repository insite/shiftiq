<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportInvitationAnalysis.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportInvitationAnalysis" %>
