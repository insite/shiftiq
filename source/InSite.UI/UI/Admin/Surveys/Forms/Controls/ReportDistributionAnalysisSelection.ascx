<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDistributionAnalysisSelection.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDistributionAnalysisSelection" %>
...
<div class="text-end cmd-selection-analysis" style="margin-bottom:5px;">
    <insite:Button runat="server" ID="DownloadCsv" ButtonStyle="Primary" Size="ExtraSmall" ToolTip="Download CSV" Text="CSV" Icon="fa fa-download fa-fw" />
    <insite:Button runat="server" ID="DownloadPng" ButtonStyle="Primary" Size="ExtraSmall" ToolTip="Download PNG" Text="PNG" Icon="fa fa-download fa-fw" />
</div>
...
<table class="table table-condensed table-selection-analysis">
    ...
    <tbody>
        ...
        <asp:PlaceHolder runat="server" ID="RowNoResponse" Visible="false">
            <tr>
		        <td class="option-text">No Response</td>
