<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportCorrelationSearchCriteria.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportCorrelationSearchCriteria" %>
        ...
        <div class="settings">
            ...
            <insite:UpdatePanel runat="server" ID="XAxisUpdatePanel">
                <ContentTemplate>
                    ...
                    <div class="form-group mb-3">
                        <div>
                            <insite:Survey2QuestionComboBox runat="server" ID="XAxisQuestionID"
        ...
        <div class="settings">
            ...
            <insite:UpdatePanel runat="server" ID="YAxisUpdatePanel">
                <ContentTemplate>
                    ...
                    <div class="form-group mb-3">
                        <div>
                            <insite:Survey2QuestionComboBox runat="server" ID="YAxisQuestionID"
                                EmptyMessage="Question"
                                QuestionType="CheckList,RadioList,Selection,Likert"
                                HasResponseAnswer="true"
                                CausesValidation="false"
