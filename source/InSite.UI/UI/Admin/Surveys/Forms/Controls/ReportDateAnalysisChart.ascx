<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDateAnalysisChart.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDateAnalysisChart" %>
...
<asp:PlaceHolder runat="server" ID="StatisticInfo" Visible="false">
    ...
    <div class="row chart-row">
        ...
        <div class="zoom-panel">
            <button type="button" title="Zoom In" data-action="zoom-in"><i class="fa fa-fw fa-search-plus"></i></button>
            <button type="button" title="Zoom Out" data-action="zoom-out"><i class="fa fa-fw fa-search-minus"></i></button>
            <button type="button" title="Actual Size" data-action="zoom-actual"><i class="fa fa-fw fa-search"></i></button>
        </div>
    </div>
