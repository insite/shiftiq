<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDistributionSearchResults.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDistributionSearchResults" %>
