<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDistributionAnalysisNumber.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDistributionAnalysisNumber" %>
