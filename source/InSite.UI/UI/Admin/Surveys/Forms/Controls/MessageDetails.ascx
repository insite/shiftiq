<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MessageDetails.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.MessageDetails" %>

<insite:Alert runat="server" ID="NoInvitationMessage" Indicator="Warning" Visible="false">
    There is no invitation for this survey.
</insite:Alert>
