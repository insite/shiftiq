<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDownloadSection.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDownloadSection" %>
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group mb-3">
            ...
            <div>
                ...
                <div class="form-text">Check this box to include additional files that describe each question, field, and option in the survey.</div>
            </div>
