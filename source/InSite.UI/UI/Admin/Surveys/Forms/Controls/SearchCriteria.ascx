<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchCriteria.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.SearchCriteria" %>
    ...
    <div class="col-4">  
        ...
        <div class="mb-2">
            <insite:ComboBox ID="SortColumns" runat="server">
                <Items>
                    <insite:ComboBoxOption Text="Sort by Name" Value="SurveyFormName" />
