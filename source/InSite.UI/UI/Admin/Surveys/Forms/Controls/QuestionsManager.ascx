<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuestionsManager.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.QuestionsManager" %>
                    ...
                    <td style="width:40px; vertical-align:top;">
                        ...
                        <div style="margin-bottom:5px;">
                            <insite:IconLink runat="server"
                                ...
                                NavigateUrl='<%# string.Format("/ui/admin/surveys/questions/change?survey={0}&question={1}", SurveyID, Eval("Identifier")) %>'
                        ...
                        <div style="margin-bottom:5px;">
                            <insite:IconLink runat="server"
                                ...
                                NavigateUrl='<%# string.Format("/ui/admin/surveys/questions/define-likert-scales?survey={0}&question={1}", SurveyID, Eval("Identifier")) %>'
                                CssClass="reorder-trigger reorder-hide"
                                Name="weight" />
                        </div>
                        <div style="margin-bottom:5px;">
                        ...
                        <div style="margin-bottom:5px;">
                            <insite:IconLink runat="server" ID="DeleteQuestion"
                                ...
                                NavigateUrl='<%# string.Format("/admin/surveys/questions/delete-survey-question?survey={0}&question={1}", SurveyID, Eval("Identifier")) %>'
                                CssClass="reorder-trigger reorder-hide"
                                Name="trash-alt"
                                />
                        </div>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <asp:HyperLink runat="server"
                                            ...
                                            NavigateUrl='<%# string.Format("/ui/admin/surveys/forms/add-survey-condition?survey={0}&question={1}&returnpanel=questions", Eval("Form.Identifier"), Eval("Identifier")) %>'
                                            Text="Condition"
                                        >
                                    ...
                                    <tr>
                                        <td style="width:40px; vertical-align:top;">
                                            ...
                                            <insite:IconLink runat="server" ID="AddNewBranch"
                                                ...
                                                NavigateUrl='<%# Eval("Identifier", "/ui/admin/surveys/forms/change-survey-branch?list={0}&returnpanel=questions") %>'
                                                Name="forward" />
                                        </td>
                                        <td>
