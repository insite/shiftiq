<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportDistributionSearchCriteria.ascx.cs" Inherits="InSite.Admin.Surveys.Forms.Controls.ReportDistributionSearchCriteria" %>
                    ...
                    <ContentTemplate>
                        <div class="form-horizontal">
                            <div class="form-group mb3">
                                ...
                                <div class="col-sm-8">
                                    <insite:Survey2QuestionComboBox runat="server" ID="AnswerFilterQuestionID" Width="100%" MaxTextLength="40" ZIndex="8501" MaxHeight="500px" HasResponseAnswer="true" ExcludeSpecialQuestions="true" />
                                    <div>
                            ...
                            <div class="form-group mb3">
                                ...
                                <div class="col-sm-8">
                                    <insite:Survey2ResponseAnswerComboBox runat="server" ID="AnswerFilterAnswerText" AllowBlank="true" Width="100%" ZIndex="8501" MaxTextLength="100" MaxHeight="500px" />
                                </div>
                                <div class="col-sm-1">
