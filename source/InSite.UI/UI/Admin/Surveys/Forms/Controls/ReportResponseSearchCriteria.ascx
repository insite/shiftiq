<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportResponseSearchCriteria.ascx.cs" Inherits="InSite.UI.Admin.Surveys.Forms.Controls.ReportResponseSearchCriteria" %>
                ...
                <div class="col-6">
                    <insite:UpdatePanel runat="server" ID="UpdatePanel">
                        <ContentTemplate>
                            ...
                            <div class="mb-2">
                                <insite:FindSurveyForm runat="server" ID="SurveyID" EmptyMessage="Survey Form" Enabled="false" />
                            </div>  
                            ...
                            <div class="mb-2">
                                <insite:Survey2ResponseAnswerComboBox runat="server" ID="AnswerText" EmptyMessage="Answer" AllowBlank="true" />
                            </div>
