...
namespace InSite.Admin.Surveys.Forms.Reports
{
    public partial class SurveyQuestionsReport : UserControl
    {
        ...
        public void LoadReport(SurveyState survey)
        {
            ...
            Title.InnerText = survey != null ? survey.Form.Name : "Invalid Survey Key";

            if (survey == null)
            {
                ErrorMessage.InnerText = "Invalid Survey Key.";
            ...
            {
                ErrorMessage.InnerText = "The survey has no questions.";
                ErrorMessage.Visible = true;
                return;
            }
        ...
        private List<PageItem> GetPages(SurveyForm form)
        {
            ...
            foreach (var question in form.Questions)
            {
                ...
                // Question breaks contain content that is needed in a PDF export of survey questions.
