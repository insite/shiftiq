    ...
    public class SurveyDeserializer
    {
        ...
        private void CreateSurvey()
        {
            _result.Survey = new SurveyForm
            {
                ...
                Content = AddContentContainer("Survey Form", _sourceSurvey.Content)
            };

            AddContent(_result.Survey.Identifier, "Survey Form", _sourceSurvey.Content);
        }
        ...
        private void CreateQuestions()
        {
            ...
            foreach (var question in _sourceSurvey.Questions)
            {
                ...
                _result.Questions.Add(new SurveyQuestion
                {
                    ...
                    Content = AddContentContainer("Survey Question", question.Content)
                });

                AddContent(questionId, "Survey Question", question.Content);
            }
        }
        ...
        private SurveyOptionList AddSurveyOptionList(OptionSerialized option)
        {
            ...
            return new SurveyOptionList
            {
                ...
                Content = AddContentContainer("Survey Option List", option.Content)
            };
        }
        ...
        private List<SurveyOptionItem> AddOptionItems(List<OptionItemSerialized> items)
        {
            ...
            foreach (var item in items)
            {
                results.Add(new SurveyOptionItem
                {
                    ...
                    Points = item.Points,
                    Content = AddContentContainer("Survey Option Item", item.Content),
