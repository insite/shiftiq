...
{
    public partial class ChangeSurveyFormSettings : AdminBasePage, IHasParentLinkParameters
    {
        private Guid SurveyIdentifier => Guid.TryParse(Request["survey"], out var result) ? result : Guid.Empty;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            PageHelper.AutoBindHeader(
                this,
                qualifier: $"{surveyForm.Name} <span class='form-text'>Survey Form #{surveyForm.Asset}</span>");
        ...
        private bool ValidateIsSubmissionsLimited()
        {
            ...
            errorMessage.Append("This survey form cannot be limited to one submission per respondent because the following users have already submitted the survey more than once: ");
