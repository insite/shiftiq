...
{
    public partial class ChangeSurveyBranch : AdminBasePage, IHasParentLinkParameters
    {
        ...
        private void Open()
        {
            ...
            PageHelper.AutoBindHeader(
                this,
                qualifier: $"{optionList.SurveyQuestion.SurveyForm.SurveyFormName} <span class='form-text'>Survey Form #{optionList.SurveyQuestion.SurveyForm.AssetNumber}</span>");
        ...
        private void SkipPatternsRepeater_ItemDataBound(Object sender, RepeaterItemEventArgs e)
        {
            ...
            var questionID = (Survey2QuestionComboBox)e.Item.FindControl("QuestionID");
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 0; i < SkipPatternsRepeater.Items.Count; i++)
            {
                ...
                var questionID = (Survey2QuestionComboBox)item.FindControl("QuestionID");
            ...
            HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}&panel={ReturnPanel}&tab={ReturnTab}", true);
        }
        ...
        {
            HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}", true);
        }
