...
{
    public partial class RenameSurveyForm : AdminBasePage, IHasParentLinkParameters
    {
        private Guid? SurveyIdentifier => Guid.TryParse(Request["survey"], out var result) ? result : (Guid?)null;
