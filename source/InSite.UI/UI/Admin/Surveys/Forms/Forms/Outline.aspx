<%@ Page Language="C#" CodeBehind="Outline.aspx.cs" Inherits="InSite.Admin.Surveys.Forms.Forms.Outline" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/Portal/Surveys/Controls/RespondHeadContent.ascx" TagName="HeadContent" TagPrefix="uc" %>
<%@ Register Src="../Controls/QuestionsManager.ascx" TagName="QuestionsManager" TagPrefix="uc" %>
<%@ Register Src="../Controls/MessageDetails.ascx" TagName="MessageDetails" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Surveys/Comments/Controls/CommentRepeater.ascx" TagName="CommentRepeater" TagPrefix="uc" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Nav runat="server" ID="NavPanel">               
        <insite:NavItem runat="server" ID="SurveyButton" Title="Survey" Icon="far fa-check-square" IconPosition="BeforeText">
            <section class="pb-5 mb-md-2">        
                <h2 class="h4 mt-4 mb-3">Survey</h2>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="row button-group mb-4">
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        ...
                                        <insite:Button runat="server" ID="ResponseSearchLink" Text="Responses" Icon="fas fa-search" CssClass="btn" ButtonStyle="Default" />
                                        ...
                                        <div class="row settings">
                                            <div class="col-lg-6">                            
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="float-end">
                                                        <insite:IconLink runat="server" id="ChangeInternalName" style="padding:8px" ToolTip="Change Survey Name" Name="pencil" />
                                                    </div>
                                                    ...
                                                    <div class="form-text">
                                                        ...
                                                        It is required, but it is not visible to the survey respondent.
                                                    </div>
                                                </div>

				                                <div class="form-group mb-3">
                                                    <div class="float-end">
                                                        <insite:IconLink Name="pencil" runat="server" id="ChangeSurveyTitle" style="padding:8px" ToolTip="Change Survey Title" />
                                                    </div>
                                                    ...
                                                    <div class="form-text">
                                                        This is the survey title displayed to the survey respondent.
                                                    </div>
				                                </div>
				                                ...
				                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text text-danger" runat="server" id="WarningText">
                                                        ...
                                                        to review and test the survey. 
                                                        It should <strong>NOT</strong> be shared with actual survey respondents.
                                                    </div>
				                                </div>

                                                <div class="form-group mb-3">
                                                    <div class="float-end">
                                                        <insite:IconLink runat="server" ID="LockLink" ToolTip="Lock this survey" Name="lock" />
                                                        <insite:IconLink runat="server" ID="UnlockLink" ToolTip="Unlock this survey" Name="lock-open" />
                                                    </div>
                                                    ...
                                                    <div class="form-text">Changes to locked survey are not permitted.</div>
                                                </div>

                                                <div class="form-group mb-3">
                                                    <div class="float-end">
                                                        <insite:IconLink Name="pencil" runat="server" id="ChangeHook" style="padding:8px" ToolTip="Change Survey Hook" />
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        A Drafted survey is open to responses from administrators only. An Opened survey is open to all respondents.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        The number of minutes that a user is expected to need in order to complete this survey.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        Allow respondents to review feedback from the survey administrator about answers they submitted to questions on the form.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:label runat="server" ID="IsLimitResponsesLabel" AssociatedControlID="IsLimitResponses" Text="Limit Responses per Respondent" CssClass="form-label" />
				                                    <div>
                                                        <asp:Literal runat="server" ID="IsLimitResponses" />
                                                    </div>
                                                    <div class="form-text">
                                                        If you want to ensure each respondent answers the survey no more than once then select Limited.
                                                    </div>
				                                </div>
                                                ...
                                                <div runat="server" id="AllowAnonymousResponsesField" class="form-group mb-3">
                                                    ...
                                                    <asp:label runat="server" ID="AllowAnonymousResponsesLabel" AssociatedControlID="AllowAnonymousResponses" Text="Allow Anonymous Responses" CssClass="form-label" />
				                                    <div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        ...
                                                        about survey respondents to survey administrators.
                                                    </div>
				                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-text">
                                                        Open a new case when a response to this survey is completed.
                                                    </div>
                                                </div>
                                                            ...
                                                            <dd>
                                                                ...
                                                                <div class="float-end">
                                                                    <insite:Button runat="server" visible='<%# CanEdit %>'
                                                                        NavigateUrl ='<%# string.Format("/ui/admin/surveys/forms/change-survey-condition?survey={0}&option={1}&returnpanel=survey&returntab=Conditions", SurveyID, Eval("MaskingOptionIdentifier")) %>'
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <li style="margin-bottom:8px;padding-bottom:8px;">
                                                                                ...
                                                                                <insite:IconLink runat="server" visible='<%# CanEdit %>'
                                                                                    NavigateUrl='<%# string.Format("/admin/surveys/forms/delete-survey-condition?option={0}&question={1}&returnpanel=survey&returntab=Conditions", Eval("MaskingOptionIdentifier"), Eval("MaskedQuestionIdentifier")) %>'
                                                            ...
                                                            <h4>
                                                                ...
                                                                <div class="float-end">
                                                                    <insite:Button runat="server"
                                                                        ...
                                                                        NavigateUrl='<%# string.Format("/ui/admin/surveys/forms/change-survey-branch?list={0}&returnpanel=survey&returntab=Branches", Eval("OptionListIdentifier")) %>'
                                                                        ToolTip="Edit branch"
                        ...
                        <div class="card border-0 shadow-lg">
                            <div class="card-body">
                                <insite:Nav runat="server">
                                    ...
                                    <insite:NavItem runat="server" ID="ResponseStartedAdministratorTab" Title="Response Started (Administrator)">
                                        <uc:MessageDetails runat="server" ID="ResponseStartedMessageDetails" />
                                    </insite:NavItem>
                                    <insite:NavItem runat="server" ID="ResponseCompletedAdministratorTab" Title="Response Completed (Administrator)">
                                        <uc:MessageDetails runat="server" ID="ResponseCompletedMessageDetails" />
                                    </insite:NavItem>
                                    <insite:NavItem runat="server" ID="ResponseCompletedRespondentTab" Title="Response Completed (Respondent)">
