<%@ Page Language="C#" CodeBehind="Report.aspx.cs" Inherits="InSite.Admin.Surveys.Forms.Forms.Report" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="../Controls/ReportDistributionSearchCriteria.ascx" TagName="DistributionSearchCriteria" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportDistributionSearchResults.ascx" TagName="DistributionSearchResults" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportCorrelationSearchCriteria.ascx" TagName="CorrelationSearchCriteria" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportCorrelationSearchResults.ascx" TagName="CorrelationSearchResults" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportDownloadSection.ascx" TagName="ReportDownloadSection" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportDateAnalysisChart.ascx" TagName="ReportDateAnalysisChart" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportInvitationAnalysis.ascx" TagName="ReportInvitationAnalysis" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportDuplicateGrid.ascx" TagName="ReportDuplicateGrid" TagPrefix="uc" %>


<%@ Register Src="../Controls/ReportResponseSearchResults.ascx" TagName="ResponseSearchResults" TagPrefix="uc" %>
<%@ Register Src="../Controls/ReportResponseSearchCriteria.ascx" TagName="ResponseSearchCriteria" TagPrefix="uc" %>
...
<insite:PageHeadContent runat="server">
    ...
    <insite:Nav runat="server" ID="NavPanel">
        ...
        <insite:NavItem runat="server" ID="SearchResultsTab" Icon="fas fa-database" Title="Responses">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-end">
                                        <div class="row" style="padding-bottom: 18px;">
                                            <div class="col-md-12">
                                                <insite:Button runat="server" ID="PrintDistributionReport" ButtonStyle="Default" Text="Print" Icon="far fa-fw fa-print" />
