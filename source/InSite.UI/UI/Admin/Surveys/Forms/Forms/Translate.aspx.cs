    ...
    public partial class Translate : AdminBasePage, IHasParentLinkParameters
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            PageHelper.AutoBindHeader(
                this,
                qualifier: $"{Survey.Name} <span class='form-text'>Survey Form #{Survey.Asset}</span>");
        ...
        {
            return parent.Name.EndsWith("/outline") ? $"survey={SurveyID}" : null;
        }
        #endregion
        ...
        private void ToLanguage_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(toLang) && SurveyID.HasValue)
            {
                ...
                if (commands.Count > 0)
                {
                    ...
                    ComparisonStatus.AddMessage(AlertType.Success, $"Google Translate has been used to translate your survey from {fromName} to {toName}. Please review and revise the translation as needed.");
