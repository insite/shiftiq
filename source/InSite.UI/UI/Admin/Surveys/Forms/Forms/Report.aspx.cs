...
namespace InSite.Admin.Surveys.Forms.Forms
{
    public partial class Report : SearchPage<QResponseSessionFilter>, IHasParentLinkParameters
    {
        ...
        private bool LoadSurvey(SurveyForm survey, QResponseSessionFilter responseFilter = null)
        {
            ...
            {
                ScreenStatus.AddMessage(AlertType.Error, "Survey not found.");
                return false;
            }
            ...
            var subtitle = "response".ToQuantity(responseCount, "N0");
            ...
            {
                ScreenStatus.AddMessage(AlertType.Information, "There are no completed submissions for this survey.");
        ...
        protected string GetReportPrintUrl()
        {
            ...
            return $"/ui/admin/surveys/forms/report-print?survey={SurveyID}&filter={filterBase64}";
        }
        ...
        private void DeleteResultsButton_Click(object sender, EventArgs e)
        {
            if (DistributionCriteria.SurveyID.HasValue)
            {
                ...
                ScreenStatus.AddMessage(
                    AlertType.Success,
                    $"All of the results for this survey have been deleted: {"record".ToQuantity(sessions.Count)}");
            }
