<%@ Page Language="C#" CodeBehind="CreateSurveyForm.aspx.cs" Inherits="InSite.Admin.Surveys.Forms.Forms.CreateSurveyForm" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
    ...
    <section runat="server" id="SurveySection" class="mb-3">
        ...
        <div class="card border-0 shadow-lg h-100">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <insite:CreationTypeComboBox runat="server" ID="CreationType" TypeName="Survey" />
                    </div>
                </div>
                ...
                <asp:Panel runat="server" ID="NewSection">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div>
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-text">
                                        The internal name is used as an internal reference for filing the survey. It is required field, and it is not visible to the survey respondent.
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Limit Responses per Respondent</label>
                                    <div>
                                ...
                                <div runat="server" id="EnableAnonymousSaveGroup" class="form-group mb-3" style="display: none;">
                                    <label class="form-label">Allow Anonymous Responses</label>
                                    <div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        Survey Form
                                        <insite:RequiredValidator runat="server" ID="CopySurveyFormValidator" ControlToValidate="CopySurveyFormSelector" FieldName="Survey Form" ValidationGroup="Copy" />
                                    </label>
                                    <div>
                                        <insite:FindSurveyForm runat="server" ID="CopySurveyFormSelector" />
                                    </div>
                                    <div class="form-text">This survey is use for copy.</div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-icon btn-outline-secondary" data-upload="#<%= JsonFileUpload.ClientID %>" title="Browse" type="button"><i class="far fa-fw fa-folder-open"></i></button>
                                        <insite:Button runat="server" ID="JsonFileUploadButton" Size="Default"
                                            ToolTip="Upload" ButtonStyle="OutlineSecondary" Icon="far fa-fw fa-upload"
