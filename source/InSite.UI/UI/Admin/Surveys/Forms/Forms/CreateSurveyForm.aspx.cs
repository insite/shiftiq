...
namespace InSite.Admin.Surveys.Forms.Forms
{
    public partial class CreateSurveyForm : AdminBasePage
    {
        ...
        protected Guid? SurveyFormIdentifier => Guid.TryParse(Request.QueryString["survey"], out var result) ? result : (Guid?)null;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            CancelButton.NavigateUrl = "/ui/admin/surveys/search";
        ...
        private void UploadSaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={id}");
            }
        ...
        {
            var result = new SurveyDeserializer().Deserialize(JsonInput.Text);
            ...
            return (id, new SurveyCommandGenerator().GetCommands(null, result.Survey, null, true));
        }
        ...
        private void CopyButton_Click(object sender, EventArgs e)
        {
            ...
            if (!CopySurveyFormSelector.HasValue)
            {
                CreatorStatus.AddMessage(AlertType.Error, "Please select an existing Survey Form from the drop-down list.");
                return;
            }
            ...
            HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={newSurveyID}");
        }
        ...
        private ICommand[] CreateCopyCommands(Guid surveyID, Guid newSurveyID)
        {
            ...
            return new SurveyCommandGenerator().GetCommands(null, form, null);
        }
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            // Apply default survey settings for this organization.
            ...
            HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={survey}");
        }
    }
}
