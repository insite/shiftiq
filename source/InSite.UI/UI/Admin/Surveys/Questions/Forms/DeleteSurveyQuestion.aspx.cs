...
{
    public partial class DeleteSurveyQuestion : AdminBasePage, IHasParentLinkParameters
    {
        ...
        private string GetOutlineUrl(Guid? questionId)
        {
            ...
            return $"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}&panel=questions" + query;
        }
