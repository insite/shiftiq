<%@ Page Language="C#" CodeBehind="DeleteSurveyQuestion.aspx.cs" Inherits="InSite.Admin.Surveys.Questions.Forms.DeleteSurveyQuestion" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="settings">
                ...
                The survey question will be deleted from all forms, queries, and reports.
