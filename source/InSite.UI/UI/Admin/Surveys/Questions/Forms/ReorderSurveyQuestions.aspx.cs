...
{
    public partial class ReorderSurveyQuestions : AdminBasePage, IHasParentLinkParameters
    {
        protected Guid SurveyIdentifier => Guid.TryParse(Page.Request.QueryString["survey"], out var id) ? id : Guid.Empty;
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            HttpResponseHelper.Redirect($"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}&panel=questions");
        }
        ...
        private void Open()
        {
            ...
            PageHelper.AutoBindHeader(this, null, "Reorder the questions in a survey");
            ...
            CancelButton.NavigateUrl = $"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}&panel=questions";
        }
        ...
        public string GetParentLinkParameters(IWebRoute parent)
        {
            return parent.Name.EndsWith("/outline")
                ? $"survey={SurveyIdentifier}&panel=questions"
                : null;
        }
    }
}
