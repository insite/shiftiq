...
namespace InSite.Admin.Surveys.Questions.Forms
{
    ...
    {
        private Guid SurveyIdentifier => Guid.TryParse(Request["survey"], out var survey) ? survey : Guid.Empty;
        ...
        private void Save()
        {
            ...
            {
                Response.Redirect("/ui/admin/surveys/search");
                return;
            }
        ...
        {
            return $"/ui/admin/surveys/forms/outline?survey={SurveyIdentifier}&question={QuestionIdentifier}&panel=questions";
        }

        public string GetParentLinkParameters(IWebRoute parent)
        {
            return parent.Name.EndsWith("/outline")
                ? $"survey={SurveyIdentifier}&question={QuestionIdentifier}&panel=questions"
                : null;
        }
    }
}
