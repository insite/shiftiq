<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailCommentBox.ascx.cs" Inherits="InSite.Admin.Surveys.Questions.Controls.DetailCommentBox" %>
...
<div class="card border-0 shadow-lg">
    <div class="card-body">
        ...
        <insite:Alert runat="server" ID="TextCharacterWarning" Indicator="Warning" CssClass="d-none">
            Allowing more than 4000 characters is permitted but not recommended for system and survey performance reasons.
            If you decide to allow a respondent to input more than 4000 characters in their answers to this question,
            then it is important to test your survey very carefully using all major web browsers.
        </insite:Alert>
