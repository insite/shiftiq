<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LikertTableColumnGrid.ascx.cs" Inherits="InSite.Admin.Surveys.Questions.Controls.LikertTableColumnGrid" %>
...
<div id="<%= ClientID %>">
    ...
    <asp:Panel runat="server" ID="ViewOnlyMessage" Width="780px" Visible="false">
        <div class="form-text">Columns cannot be added or removed because responses to this survey have been submitted.</div>
    </asp:Panel>
        ...
        (function () {
            ...
            function addItem(item) {
...

                {
                    ...
                    $('<th class="col-drag col-head"><span title="Drag &amp; Drop Column"><i title="Drag &amp; Drop Row" class="icon fas fa-fw fa-exchange-alt x20"></i></span></th>')
                    ...
                    $('<td class="col-foot">').append(
                        $('<a title="Delete Column" data-action="delete" href="javascript:void(0);"><i class="icon fas fa-fw fa-trash-alt x20"></i></a>').on('click', onRemoveItemClick)
