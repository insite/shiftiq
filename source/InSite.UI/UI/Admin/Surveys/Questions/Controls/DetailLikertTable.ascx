<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailLikertTable.ascx.cs" Inherits="InSite.Admin.Surveys.Questions.Controls.DetailLikertTable" %>
<%@ Register Src="LikertTableColumnGrid.ascx" TagName="LikertTableColumnGrid" TagPrefix="uc" %>
<%@ Register Src="LikertTableRowGrid.ascx" TagName="LikertTableRowGrid" TagPrefix="uc" %>
