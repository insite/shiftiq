<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailAnswerRepeater.ascx.cs" Inherits="InSite.UI.Admin.Surveys.Questions.Controls.DetailAnswerRepeater" %>
<section>
