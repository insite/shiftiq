<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Detail.ascx.cs" Inherits="InSite.Admin.Surveys.Questions.Controls.Detail" %>

<%@ Register Src="DetailAnswerRepeater.ascx" TagName="DetailAnswerRepeater" TagPrefix="uc" %>
<%@ Register Src="DetailCommentBox.ascx" TagName="DetailCommentBox" TagPrefix="uc" %>
<%@ Register Src="DetailList.ascx" TagName="DetailList" TagPrefix="uc" %>
<%@ Register Src="DetailLikertTable.ascx" TagName="DetailLikertTable" TagPrefix="uc" %>
                    ...
                    <div class="card border-0 shadow-lg h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <insite:SurveyQuestionTypeComboBox runat="server" ID="QuestionTypeSelector" />
