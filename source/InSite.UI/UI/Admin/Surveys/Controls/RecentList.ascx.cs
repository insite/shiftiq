...
namespace InSite.UI.Admin.Surveys.Controls
{
    public partial class RecentList : BaseUserControl
    {
        ...
        private void Repeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            link.Text = $"<a href='/ui/admin/surveys/responses/search?survey={survey.SurveyFormIdentifier}'><i class='far fa-fw fa-search me-1'></i>Response Search ({countResponses:n0})</a>";
