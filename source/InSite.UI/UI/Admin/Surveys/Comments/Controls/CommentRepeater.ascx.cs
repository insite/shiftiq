...
namespace InSite.UI.Admin.Surveys.Comments.Controls
{
    public partial class CommentRepeater : BaseUserControl
    {
        ...
        public bool LoadData(Guid surveyFormId)
        {
            ...
            AddCommentButton.NavigateUrl = Forms.Author.GetNavigateUrl(surveyFormId);
        ...
        private void Repeater_DataBinding(object sender, EventArgs e)
        {
            ...
            Repeater.DataSource = data.Select(x => new
            {
                ...
                ReviseUrl = Forms.Revise.GetNavigateUrl(x.CommentIdentifier),
                DeleteUrl = Forms.Delete.GetNavigateUrl(x.CommentIdentifier)
            });
        }
    }
}