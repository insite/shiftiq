<%@ Page Language="C#" CodeBehind="DeleteSession.aspx.cs" Inherits="InSite.Admin.Surveys.Responses.DeleteSession" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="settings">
                ...
                <dl class="row">
                    <dt class="col-sm-3">Survey Name</dt>
                    <dd class="col-sm-9">
                ...
                <div class="alert alert-danger">
                    ...
                    Are you sure you want to delete this response session?
                </div>
        ...
        <div class="col-md-6">
            <div class="settings">
                ...
                The this survey response session will be deleted from all forms, queries, and reports.
