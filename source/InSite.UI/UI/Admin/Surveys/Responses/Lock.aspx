<%@ Page Language="C#" CodeBehind="Lock.aspx.cs" Inherits="InSite.Admin.Surveys.Responses.Lock" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Alert runat="server" ID="ConfirmAlert" Indicator="Information">
        Are you sure you want to lock this survey response?
    </insite:Alert>
