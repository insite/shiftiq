...
namespace InSite.Admin.Surveys.Responses.Controls
{
    public partial class ResponseReport : UserControl
    {
        ...
        public void LoadReport(ResponseSessionState current, ResponseSessionNavigator navigator)
        {
            Current = current;
            Navigator = navigator;
        ...
        {
            FormTitle.InnerHtml = $"{Current.Survey.Name} <span class='form-text'>Survey Form #{Current.Survey.Asset}</span>";
