<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchCriteria.ascx.cs" Inherits="InSite.Admin.Surveys.Responses.SearchCriteria" %>
                ...
                <div class="col-4">
                    <insite:UpdatePanel runat="server" ID="UpdatePanel">
                        <ContentTemplate>
                            ...
                            <div class="mb-2">
                                <insite:FindSurveyForm runat="server" ID="SurveyID" EmptyMessage="Survey Form" />
                            </div>  
                    
                            <div class="mb-2">
                                <insite:Survey2QuestionComboBox runat="server" ID="QuestionID" EmptyMessage="Question" MaxTextLength="40" ExcludeSpecialQuestions="true" />
                            </div>

                            <div class="mb-2">
                                <insite:Survey2ResponseAnswerComboBox runat="server" ID="AnswerText"
                                    EmptyMessage="Answer"
                                    AllowBlank="true"
                                    MaxTextLength="50"
    ...
    <div class="col-3">
        ...
        <div class="mb-4">
            <insite:ComboBox ID="SortColumns" runat="server">
                <Items>
                    <insite:ComboBoxOption Text="Sort by Response Started" Value="ResponseSessionStarted desc" />
                    <insite:ComboBoxOption Text="Sort by Survey Name" Value="SurveyName,ResponseSessionStarted desc" />
