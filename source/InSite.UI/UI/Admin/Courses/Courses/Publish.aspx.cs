...
namespace InSite.Admin.Courses.Courses
{
    public partial class Publish : AdminBasePage, IHasParentLinkParameters
    {
        ...
        private void SetInputValues(TCourse course)
        {
        ...
        private void UpdateWebPage(Guid site, Guid pageId, TCourse course)
        {
        ...
        private void InsertWebPage(Guid site, Guid folder, TCourse course)
        {
            var page = new QPage
            {
