...
namespace InSite.Admin.Courses.Courses
{
    ...
    {
        private TCourse _course;
        private List<TUnit> _units;
        private List<TModule> _modules;
        private List<TActivity> _activities;
        ...
        private CourseSerialized GetCourseSerialized()
        {
            var courseSerialized = new CourseSerialized
            {
                ...
                Framework = GetStandardName(_course.FrameworkIdentifier),
        ...
        private UnitSerialized GetUnitSerialized(TUnit unit)
        {
        ...
        private ModuleSerialized GetModuleSerialized(TModule module)
        {
        ...
        private ActivitySerialized GetActivitySerialized(TActivity activity)
        {
