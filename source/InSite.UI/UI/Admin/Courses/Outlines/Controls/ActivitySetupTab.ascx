    ...
    <ContentTemplate>
        <div class="form-group mb-3">
            ...
            <div>
                ...
                <div><asp:RadioButton runat="server" ID="RequirementConditionCompleteSurvey" GroupName="RequirementCondition" Text="Learners must complete a response to the survey" /></div>
