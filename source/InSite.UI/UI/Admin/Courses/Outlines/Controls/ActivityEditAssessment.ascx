...
<insite:Nav runat="server">
    ...
    <insite:NavItem runat="server" ID="QuestionTab" Title="Questions">
        ...
        <div runat="server" id="QuestionCommandsTop" class="mb-3 hstack">
            ...
            <insite:Button runat="server" ID="CollapseTopButton" ButtonStyle="Default" Width="95px" Text="Collapse" Icon="fas fa-fw fa-chevron-up" />
        </div>
                ...
                <div>
                    <div class="question-commands">
                        ...
                        <div>
                            ...
                            <span runat="server" class="start-reorder" visible='<%# AllowReorder %>'><i class="fas fa-sort fa-fw"></i></span>
                            <a href='/ui/admin/assessments/banks/outline?bank=<%# Eval("Set.Bank.Identifier") %>&question=<%# Eval("Identifier") %>' target="_blank" title="Assessment Question Bank"><i class="fas fa-fw fa-external-link-square"></i></a>
                        </div>
                    </div>
        ...
        <div runat="server" id="QuestionCommandsBottom" style="margin-bottom:15px; margin-top:15px;">
            ...
            <insite:Button runat="server" ID="CollapseBottomButton" ButtonStyle="Default" Width="95px" Text="Collapse" Icon="fas fa-fw fa-chevron-up" />
        </div>
        ...
        (function () {
            ...
            function renderCorrectOption($question) {
                ...
                $question.find('> .question-content > .option-list > div').each(function () {
                    ...
                    if (id.item.correct === $option.data('id'))
                        $number.html('<i style="color:#5cb85c" class="far fa-fw fa-check-circle"></i>');
                    else
                        $number.html('<i style="color:#f74f78" class="far fa-fw fa-times-circle"></i>');
                });
            }
            ...
            function onViewToggle(e) {
                ...
                $('#<%= CollapseTopButton.ClientID %>,#<%= CollapseBottomButton.ClientID %>').each(function () {
                    ...
                    if (isCollapsed)
                        $this.html('<i class="fas fa-fw fa-chevron-up"></i> Collapse');
                    else
                        $this.html('<i class="fas fa-fw fa-chevron-down"></i> Expand');
                });
