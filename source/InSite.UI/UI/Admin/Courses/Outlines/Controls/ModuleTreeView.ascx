...
<insite:Container runat="server" ID="TreeWrapper">
    ...
    <div class="d-flex justify-content-between mb-2">
        <div>
            <insite:Button runat="server" ID="PreviewLink" ButtonStyle="Default" Text="Preview" Icon="far fa-external-link" NavigateTarget="_blank" />
            <insite:Button ID="ReorderStartButton" runat="server" Icon="fas fa-sort" Text="Reorder" ButtonStyle="Default" />       
            <insite:DownloadButton runat="server" ID="DownloadLink" />
                    ...
                    <div>
                        <div>
                            ...
                            <div runat="server" id="CommandsContainer" class="node-inputs">
                                <div class="btn-group">
                                    <a runat="server" ID="ModuleEditLink" title="Edit Activity" class="p-1 dropdown-toggle" data-bs-toggle="dropdown" data-popper-strategy="fixed" aria-haspopup="true" aria-expanded="false"><i class="far fa-fw fa-plus-circle"></i></a>
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><asp:HyperLink runat="server" ID="LessonCreateLink" ToolTip="New Lesson" Text="<i class='far fa-fw fa-chalkboard-teacher me-1'></i> New Lesson" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="AssessmentCreateLink" ToolTip="New Assessment" Text="<i class='far fa-fw fa-balance-scale me-1'></i> New Assessment" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="SurveyCreateLink" ToolTip="New Survey" Text="<i class='far fa-fw fa-check-square me-1'></i> New Survey" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="DocumentCreateLink" ToolTip="New Document" Text="<i class='far fa-fw fa-file-pdf me-1'></i> New Document" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="LinkCreateLink" ToolTip="New Link" Text="<i class='far fa-fw fa-link me-1'></i> New Link" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="VideoCreateLink" ToolTip="New Video" Text="<i class='far fa-fw fa-video me-1'></i> New Video" CssClass="dropdown-item" /></li>
                                        <li><asp:HyperLink runat="server" ID="QuizCreateLink" ToolTip="New Single-Question Quiz" Text="<i class='far fa-fw fa-square-question me-1'></i> New Single-Question Quiz" CssClass="dropdown-item" /></li>
                                    </ul>
                                </div>
                                <a runat="server" ID="ModuleDeleteLink" title="Delete Module" class="p-1 align-middle"><i class="far fa-fw fa-trash-alt"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <ItemTemplate>
                            ...
                            <li class='item-activity <%# (Guid)Eval("Identifier") == ActivityIdentifier ? "selected" : "" %>' data-key="<%# Eval("Identifier") %>">
                                <div>
                                    <div>
                                        <div class="node-title">
                                            <i class='<%# "me-1 far fa-fw fa-" + GetTypeIconName((string)Eval("Type")) %>'></i>
                                            <span runat="server" visible='<%# ShowMetadataChecked && Eval("Code") != null %>' class="badge bg-info">
                                                <%# Eval("Code") %>
                                            </span>
                                        ...
                                        <div class="node-inputs">
                                            <a runat="server" ID="ActivityEditLink" title="Edit Activity" class="p-1"><i class="far fa-fw fa-pencil-alt"></i></a>
                                            <a runat="server" ID="ActivityDeleteLink" title="Delete Activity" class="p-1"><i class="far fa-fw fa-trash-alt"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div>
                    ...
                    <div runat="server" id="ModuleCommandsContainer" class="node-inputs">
                        <div class="btn-group" style="margin-right:32px;">
                            <a runat="server" ID="ModuleEditLink" title="New Module and Activity" class="dropdown-toggle p-1" data-bs-toggle="dropdown" data-popper-strategy="fixed" aria-haspopup="true" aria-expanded="false"><i class="far fa-fw fa-plus-circle"></i></a>
                            <ul class="dropdown-menu dropdown-menu-right">

                                <li><asp:HyperLink runat="server" ID="ModuleLessonCreateLink" ToolTip="New Lesson" Text="<i class='far fa-fw fa-chalkboard-teacher me-1'></i> New Lesson" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleAssessmentCreateLink" ToolTip="New Assessment" Text="<i class='far fa-fw fa-balance-scale me-1'></i> New Assessment" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleSurveyCreateLink" ToolTip="New Survey" Text="<i class='far fa-fw fa-check-square me-1'></i> New Survey" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleDocumentCreateLink" ToolTip="New Document" Text="<i class='far fa-fw fa-file-pdf me-1'></i> New Document" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleLinkCreateLink" ToolTip="New Link" Text="<i class='far fa-fw fa-link me-1'></i> New Link" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleVideoCreateLink" ToolTip="New Video" Text="<i class='far fa-fw fa-video me-1'></i> New Video" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="ModuleQuizCreateLink" ToolTip="New Single-Question Quiz" Text="<i class='far fa-fw fa-square-question me-1'></i> New Single-Question Quiz" CssClass="dropdown-item" /></li>
            ...
            <div>
                <div>
                    ...
                    <div runat="server" id="UnitCommandsContainer" class="node-inputs">
                        <div class="btn-group" style="margin-right:32px;">
                            <a runat="server" ID="UnitEditLink" title="New Unit, Module, and Activity" class="dropdown-toggle p-1" data-bs-toggle="dropdown" data-popper-strategy="fixed" aria-haspopup="true" aria-expanded="false"><i class="far fa-fw fa-plus-circle"></i></a>
                            <ul class="dropdown-menu dropdown-menu-right">

                                <li><asp:HyperLink runat="server" ID="UnitLessonCreateLink" ToolTip="New Lesson" Text="<i class='far fa-fw fa-chalkboard-teacher me-1'></i> New Lesson" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitAssessmentCreateLink" ToolTip="New Assessment" Text="<i class='far fa-fw fa-balance-scale me-1'></i> New Assessment" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitSurveyCreateLink" ToolTip="New Survey" Text="<i class='far fa-fw fa-check-square me-1'></i> New Survey" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitDocumentCreateLink" ToolTip="New Document" Text="<i class='far fa-fw fa-file-pdf me-1'></i> New Document" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitLinkCreateLink" ToolTip="New Link" Text="<i class='far fa-fw fa-link me-1'></i> New Link" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitVideoCreateLink" ToolTip="New Video" Text="<i class='far fa-fw fa-video me-1'></i> New Video" CssClass="dropdown-item" /></li>
                                <li><asp:HyperLink runat="server" ID="UnitQuizCreateLink" ToolTip="New Single-Question Quiz" Text="<i class='far fa-fw fa-square-question me-1'></i> New Single-Question Quiz" CssClass="dropdown-item" /></li>
