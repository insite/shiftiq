...
namespace InSite.Admin.Courses.Outlines.Controls
{
    public partial class ActivitySetupTab : UserControl
    {
        ...
        private void OnRequirementConditionChanged(bool isInit)
        {
            ...
            {
                DoneButtonText.Text = TActivity.DefaultDoneButtonText;
                DoneButtonInstructions.Text = TActivity.DefaultDoneButtonInstructions;
                DoneMarkedInstructions.Text = TActivity.DefaultDoneMarkedInstructions;
            }
        }

        public void BindModelToControls(TActivity activity, string validationGroup)
        {
            ...
            DoneButtonText.Text = activity.DoneButtonText.IfNullOrEmpty(TActivity.DefaultDoneButtonText);
            DoneButtonInstructions.Text = activity.DoneButtonInstructions.IfNullOrEmpty(TActivity.DefaultDoneButtonInstructions);
            DoneMarkedInstructions.Text = activity.DoneMarkedInstructions.IfNullOrEmpty(TActivity.DefaultDoneMarkedInstructions);
        ...
        private void SetRequirementType(TActivity activity)
        {
