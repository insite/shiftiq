<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivityEditDocument.ascx.cs" Inherits="InSite.Admin.Courses.Outlines.Controls.ActivityEditDocument" %>
...
<insite:Nav runat="server">
    ...
    <insite:NavItem runat="server" Title="Document Setup">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group mb-3">
                    <div class="float-end">
                        <asp:HyperLink runat="server" ID="DocumentUrlLink" Target="_blank" Visible="false">
                    ...
                    <div>
                        <insite:TextBox runat="server" ID="DocumentUrl" MaxLength="500" />
                        <div class="form-text">
                ...
                <div class="form-group mb-3">
                    ...
                    <div>
                        <insite:ComboBox runat="server" ID="DocumentTarget" Width="100%">
                            <Items>
                ...
                <div class="form-group mb-3">
                    ...
                    <div>
                        <asp:Literal runat="server" ID="DocumentViewer" />
                    </div>
                </div>
