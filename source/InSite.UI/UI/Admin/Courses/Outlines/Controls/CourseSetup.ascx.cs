    ...
    public partial class CourseSetup : BaseUserControl
    {
        ...
        public void BindControlsToModel(QCourse course, ContentContainer content)
        {
            ...
            if (WebPageIdentifier.ValueAsGuid.HasValue)
                SavePage(WebPageIdentifier.ValueAsGuid.Value, course);
        ...
        private void SavePage(Guid pageId, QCourse course)
        {
        ...
        private void SaveChangesToGradebook(QCourse course, TUnit[] units)
        {
        ...
        private void CreateGradebook(QCourse course, TUnit[] units, decimal? passPercent)
        {
