                    ...
                    <div runat="server" id="ExistedEnrollmentsPanel" class="row">
                        <div class="col-lg-12">
                            <div id="CommandButtons" runat="server" style="padding-bottom: 10px;">
                                ...
                                <insite:Button runat="server" ID="PreDeleteButton" ButtonStyle="Default" ToolTip="Delete Selected Enrollments" style="padding:5px 8px;" Icon="fas fa-fw fa-trash-alt" />
                            </div>
