...
<div class="mb-3">
    ...
    <insite:Button runat="server" ID="UnselectAllButton" ButtonStyle="Default" ToolTip="Deselect All" style="padding:5px 8px; display:none;" Icon="far fa-fw fa-check-square" />
    <insite:Button runat="server" ID="AddButton" ButtonStyle="Default" ToolTip="Add" style="padding: 5px 8px;" Icon="fas fa-fw fa-plus-circle" />
    <insite:Button runat="server" ID="DeleteButton" ButtonStyle="Default" ToolTip="Delete" style="padding:5px 8px;" Icon="fas fa-fw fa-trash-alt" ConfirmText="Are you sure to delete access for selected group(s)?" />
</div>
