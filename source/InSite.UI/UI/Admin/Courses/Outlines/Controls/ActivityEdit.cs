...
namespace InSite.Admin.Courses.Outlines.Controls
{
    public abstract class BaseActivityEdit : BaseUserControl, IActivityEdit
    {
        ...
        protected void BindModelsToControls(TActivity activity, Shift.Common.ContentContainer content)
        {
        ...
        protected abstract void BindModelToControls(TActivity activity);
