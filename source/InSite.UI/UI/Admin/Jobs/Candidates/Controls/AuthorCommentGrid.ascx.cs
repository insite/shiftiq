...
{
    public partial class AuthorCommentGrid : SearchResultsGridViewController<TCandidateCommentFilter>
    {
        ...
        {
            Search(new TCandidateCommentFilter() { AuthorContactId = contactId });
        }
