...
<insite:Grid runat="server" ID="Grid">
    <Columns>
        ...
        <asp:TemplateField ItemStyle-Wrap="False" ItemStyle-Width="30px">
            <itemtemplate>
                <a href='<%# string.Format("/ui/admin/messages/deliveries/view?mailout={0}&recipient={1}", MailoutIdentifier, HttpUtility.UrlEncode((string)Eval("RecipientAddress"))) %>' title="View Email"><i class="icon far fa-fw fa-search x20"></i></a>
            </itemtemplate>
        </asp:TemplateField>
    </Columns>
</insite:Grid>
