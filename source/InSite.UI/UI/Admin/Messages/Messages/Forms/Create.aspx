                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div runat="server" ID="NewSurveyFormField" visible="false" class="form-group mb-3">
                                                <label class="form-label">
                                                    Survey Form
                                                    <insite:RequiredValidator runat="server" ControlToValidate="NewSurveyFormSelector" FieldName="Survey Form" ValidationGroup="Message" />
                                                </label>
                                                <insite:FindSurveyForm runat="server" ID="NewSurveyFormSelector" EmptyMessage="Select a survey in the Surveys toolkit" />
                                                <div class="form-text">
                                                    A link to this survey must be included in the body of the invitation email.
                                                </div>
                                            </div>
