                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div runat="server" id="InvitationRespondents" class="col-lg-8" visible="false">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <h3 class="card-title mb-3">Survey Respondents</h3>

                                    <insite:DownloadButton runat="server" ID="DownloadRespondentsCsv" />
                                    <insite:DeleteButton runat="server" ID="DeleteRespondents" OnClientClick="return confirm('Are you sure you want to remove from this message the recipients who have answered the survey?');" />
                                    &nbsp;
