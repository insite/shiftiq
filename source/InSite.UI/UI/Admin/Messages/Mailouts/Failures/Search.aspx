<%@ Page Language="C#" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" CodeBehind="Search.aspx.cs" Inherits="InSite.UI.Admin.Messages.Mailouts.Failures.Search" %>

<%@ Register Src="~/UI/Admin/Messages/Mailouts/Failures/Controls/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/Admin/Messages/Mailouts/Failures/Controls/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
