<%@ Page Language="C#" CodeBehind="Search2.ascx.cs" Inherits="InSite.Cmds.Admin.Profiles.Forms.Search2" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/CMDS/Common/Controls/User/FieldProfileSearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/CMDS/Common/Controls/User/FieldProfileSearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
