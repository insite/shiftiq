...
{
    public partial class FieldProfileSearchCriteria : SearchCriteriaController<ProfileFilter>
    {
        public override ProfileFilter Filter
        {
            get
            {
                var filter = new ProfileFilter
                {
                    ...
                    CompaniesForPersonId = User.UserIdentifier
                };
        ...
        private void LoadParentProfiles()
        {
            ...
            if (AccountScope.Value == AccountScopes.Organization)
                ...
                ParentProfile.Filter.ProfileOrganizationIdentifier = Company.Value ?? Guid.Empty;
