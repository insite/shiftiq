...
namespace InSite.UI.CMDS.Common.Controls.User
{
    public partial class AchievementListEditor : BaseUserControl
    {
        ...
        public List<AchievementListGridItem> GetMatchingAchievements(Guid enterpriseId, Guid organizationId, string scope, string keyword)
        {
            return VCmdsAchievementSearch.SelectOrganizationAchievements(enterpriseId, organizationId, scope, keyword);
        }
        ...
        public int LoadAchievements(GroupByEnum? groupBy = GroupByEnum.Type)
        {
            ...
            var matchingAchievements = GetMatchingAchievements(enterpriseId, organizationId, scope, keyword);
