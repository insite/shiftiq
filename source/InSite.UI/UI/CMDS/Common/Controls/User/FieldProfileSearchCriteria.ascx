<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FieldProfileSearchCriteria.ascx.cs" Inherits="InSite.Cmds.Controls.Profiles.Profiles.FieldProfileSearchCriteria" %>
