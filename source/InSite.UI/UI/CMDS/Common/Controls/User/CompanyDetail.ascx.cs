...
namespace InSite.Cmds.Controls.Contacts.Companies
{
    public partial class CompanyDetails : UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            CompanyDomainValidator.ServerValidate += CompanyDomainValidator_ServerValidate;
        }
        ...
        public void GetInputValues(OrganizationState organization)
        {
            ...
            organization.CompanyDomain = UrlHelper.GetDomainName(WebSiteUrl.Text).MaxLength(50);
        ...
        private void CompanyDomainValidator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            try
            {
                args.IsValid = !string.IsNullOrWhiteSpace(UrlHelper.GetDomainName(WebSiteUrl.Text));
            }
