    ...
    public sealed class CmdsUploadStorage : IDisposable
    {
        ...
        private class UploadModel : ICmdsUploadModel
        {
            ...
            private string GetEntityFilePath() =>
                IsNew ? null : _storage._provider.StoragePath + "\\" + _originalKey.ContainerId + "\\" + _originalKey.Name;

            private string GetModelFilePath() =>
                _storage._provider.StoragePath + "\\" + ContainerID + "\\" + Name;

            private string GetTempFilePath(string ext) =>
                _storage._provider.TempStoragePath + "\\" + _storage.ID + "_" + _tempId + "." + ext;
