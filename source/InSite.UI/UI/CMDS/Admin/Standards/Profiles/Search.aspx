...
<%@ Register Src="~/UI/CMDS/Common/Controls/User/ProfileSearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/CMDS/Common/Controls/User/ProfileSearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
