...
using InSite.Persistence.Custom.CMDS;
...
namespace InSite.Cmds.Admin.Competencies.Forms
{
    public partial class Edit : AdminBasePage, ICmdsUserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            AchievementEditor.InitDelegates(SelectAchievements, SelectAchievementsToAdd, DeleteAchievements, InsertAchievements, "competency");
        ...
        public override void ApplyAccessControlForCmds()
        {
            ...
            DeleteButtonSpacer.Visible = Access.Delete;
        }
        ...
        private DataTable SelectAchievements()
        {
            return VCmdsAchievementSearch.SelectCompetencyAchievements(StandardIdentifier);
        }

        private DataTable SelectAchievementsToAdd(string searchText, string achievementVisibility)
        {
            return VCmdsAchievementSearch.SelectNewCompetencyAchievements(StandardIdentifier, searchText);
        }
        ...
        private bool CheckDeleteAllowed()
        {
            ...
            message.AppendFormat(
                "You can't delete this competency ({0}) because it is referenced by the following {1}:<br/>",
            ...
            message.AppendFormat(
                "You must remove the competency from the {0} that reference it before you can delete the competency.",
                nameList);
