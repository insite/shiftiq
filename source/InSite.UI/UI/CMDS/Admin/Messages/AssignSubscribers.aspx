<%@ Page Language="C#" CodeBehind="AssignSubscribers.aspx.cs" Inherits="InSite.Custom.CMDS.Admin.Workflows.Departments.Forms.Assign" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register TagPrefix="uc" TagName="SubscriberGrid" Src="DepartmentSubscriberGrid.ascx" %>
                            ...
                            <ContentTemplate>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        Organization
                                        <insite:RequiredValidator runat="server" ControlToValidate="AssetOrganizationIdentifier" FieldName="Organization" ValidationGroup="Assignment" />
                                    </label>
                                    <insite:AuthorizedOrganizationComboBox runat="server" ID="AssetOrganizationIdentifier" AllowBlank="false" />
                                </div>
                                ...
                                <div runat="server" id="EmploymentTypeField" class="form-group mb-3">
                                    <label class="form-label">
                                        Employment Type
                                    </label>
                                    <div>
                                ...
                                <div class="mt-3">
                                    <insite:FilterButton runat="server" ID="SearchButton" ValidationGroup="Assignment" CausesValidation="true" />
                                    <insite:Button runat="server" ID="TriggerButton" Icon="far fa-bolt" Text="Trigger" ButtonStyle="Success" />
                                </div>
