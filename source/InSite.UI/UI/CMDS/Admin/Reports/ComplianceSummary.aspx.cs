...
$(window).one('load', function () {{
    document.getElementById('{DownloadXlsx.ClientID}').click();
        ...
        {
            return (Organization.OrganizationIdentifier != OrganizationIdentifiers.Keyera ? "Compliance Summary Report" : "Commitment Summary Report")
                 + (isShowStatus ? " (with Statuses)" : string.Empty);
        }
