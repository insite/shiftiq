    ...
    public partial class UserTrainingSummary : AdminBasePage, ICmdsUserControl
    {
        ...
        private void LoadAchievements()
        {
            _achievements = Department.Value.HasValue
                ...
                : VCmdsCredentialSearch.SelectAchievementsByCompany(Organization.Identifier, _achievementCategories, GetIsRequired());
        ...
        private void LoadEmployees()
        {
            _employees = Department.Value.HasValue
                ...
                : ContactRepository3.SelectEmployeesByOrganizationIdentifier(Organization.Identifier);
        ...
        private void LoadEmployeeAchievements()
        {
            var credentials = Department.Value.HasValue
                ...
                : VCmdsCredentialSearch.SelectEmployeeAchievementsByCompany(Organization.Identifier, _achievementCategories, GetIsRequired());
