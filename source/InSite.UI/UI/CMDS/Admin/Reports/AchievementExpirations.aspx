<%@ Page Language="C#" CodeBehind="AchievementExpirations.aspx.cs" Inherits="InSite.Cmds.Admin.Reports.Forms.ExpiredCredentials" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>
                    ...
                    <asp:Repeater runat="server" ID="DataRepeater">
                        <HeaderTemplate>
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <td colspan="2" class="text-center text-white" style="background-color: #2c2d3f; border-right:1px solid #f3f3f3;">User</td>
                                        <td colspan="4" class="text-center text-white" style="background-color: #2c2d3f; border-right:1px solid #f3f3f3;">Asset</td>
                                        <td colspan="2" class="text-center text-white" style="background-color: #2c2d3f;"></td>
                                    </tr>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
