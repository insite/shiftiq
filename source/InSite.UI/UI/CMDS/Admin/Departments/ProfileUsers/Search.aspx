<%@ Page Language="C#" CodeBehind="Search.aspx.cs" Inherits="InSite.Custom.CMDS.Admin.Standards.DepartmentProfileUsers.Forms.Search" MasterPageFile="~/UI/Layout/Admin/AdminHome.master" %>

<%@ Register Src="~/UI/CMDS/Admin/Departments/ProfileUsers/SearchCriteria.ascx" TagName="SearchCriteria" TagPrefix="uc" %>
<%@ Register Src="~/UI/CMDS/Admin/Departments/ProfileUsers/SearchResults.ascx" TagName="SearchResults" TagPrefix="uc" %>
