<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Delete.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.Delete" %>
...
<div class="mb-4 alert alert-danger">
    ...
    <%= Translate("Are you sure you want to delete this response session?") %>
</div>
...
<asp:Panel runat="server" ID="DebugPanel" Visible="false">
    ...
    <ul>
        <li>
            Here we need to display information about the selected response and prompt the user to confirm the delete.
        </li>
    </ul>
