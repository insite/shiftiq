<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurveyDebugInfo.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.SurveyDebugInfo" %>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header text-danger fs-5">
                <insite:Literal runat="server" Text="Current Survey" />
            </div>
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Response Limit</dt>
    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header text-danger fs-5">Current Response</div>
            <div class="card-body">
