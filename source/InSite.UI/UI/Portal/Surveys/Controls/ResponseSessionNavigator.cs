...
{
    public class ResponseSessionNavigator
    {
        ...
        public WebUrl GetAnswerPageUrl(Guid session, string page, Guid? question)
        {
        ...
        {
            return GetPageUrl(ResponseVerb.Start, session);
        }
        ...
        {
            var url = new WebUrl("/ui/survey/respond/" + verb.GetNameLowerCase());
