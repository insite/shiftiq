...
{
    public partial class Confirm : ResponseSessionControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                PreviousButton.NavigateUrl = ResponseSessionNavigator.GetResumePageUrl(Current.SessionIdentifier).ToString();
        ...
        private string GetInstructions()
        {
            ...
            var buttonText = GetDisplayText("Submit My Response");

            instructions = GetDisplayHtml("Survey Response Completed: Ending Instructions")
