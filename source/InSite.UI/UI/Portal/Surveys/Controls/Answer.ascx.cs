...
{
    public partial class Answer : ResponseSessionControl
    {
        ...
        private void LaunchButton_Click(object sender, EventArgs e)
            => ResponseSessionNavigator.RedirectTo(ResponseVerb.Launch, Current.SessionIdentifier);
        ...
        private bool IsSurveyOpen()
        {
            if (Current.Survey.Status == SurveyFormStatus.Closed || Current.Survey.Status == SurveyFormStatus.Archived)
            {
                ...
                StatusAlert.AddMessage(AlertType.Error, Translate("Survey has been closed."));
                return false;
            }
        ...
        private bool SaveAnswers()
        {
            ...
            foreach (var question in questions)
            {
                ...
                if (control != null)
                {
                    ...
                    else if (control is SurveyFileUpload upload)
                    {
                        ...
                        {
                            var error = AppPage.GetDisplayHtml("Missing Required Survey Answer", $"Please answer all required questions on this page.");
        ...
        private bool CheckUploadsValid(List<SurveyQuestion> questions)
        {
            ...
            foreach (var question in questions)
            {
                ...
                if (!(control is SurveyFileUpload upload) || upload.UploadedFiles.Length == 0)
                    continue;
