<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GoTo.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.GoTo" %>
...
<section class="container mb-2 mb-sm-0 pb-sm-5">
    ...
    <asp:Panel runat="server" ID="DebugPanel" Visible="false">
        ...
        <ul>
            ...
            <li>It calculates the next page, based on the current page and the current response.
            </li>
            <li>If Debug mode is disabled, then this page automatically jumps to the Next or Previous page, based on
            the branches defined for the survey, and based on the answers submitted by the user on preceding questions.
            </li>
        </ul>
