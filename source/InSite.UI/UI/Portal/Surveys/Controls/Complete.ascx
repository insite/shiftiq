<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Complete.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.Complete" %>
...
<div class="mb-4">
    ...
    <insite:Button runat="server" ID="ReviewButton" Text="Review my Response" Icon="fas fa-arrow-alt-right" IconPosition="AfterText" ButtonStyle="Primary" />
</div>
...
<asp:Panel runat="server" ID="DebugPanel" Visible="false">
    ...
    <ul>
        <li>
            If the survey has completed instructions then these are displayed here. 
        </li>
        <li>
