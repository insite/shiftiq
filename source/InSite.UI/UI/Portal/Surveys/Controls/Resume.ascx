<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resume.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.Resume" %>
...
<section class="container mb-2 mb-sm-0 pb-sm-5">
    ...
    <asp:Panel runat="server" ID="DebugPanel" Visible="false">
        ...
        <ul>
            ...
            <li>It automatically jumps to the survey page that contains the last question 
            answered by the user.
            </li>
            <li>If the user has not answered any questions then this page jumps to the first page of the survey.
            </li>
        </ul>
