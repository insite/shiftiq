<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReviewDetails.ascx.cs" Inherits="InSite.UI.Portal.Surveys.Responses.Controls.ReviewDetails" %>
                                ...
                                <div class="mb-4" data-question-item='<%# Eval("Identifier") %>'>
                                    ...
                                    <div class="row" runat="server" id="AnswerPanel" visible='<%# !(bool)Eval("IsHidden") %>'>
                                        <div class='col-md-12'>
                                            ...
                                            <p runat="server" style="font-weight:bold;" visible='<%# !HasResponse() %>'>No Response</p>
...
<insite:PageFooterContent runat="server">
    <link rel="stylesheet" href="/ui/portal/surveys/controls/charts.css" />
    <script src="/ui/portal/surveys/controls/charts.js"></script>
</insite:PageFooterContent>
