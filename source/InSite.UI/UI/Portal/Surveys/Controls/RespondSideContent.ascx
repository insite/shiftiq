<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RespondSideContent.ascx.cs" Inherits="InSite.UI.Portal.Surveys.Controls.RespondSideContent" %>
...
<div class="p-4">
    <asp:HyperLink runat="server" ID="ReturnToCourseButton" Visible="false" CssClass="dropdown-item"><i class="me-1 fas fa-fw fa-chevron-double-left"></i> Return to Course</asp:HyperLink>
</div>
