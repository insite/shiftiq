...
namespace InSite.UI.Portal.Surveys.Responses.Controls
{
    public partial class ReviewDetails : BaseUserControl
    {
        ...
        private ResponseSessionState _state;
        private ResponseSessionNavigator _navigator;
        ...
        internal void LoadData(ResponseSessionState state, ResponseSessionNavigator navigator, UserFeedbackType feedbackType, bool print)
        {
            _state = state;
