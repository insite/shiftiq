...
namespace InSite.Portal.Surveys.Responses
{
    ...
    {
        private readonly ResponseSessionState _current;
        ...
        public AnswerInputControlBuilder(ResponseSessionState current, GlossaryHelper glossary)
        {
            _current = current;
            _glossary = glossary;
        }
        ...
        public IEnumerable<Control> CreateInputControls(Guid sessionIdentifier, SurveyQuestion question, string answer, AnswerItem item, bool consent = false)
        {
            ...
            {
                var input = new SurveyFileUpload
                {
                    ID = inputID,
        ...
        private void OptionItemChanged(object sender, EventArgs e)
        {
            ...
            else if (sender is SurveyComboBox select)
            {
        ...
        {
            var fileUpload = (SurveyFileUpload)sender;
