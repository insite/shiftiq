<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Confirm.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.Confirm" %>
...
<div runat="server" id="ButtonPanel" class="mb-4">
    ...
    <insite:Button runat="server" ID="SubmitButton" ButtonStyle="Success" Icon="fas fa-check" Text="Submit My Response" DisableAfterClick="true" />
</div>
...
<asp:Panel runat="server" ID="DebugPanel" Visible="false">
    ...
    <ul>
        <li>
            This page prompts the user to confirm final submission of their completed response. After a response is 
