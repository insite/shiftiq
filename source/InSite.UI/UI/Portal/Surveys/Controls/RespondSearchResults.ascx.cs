...
{
    public partial class RespondSearchResults : SearchResultsGridViewController<QResponseSessionFilter>
    {
        ...
        private void Grid_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            ...
            var deleteUrl = ResponseSessionNavigator.GetDeletePageUrl(dataItem.ResponseSessionIdentifier).ToString();
