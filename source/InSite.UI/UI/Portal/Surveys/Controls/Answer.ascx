<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Answer.ascx.cs" Inherits="InSite.Portal.Surveys.Responses.Answer" %>
...
<asp:Panel runat="server" ID="DebugPanel" Visible="false">
    ...
    <ul>
        <li>
            This page shows the questions for a specific page in the survey.
        </li>
        <li>
        ...
        <li>
            On the <strong>first</strong> page: If the Launch page is accessible (i.e. the survey contains starting instructions, or I can submit more than
            one response) then an Instructions button is displayed instead of the Previous button.
        </li>
        <li>
