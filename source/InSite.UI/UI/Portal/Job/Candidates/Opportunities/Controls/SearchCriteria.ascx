<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchCriteria.ascx.cs" Inherits="InSite.UI.Portal.Jobs.Candidates.Opportunities.Controls.SearchCriteria" %>
    ...
    <div class="col-12">
        <div id="toolbox" class="toolbox-section">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-2">
                        <insite:GroupComboBox runat="server" ID="StreamIdentifier" EmptyMessage="Opportunity Stream" />
                    </div>
                    <div class="mb-2">
                        <insite:OccupationListComboBox runat="server" ID="OccupationIdentifier" EmptyMessage="Occupation" />
                    </div>
                </div>
            </div>
        </div>
