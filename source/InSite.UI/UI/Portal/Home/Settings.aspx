        ...
        <div class="bg-secondary rounded-3 p-4 mb-4">
            ...
            <div class="d-block d-sm-flex align-items-center">
                ...
                <div class="ps-sm-3 text-center text-sm-start">
                    <button class="btn btn-outline-secondary shadow btn-sm mb-2" type="button" data-bs-toggle="collapse" data-bs-target='<%= "#" + ProfileUploadPanel.ClientID %>' aria-expanded="false" aria-controls='<%= ProfileUploadPanel.ClientID %>'>
                        <i class="far fa-fw fa-arrows-rotate me-2"></i>Change photo</button>
            ...
            <div class="accordion-collapse collapse" runat="server" id="ProfileUploadPanel" aria-labelledby='item-header-1234' data-bs-parent="#orders-accordion" enableviewstate="false">
                <div class="accordion-body pt-4 bg-secondary rounded-top-0 rounded-3" style="padding-bottom: 0;">             
                    <div class="pb-4">
                        <insite:FileUploadV1 runat="server" ID="ProfilePictureToUpload" LabelText="Select profile picture to upload" AllowedExtensions=".jpg,.jpeg,.gif,.png" />
                        <insite:FileUploadV2 runat="server" ID="ProfilePictureToUploadV2" LabelText="Select profile picture to upload" AllowedExtensions=".jpg,.jpeg,.gif,.png" />
                        <div class="pt-2">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <insite:Button runat="server" ID="ChangePasswordButton" Text="Change Password" ButtonStyle="Default" Icon="fas fa-fw fa-sync" CausesValidation="false" CssClass="mb-3 float-end" NavigateUrl="/ui/portal/identity/password"/>
            </div>
        </div>
    </div>
