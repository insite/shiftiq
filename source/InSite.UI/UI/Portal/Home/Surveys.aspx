<%@ Page Language="C#" CodeBehind="Surveys.aspx.cs" Inherits="InSite.UI.Portal.Home.Surveys" MasterPageFile="~/UI/Layout/Portal/Portal.master" %>
                    ...
                    <div class="card mb-4">
                      <div class="card-body">
                        ...
                        <div class="float-end">
                            ...
                            <insite:Button runat="server" ID="DeleteButton" Icon="fas fa-trash-alt" ToolTip="Delete Response" ButtonStyle="Default" />
                        </div>
