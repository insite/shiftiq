...
namespace InSite.UI.Portal.Home.Management
{
    public partial class Home : PortalBasePage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            AssignUserIdentifier.ValueChanged += AssignUserIdentifier_ValueChanged;
        ...
        private void AssignUserIdentifier_ValueChanged(object sender, FindEntityValueChangedEventArgs e)
        {
            var userId = AssignUserIdentifier.Value;
        ...
        private void DistributionRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Resend")
            {
                if (key.LearnerUserId.HasValue)
                    SendUserWelcome(key.LearnerUserId.Value);
            }
        ...
        protected string GetGridStatusHtml()
        {
            ...
            {
                case CourseDistributionGridItem.StatusType.Unassigned:
                    return "<i class=\"far fa-fw fa-circle\"></i> Unassigned";
                case CourseDistributionGridItem.StatusType.NotStarted:
                case CourseDistributionGridItem.StatusType.Assigned:
                    return "<i class=\"fas fa-fw fa-circle text-info\"></i> Not Started";
                case CourseDistributionGridItem.StatusType.InProgress:
                    return "<i class=\"fas fa-fw fa-circle text-warning\"></i> In Progress";
                case CourseDistributionGridItem.StatusType.Completed:
                    return "<i class=\"fas fa-fw fa-circle text-success\"></i> Completed on " + LocalizeDate(Eval("AttemptGraded"));
                default:
        ...
        private void SendUserWelcome(Guid userId)
        {
            ...
            ServiceLocator.AlertMailer.Send(Organization.Identifier, userId, alert);
        }
