...
namespace InSite.UI.Portal.Billing
{
    public partial class Checkout : PortalBasePage
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            AccountInfo.Visible = !CurrentSessionState.Identity.IsAuthenticated;
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            EditorStatus.AddMessage(
                ...
                "You will receive email with login instructions shortly.<br>" +
        ...
        {
            var userId = Identity.IsAuthenticated ? User.Identifier : CreateUser();
            var cart = CartStorage.Get();
        ...
        private void BindTotalsForCart(CartState cart)
        {
            ...
            SubtotalLit.Text = Currency(subtotal);
            TaxLit.Text = Currency(tax);
            TotalLit.Text = Currency(total);
        }
        ...
        {
            var invoiceId = orders.FirstOrDefault().InvoiceIdentifier;
            ProductHelper.SendPaidInvoiceInformation(invoiceId);
        }
        ...
        {
            SubtotalLit.Text = Currency(amount);
            TotalLit.Text = Currency(amount);
        }
