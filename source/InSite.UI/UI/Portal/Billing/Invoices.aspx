...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Accordion runat="server" ID="MainAccordion">
        <insite:AccordionPanel runat="server" ID="UnpaidInvoicePanel" Title="Unpaid Invoices" Icon="fas fa-file-invoice-dollar">

            <asp:Repeater runat="server" ID="UnpaidInvoiceRepeater">
                <HeaderTemplate>
        ...
        <insite:AccordionPanel runat="server" ID="PaidInvoicePanel" Title="Invoices" Icon="fas fa-file-invoice-dollar">

            <asp:Repeater runat="server" ID="PaidInvoiceRepeater">
                <HeaderTemplate>
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <thead>
