...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <asp:UpdatePanel ID="SummaryPanel" runat="server">
        <ContentTemplate>
            ...
            <div class="d-lg-flex gap-4 g-4 mt-2">
                <!-- Column 1: Order Summary -->
                <div class="flex-same-size">
                    <div class="p-4 h-100">
                        ...
                        <asp:Repeater runat="server" ID="SummaryRepeater">
                            <ItemTemplate>
                                <div class="d-flex justify-content-between align-items-start py-2">
                                    <div class="pe-3">
                                        <a href='<%# Eval("Url") %>' class="text-decoration-underline fw-semibold"><%# Eval("Name") %></a>
                        ...
                        <div class="pt-4 mt-2">
                            <div class="d-flex justify-content-between mb-1">
                                <span>Subtotal</span>
                                <span>
                                    <asp:Literal runat="server" ID="SubtotalLit" /></span>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <span>
                                    <asp:Literal runat="server" ID="TaxLit" /></span>
                            </div>
                            <div class="d-flex justify-content-between fw-semibold">
                                <span>Total</span>
                                <span>
                                    <asp:Literal runat="server" ID="TotalLit" /></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-same-size">
                    <div class="cardish p-4 h-100">
                        ...
                        <h6 class="mt-1 mb-3">Billing Address</h6>
                ...
                <div runat="server" id="AccountInfo" class="flex-same-size">
                    <div class="cardish p-4 h-100">
    ...
    <div class="mt-4 d-flex justify-content-end">
        <insite:SaveButton runat="server" ID="SubmitButton" Text="Submit" ValidationGroup="Checkout" />
    </div>
