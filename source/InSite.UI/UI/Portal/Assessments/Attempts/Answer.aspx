        ...
        <div id="attempt-commands" class="mt-4 attempt-commands">
            <asp:Panel runat="server" ID="CommandsPanel">
                ...
                <a runat="server" id="ViewFormulasLink" title="View Formulas" class="btn btn-default">
                    <i class="fal fa-fw fa-square-root-alt"></i>
                </a>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td class="addendum-icon">
                                                    <i class='<%# Eval("Icon", "fal fa-fw fa-{0}") %>'></i>
                                                </td>
                                                ...
                                                <td class="addendum-cmd">
                                                    <a target="_blank" href='<%# Eval("Url") %>' title="Open in a new window"><i class="far fa-fw fa-folder-open"></i></a>
                                                    <a href='<%# Eval("Url") + "?download=1" %>' title="Download" class="ms-2"><i class="far fa-fw fa-download"></i></a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
