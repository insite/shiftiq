...
<script type=""text/javascript"">
    ...
    const _answerStrings = {{
        ...
        attempt: {{
            ...
            confirmQuestion: {TranslateAndJsEncode("Are you ready to submit your responses?")},
            confirmReminder: {TranslateAndJsEncode("Please remember, after your responses are submitted, you cannot change any of your answers.")}
        }},
        nextSection: {{
            confirmSome: {TranslateAndJsEncode("You have answered $1 out of $2 questions.")},
            confirmAll: {TranslateAndJsEncode("You have answered all questions.")},
