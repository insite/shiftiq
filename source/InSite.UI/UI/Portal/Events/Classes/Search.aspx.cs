...
namespace InSite.UI.Portal.Events.Classes
{
    public partial class Search : PortalBasePage
    {
        ...
        {
            var classes = GetClasses(SearchText.Text, HideFullWithNoWaitlist.Checked);
        ...
        private static List<ClassItem> GetClasses(string eventTitle, bool hideFullWithNoWaitlist)
        {
