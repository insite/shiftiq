    ...
    public partial class HomeAdminPanel : BaseUserControl
    {
        ...
        public bool HasQuickLinkMenu
        {
            get
            {
                ...
                return
                  organization.OrganizationIdentifier == OrganizationIdentifiers.BCPVPA
               || organization.IsIndustrySpecialist()
               || organization.OrganizationIdentifier == OrganizationIdentifiers.InSite
               || organization.OrganizationIdentifier == OrganizationIdentifiers.SkilledTradesBC
               || organization.OrganizationIdentifier == OrganizationIdentifiers.NCSHA
               ;
            }
        }
