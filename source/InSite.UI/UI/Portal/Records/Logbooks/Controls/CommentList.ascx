            ...
            <ItemTemplate>
                ...
                <div style="width: 100%;">
                    ...
                    <div style="float:right;">
                        <a runat="server" id="ChangeLink" title="Change Comment"><i class="icon fas fa-fw fa-pencil"></i></a>
                        <a runat="server" id="DeleteLink" title="Delete Comment"><i class="icon fas fa-fw fa-trash-alt"></i></a>
                    </div>
