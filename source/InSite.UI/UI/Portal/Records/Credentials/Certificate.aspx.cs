...
namespace InSite.UI.Portal.Records.Credentials
{
    public partial class Certificate : PortalBasePage
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var filename = certificate.Variables["Certificate.Code"];
            filename = !string.IsNullOrEmpty(filename) ? FileHelper.AdjustFileName(filename, true, false) + "_certificate" : "certificate";
