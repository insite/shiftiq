<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Plan.aspx.cs" Inherits="InSite.UI.Portal.Learning.Programs.Plan" MasterPageFile="~/UI/Layout/Portal/Portal.master" %>
        ...
        <div class="card border-0 shadow-lg">
            <div class="card-body">
                ...
                <insite:UpdatePanel runat="server" ID="UpdatePanel">
                    <ContentTemplate>
                        <div runat="server" ID="ProgramPanel" class="row">
                            <div class="col-md-6">
