        ...
        <ol runat="server" id="OutlineList">
            <li>
                ...
                <a runat="server" id="CourseOverviewLink" class="" href="#">
                    <i class="fas fa-fw fa-info-circle me-1"></i><insite:Literal runat="server" Text="Overview" />
                </a>

                <a runat="server" id="CourseDiscussionsLink" class="" href="#">
                    <i class="fas fa-fw fa-comments me-1"></i><insite:Literal runat="server" Text="Discussions" />
                </a>

                <a runat="server" id="CourseAchievementsLink" visible="false" class="" href="#">
                    <i class="fas fa-fw fa-award me-1"></i><insite:Literal runat="server" Text="Achievements" />
                </a>

                <asp:LinkButton runat="server" ID="RestartCourseButton" CssClass="mt-3">
                    <i class="fas fa-fw fa-redo me-1"></i><insite:Literal runat="server" Text="Restart" />
                </asp:LinkButton>
        ...
        <div class="lesson col-full-height">
            ...
            <div runat="server" id="OverviewPanel" visible="false">
                ...
                <div runat="server" id="OverviewAchievementPanel" visible="false">
                    ...
                    <insite:Alert runat="server" ID="ValidAlert" Icon="fa-solid fa-circle-check" Indicator="Success"
                        Text="Congratulations on completing the course! To recognize your achievement, you can download your Certificate of Completion using the <strong>Download</strong> button." />

                    <insite:Alert runat="server" ID="ExpiredAlert" Icon="fa-solid fa-circle-exclamation" Indicator="Warning"
                        Text="Your Certificate of Completion is now expired. To receive a current certificate, please retake the course:  click <strong>Restart</strong> in the menu on the left side of the page." />
                    
                    <uc:CertificateRepeater runat="server" ID="CertificateRepeater" />
                    
                    <insite:Alert runat="server" Icon="fa-solid fa-circle-info" Indicator="Information" CssClass="mt-4"
                        Text="You can restart the course any time: click <strong>Restart</strong> in the menu on the left side of the page." />
