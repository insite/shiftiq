...
namespace InSite.UI.Desktops.Design.Users.Controls
{
    public partial class SearchResults : SearchResultsGridViewController<PersonFilter>
    {
        ...
        protected string GetImpersonateIcon(Guid user, bool isApproved)
        {
            ...
            return isApproved
                ? $"<a class='btn btn-sm btn-default' title='{Translate("Impersonate")}' href='/ui/portal/identity/impersonate?user={user}'><i class='fas fa-fw fa-user-secret'></i></a>"
                : $"<span class='btn btn-sm btn-default' title='{Translate("Not Approved")}' class='text-danger'><i class='fas fa-fw fa-user-secret'></i></span>";
        }
