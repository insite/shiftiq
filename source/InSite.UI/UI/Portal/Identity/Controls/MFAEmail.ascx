<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MFAEmail.ascx.cs" Inherits="InSite.UI.Portal.Accounts.Users.Controls.MFAEmail" %>
        ...
        <asp:MultiView runat="server" ID="Steps">
            ...
            <asp:View runat="server" ID="Step1">
                <div class="form-group mb-3 w-50">
                    ...
                    <div>
                        <insite:TextBox ID="EmailAddress" runat="server" MaxLength="32" ReadOnly="true" />
                        <div class="form-text">
                            In order to verify your email address you will recieve an email from InSite containing a PIN code in the next step.
                        </div>
                    </div>
                </div>
            </asp:View>
            ...
            <asp:View runat="server" ID="Step2">
                <div class="form-group mb-3 w-50">
                    ...
                    <div>
                        <insite:TextBox ID="EmailAddress2" runat="server" ReadOnly="true" />
                    </div>
                </div>
...
<insite:Button runat="server"
    ...
    Icon="fas fa-share"
    Visible="false"
    OnClientClick="return mfaEmail.clientClick()"
/>
...
<insite:PageFooterContent runat="server">
    <script type="text/javascript">
        (() => {
            const instance = window.mfaEmail = window.mfaEmail || {};
