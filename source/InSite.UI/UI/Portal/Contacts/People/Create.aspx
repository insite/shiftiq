...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">
                            ...
                            <asp:CustomValidator runat="server" ID="UniqueEmail" ControlToValidate="PersonEmail" ErrorMessage="The email is already in use" ValidationGroup="Person" />
                        </label>
    ...
    <insite:SaveButton runat="server" ID="SaveButton" ValidationGroup="Person" DisableAfterClick="true" />
