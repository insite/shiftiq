...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <insite:Container runat="server" ID="ContentContainer">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="float-end">
                    <insite:Button runat="server" ID="ExpandAllButton" Text="Expand All" Icon="fas fa-fw fa-chevron-down" PostBackEnabled="false" ButtonStyle="Default" />
                    <insite:Button runat="server" ID="CollapseAllButton" Text="Collapse All" Icon="fas fa-fw fa-chevron-up" PostBackEnabled="false" ButtonStyle="Default" />
                </div>
