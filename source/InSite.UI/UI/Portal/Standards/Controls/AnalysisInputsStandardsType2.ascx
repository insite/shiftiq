<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnalysisInputsStandardsType2.ascx.cs" Inherits="InSite.UI.Portal.Standards.Controls.AnalysisInputsStandardsType2" %>
...
<div class="form-group mb-3">
    <label class="form-label" for="<%# StandardTypeSelector2.ClientID %>">
        <insite:Literal runat="server" Text="Standard 2" />
        <insite:RequiredValidator runat="server" ControlToValidate="StandardTypeSelector2" FieldName="Standard Type 2" ValidationGroup="Analysis" />
    </label>
    <div>
        <insite:StandardTypeComboBox runat="server" ID="StandardTypeSelector2" Width="150px" EmptyMessage="Type" />
    </div>
</div>