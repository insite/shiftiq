...
<insite:UpdatePanel runat="server" ID="UpdatePanel">
    <ContentTemplate>
        ...
        <div style="padding-top:5px;">
            <insite:Button runat="server" ID="ExpandAllButton" ButtonStyle="OutlineSecondary" CssClass="btn-bg-white" Icon="fas fa-fw fa-chevron-down" Text="Expand All" />
            <insite:Button runat="server" ID="CollapseAllButton" ButtonStyle="OutlineSecondary" CssClass="btn-bg-white" Icon="fas fa-fw fa-chevron-up" Text="Collapse All" />
