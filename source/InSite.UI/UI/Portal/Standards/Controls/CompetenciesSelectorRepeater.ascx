<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompetenciesSelectorRepeater.ascx.cs" Inherits="InSite.UI.Portal.Standards.Controls.CompetenciesSelectorRepeater" %>
            ...
            <div>
                <div>
                    <div class="node-title">
                        ...
                        <span class='text'>
                            <%# Eval("TypeIcon") != null ? Eval("TypeIcon", "<i class='align-middle fa-fw {0}'></i>") : null %>
                        ...
                        <span runat="server" Visible='<%# !(bool)(Eval("HasChildren")) %>'>
                            <a href="#" data-action="connection-info" data-id="<%# Eval("Key") %>"><i class="far fa-search"></i></a>
                        </span>
                    </div>
                </div>
            </div>
