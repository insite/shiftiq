...
namespace InSite.UI.Portal.Standards.Controls
{
    public partial class AnalysisInputsCareerMap : BaseUserControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Translate(BenchmarkType);
            Translate(ComparisonType);
        }
        ...
        {
            selector.Filter.DocumentType = !string.IsNullOrEmpty(type) ? new[] { type } : new[] { DocumentType.NationalOccupationStandard, DocumentType.OccupationProfile };
            selector.Value = null;

            if (anotherSelector.Filter.Exclusions.StandardIdentifier.Count > 0)
            {
        ...
        private void AnalyzeButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Title = $"{Translate("Career Map for")} {GetTitle(benchmark)}",
