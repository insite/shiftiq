...
<asp:Content runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <div runat="server" id="ButtonPanel" class="row mb-4">
        <div class="col-lg-12">
            <insite:Button runat="server" id="BackToAnalysis" Icon="far fa-fw fa-arrow-turn-left" Text="Job Comparison Tool" ButtonStyle="Success" Visible="false"/>
                        ...
                        <div>
                            <asp:Repeater runat="server" ID="RelatedStandardRepeater">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td style="width:40px;">
                                            <%# (ConnectionDirection)Eval("Direction") == ConnectionDirection.Incoming ? "<i title='Parent' class='fas fa-fw fa-level-up-alt'></i>" : "<i title='Child' class='fas fa-fw fa-level-down-alt'></i>" %>
                                        </td>
                                        <td>
                                            <a href="/ui/portal/standards/documents/outline?standard=<%# Eval("Identifier") %>"><%# Eval("Title") %></a>
                                        </td>
                                        <td style="text-align:right;width:40px;">
                                            <insite:Button runat="server" ID="DeleteRelationshipButton" ToolTip="Delete Relationship" CommandName="Delete" Icon="far fa-fw fa-trash-alt"
