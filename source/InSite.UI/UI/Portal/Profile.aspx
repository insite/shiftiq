    ...
    <insite:Nav runat="server">
        <insite:NavItem runat="server" ID="AccountSection" Icon="far fa-user" Title="My Account">
            ...
            <div class="mb-3">
                ...
                <insite:Button runat="server" ID="ChangePasswordButtonTop" Text="Change Password" ButtonStyle="Default" Icon="fas fa-fw fa-sync" CausesValidation="false" />
                <insite:Button runat="server" ID="MFAButtonTop" Text="Multi-Factor Authentication" ButtonStyle="Default" Icon="fas fa-fw fa-shield" CausesValidation="false" />
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div runat="server" id="SeekingEmploymentPanel" class="card border-0 shadow mb-4">
                        <div class="card-body">

                            <h5 class="card-title">
                                <insite:Literal runat="server" Text="Employment Interest" />
                            </h5>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-text">In what occupation are you seeking employment?</div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-text">I accept that my resume, work experience survey, and (if applicable) competency assessment results may be shared with interested employers.</div>
                            </div>
