        ...
        <div class="card-body">
            <div class="text-end mb-3">
                <div class="d-md-inline-block mb-2 mb-md-0">
                    <button type="button" data-action="save-filter" class="btn btn-success btn-sm"><i class="far fa-cloud-upload fa-fw me-1"></i>Save</button>
                    <button type="button" data-action="load-filter" class="btn btn-default btn-sm"><i class="far fa-folder-open fa-fw me-1"></i>Load</button>
                    <button type="button" data-action="download-csv" class="btn btn-default btn-sm"><i class="fa fa-download fa-fw me-1"></i>CSV</button>
                    <button type="button" data-action="download-png" class="btn btn-default btn-sm"><i class="fa fa-download fa-fw me-1"></i>PNG</button>
                </div>
                <div class="d-md-inline-block">
                    <button type="button" data-action="toggle-legend" class="btn btn-default btn-sm">Legend</button>
                    <a href="/ui/portal/home" class="btn btn-sm btn-primary"><i class="fas fa-fw fa-home me-1"></i> Portal Home</a>
                </div>
            ...
            $(document).ready(function () {
                ...
                function updateToggleLegend() {
                    if (chartConfig.options.plugins.legend.display) {
                        $toggleLegendButton.html('<i class="far fa-eye-slash fa-fw me-1"></i> Hide Legend');
                    } else {
                        $toggleLegendButton.html('<i class="far fa-eye fa-fw me-1"></i> Show Legend');
                    }
                }
                                ...
                                if (!result.data || result.data.length === 0) {
                                    ...
                                    for (let i = 0; i < result.data.length; i++) {
                                        ...
                                        for (let j = 0; j < group.items.length; j++) {
                                            ...
                                            const $deleteCommand = $('<a href="#delete" title="Delete"><i class="far fa-trash-alt fa-fw"></i></a>');
                                            ...
                                            $table.append(
                                                $('<tr>').data('id', item.id).append(
                                                    ...
                                                    $('<td class="cmd">').append(
                                                        $('<a title="Open"><i class="far fa-folder-open fa-fw"></i></a>').attr('href', '?filter=' + item.id),
                                                        $deleteCommand
                                                    )
                                                )
                                            );
