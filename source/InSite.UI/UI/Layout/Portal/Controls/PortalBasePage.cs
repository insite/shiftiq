...
namespace InSite.UI.Layout.Portal
{
    public class PortalBasePage : Lobby.LobbyBasePage
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (ActionModel != null)
                HelpTopic = HelpTopics.FindTopicByContentActionId(ActionModel.ActionIdentifier)
                    ?? HelpTopics.FindTopicByUrl(ActionModel.HelpUrl);
        ...
        private void RequireAuthentication()
        {
            ...
            if (!Request.RawUrl.StartsWith("/ui/lobby/")
                && !Request.RawUrl.StartsWith("/ui/survey/respond/"))
            {
