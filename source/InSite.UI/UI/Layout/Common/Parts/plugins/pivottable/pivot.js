            ...
            try {
                ...
                fn1 = function (attr) {
                    ...
                    triangleLink = $("<span>").addClass('pvtTriangle').html(" &#x25BE;").bind("click", function (e) {
                        ...
                        var tableOffset = $target.offsetParent().offsetParent().offset();
                        ...
                        if ((targetOffset.top + 25 + valueList.height()) > $(document).height()) {
                            cssObj.left = targetOffset.left - tableOffset.left;
                            cssObj.top = targetOffset.top - tableOffset.top - valueList.height();
                        } else {
                            cssObj.left = targetOffset.left - tableOffset.left;
                            cssObj.top = targetOffset.top - tableOffset.top + 25;
                        }

                        return valueList.css(cssObj).trigger('pvt.filterbox.shown');
                    });
