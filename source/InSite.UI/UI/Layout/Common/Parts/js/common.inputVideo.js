    ...
    class InputVideoState extends inSite.common.inputMedia.BaseState {
        ...
        #updateButtons() {
            ...
            if (isStopped || isCameraWaiting || isCameraPlaying)
                startIcon.className = 'fas fa-fw fa-circle';
            else if (isWaiting)
                startIcon.className = 'fas fa-fw fa-spinner fa-pulse';
            else if (isUploading)
                startIcon.className = 'fas fa-fw fa-upload fa-fade';
            else
                startIcon.className = 'fas fa-fw fa-stop';

            if (pause != null) {
                pause.disabled = !isPaused && !isRecording || this.#disabledButton[buttonId.playPause] == true;

                if (isPaused)
                    pauseIcon.className = 'fas fa-fw fa-play';
                else
                    pauseIcon.className = 'fas fa-fw fa-pause';
            }
            ...
            if (cameraButton) {
                ...
                if (isCameraWaiting)
                    cameraIcon.className = 'fas fa-fw fa-spinner fa-pulse';
                else if (isCameraPlaying)
                    cameraIcon.className = 'fa-fw far fa-camera-web-slash';
                else
                    cameraIcon.className = 'fa-fw far fa-camera-web';
            }
        }
