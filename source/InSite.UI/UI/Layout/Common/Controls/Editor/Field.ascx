...
<div class="form-group mb-3 content-field" id="<%= ClientID %>">
    <div class="commands">
        ...
        <insite:Button runat="server" ID="RequestTranslationButton" ButtonStyle="Primary" Size="ExtraSmall" ToolTip="Request Google Translation" Icon="fas fa-fw fa-globe" />
    </div>
    ...
    <script type="text/javascript">
        ...
        (function () {
                    ...
                    ensureInited = function () {
                        ...
                        $textInput.summernote({
                            ...
                            cleaner: {
                                action: 'button',
                                newline: '<br>',
                                icon: '<i class="fas fa-fw fa-sparkles"></i>',
                                keepHtml: true,
            ...
            function initFileUpload($text, $state) {
                ...
                var $loadingMessage = $('<div class="loading-panel content-field-loadingmessage"><div><div><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i></div></div></div>');
