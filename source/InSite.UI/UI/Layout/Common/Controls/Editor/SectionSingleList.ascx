<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SectionSingleList.ascx.cs" Inherits="InSite.UI.Layout.Common.Controls.Editor.SectionSingleList" %>
...
<insite:UpdatePanel runat="server" ID="UpdatePanel">
    <ContentTemplate>
        <asp:Repeater runat="server" ID="Repeater">
            <ItemTemplate>
                <insite:Button runat="server" ID="DeleteButton" CommandName="Delete" ButtonStyle="Danger" Size="ExtraSmall" Icon="fas fa-fw fa-trash-alt" />
