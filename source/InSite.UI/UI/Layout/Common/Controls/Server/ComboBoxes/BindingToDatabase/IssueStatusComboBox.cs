...
namespace InSite.Common.Web.UI
{
    public class IssueStatusComboBox : ComboBox
    {
        ...
        {
            List<TCaseStatus> items = new List<TCaseStatus>();
            if (StatusCategory.HasNoValue())
                items = ServiceLocator.IssueSearch.GetStatuses(org.Identifier, IssueType);
            else
                items = ServiceLocator.IssueSearch.GetStatuses(org.Identifier, IssueType, StatusCategory);
