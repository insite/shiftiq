...
namespace InSite.Common.Web.UI
{
    public partial class BaseUserControl : UserControl
    {
        ...
        protected string GetEmbededHelpContent(string fragment = null)
        {
            ...
            var help = new Shift.Sdk.UI.Help.EmbeddedHelp(Organization.PlatformCustomization.EmbeddedHelpContentUrl);

            var html = Shift.Common.TaskRunner.RunSync(help.GetContentAsync, path);
