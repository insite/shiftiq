        ...
        <nav class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li runat="server" id="RecentMenu" class="nav-item dropdown fs-sm">
                    <a runat="server" id="RecentAnchor" href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i class="fa-regular fa-circle-bookmark me-2"></i>Recent</a>
                    <insite:RecentLinkCache runat="server" ID="RecentLinks" />
                </li>

                <li class="nav-item fs-sm">
                    <a runat="server" id="PortalAnchor" class="nav-link" href="/ui/portal/home"><i class="fa-regular fa-chalkboard-user me-2"></i>Portal</a>
                </li>
                ...
                <li runat="server" id="AdminMenu" class="nav-item dropdown fs-sm">
                    ...
                    <a runat="server" id="AdminMenuAnchor" href="#" class="nav-link dropdown-toggle"
                        data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i class="fa-fw far fa-grid-round me-1"></i>Admin</a>
                        ...
                        <div class="d-lg-flex">
                            <div class="mega-dropdown-column pt-1 pt-lg-3 pb-lg-4">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li><a runat="server" id="AdminHomeLink" class="dropdown-item" href="/ui/admin/home"><i class="me-1 fa-fw far fa-grid-round"></i>Toolkits (Apps)</a></li>
                ...
                <li class="nav-item dropdown fs-sm">
                    ...
                    <a runat="server" id="HelpMenuAnchor" href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i class="fa-regular fa-question-circle me-2"></i>Help</a>
            ...
            <div class="admin-simplebar-content">
                ...
                <nav class="widget-nav nav nav-light flex-column hide-compact" style="margin-top: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.13) !important">
                    <div class="text-body-secondary fs-sm mt-3">
                        <div class="mb-1"><i class="fa-fw far fa-stopwatch me-2"></i>Session <span runat="server" id="SessionTimer" class="sessionTimer"></span></div>
                        <div class="mb-1"><i class="fa-fw far fa-weight-hanging me-2"></i><asp:Label runat="server" ID="PageSizeLiteral" ViewStateMode="Disabled" /> <asp:Label runat="server" ID="CreateTimeLiteral" ViewStateMode="Disabled" /></div>
                        <div class="mb-1"><i class="fa-fw far fa-network-wired me-2"></i><%= Page.Request.UserHostAddress %></div>
                        <div class="mb-1"><i class="fa-fw far fa-code-commit me-2"></i><asp:Literal runat="server" ID="ReleaseVersion" /></div>
                    </div>
                </nav>
