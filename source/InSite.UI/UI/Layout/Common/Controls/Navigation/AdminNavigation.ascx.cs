...
namespace InSite.UI.Layout.Admin
{
    public partial class AdminNavigation : AdminBaseControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (sidebar?.Home != null)
            {
                ...
                var icon = home.Image.IsNotEmpty() && IsUrlValid(home.Image)
                    ? $"<img style='width:24px; max-height:24px; border-radius: 4px;' class='me-2' src='{HttpUtility.UrlPathEncode(home.Image)}' />"
        ...
        private void BindUser()
        {
            ...
            UserNameAnchor.InnerHtml = "<i class='fa-regular fa-user me-2'></i>" + User.FirstName;
        }
