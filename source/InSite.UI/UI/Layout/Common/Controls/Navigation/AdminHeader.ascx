...
<div class="form-header border-bottom">
    ...
    <nav runat="server" id="Breadcrumbs" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li runat="server" id="GoToCalendar" visible="false" class="ms-5"><a runat="server" id="Calendar" href="/ui/portal/events/calendar"><i class="fas fa-fw fal fa-calendar-alt me-1"></i>Calendar</a></li>
                ...
                <div class="btn-group" role="group" aria-label="button group with nested dropdown">
                  <div class="btn-group" role="group">
                    <span type="button" class="dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-fw fa-plus-circle me-1"></i>
