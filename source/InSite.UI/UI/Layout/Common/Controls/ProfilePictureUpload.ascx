    ...
    <div class="rounded-3">
        ...
        <div class="ps-sm-3 text-center text-sm-start mt-3">
            <button class="btn btn-outline-secondary shadow btn-sm mb-2" type="button" data-bs-toggle="collapse" data-bs-target='<%= "#" + ProfileUploadPanel.ClientID %>' aria-expanded="false" aria-controls='<%= ProfileUploadPanel.ClientID %>'>
                <i class="far fa-fw fa-edit me-2"></i>Replace
            </button>
            <insite:Button runat="server" ID="DeleteProfilePicture" ButtonStyle="OutlineDanger" Icon="far fa-fw fa-trash-alt" CssClass="btn btn-outline-danger shadow btn-sm mb-2" OnClick="DeleteButton_Click" />
