...
namespace InSite.Web.Routing
{
    public static class RoutingConfiguration
    {
        ...
        {
            Routes.MapPageRoute($"Portal/Surveys/WithIdentification/Launch", "survey/{form}/{user}", $"~/UI/Portal/surveys/respond.aspx", false, null, new RouteValueDictionary { { "form", @"^\d+$" } });
            Routes.MapPageRoute($"Portal/Surveys/WithoutIdentification/Launch", "survey/{form}", $"~/UI/Portal/surveys/respond.aspx", false, null, new RouteValueDictionary { { "form", @"^\d+$" } });

            Register($"Portal/Surveys/Search", "ui/survey/respond/search", $"~/UI/Portal/surveys/respondsearch.aspx");
            Register($"Portal/Surveys/WithIdentification", "ui/survey/respond/{verb}/{form}/{user}", $"~/UI/Portal/surveys/respond.aspx");
            Register($"Portal/Surveys/WithoutIdentification", "ui/survey/respond/{verb}/{form}", $"~/UI/Portal/surveys/respond.aspx");
            Register($"Portal/Surveys/WithResponseSession", "ui/survey/respond/{verb}", $"~/UI/Portal/surveys/respond.aspx");
        }
