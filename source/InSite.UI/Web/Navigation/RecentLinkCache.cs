    ...
    public class RecentLinkCache : Control
    {
        ...
        static public void Add(Page page)
        {
            ...
            var observers = new Dictionary<string, (string Name, string IdParam)>
            {
                ...
                { "/ui/admin/learning/programs/outline", ("Program", "id") },
                ...
                { "/ui/admin/surveys/forms/outline", ("Survey", "survey") },
                { "/ui/admin/surveys/responses/outline", ("Response", "session") },
                ...
                { "/ui/admin/jobs/candidates/edit", ("Candidate", "contact") },
                { "/ui/admin/jobs/opportunities/edit", ("Opportunity", "id") },
