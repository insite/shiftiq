    ...
    public sealed class FileStorage : IDisposable
    {
        ...
        private class TransactionInfo : IFileStorageItem
        {
            ...
            private string GetEntityFilePath() =>
                _entity == null ? null : _storage._provider.StoragePath + "\\" + _entity.UploadIdentifier + _entity.ContentType;

            private string GetModelFilePath() =>
                _storage._provider.StoragePath + "\\" + FileId + _model.Type;

            private string GetTempFilePath(string ext) =>
                $"{_storage._provider.StoragePath}\\_{FileId}_{_storage.ID}.{ext}";
