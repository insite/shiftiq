...
namespace InSite.Web.Helpers
{
    public class PortalFieldInfo
    {
        ...
        private PortalFieldInfo(string groupName, string fieldName, string title, bool isVisible, bool isRequired, bool isMasked, bool canChangeRequired = true, bool canChangeMasked = true, bool titleIsLabel = false)
        {
            GroupName = groupName;
            FieldName = fieldName;
            _title = title;
        ...
        public static readonly PortalFieldInfo[] ClassRegistration = new[]
        {
            ...
            new PortalFieldInfo("Personal", "MiddleName", "Middle Name",                   isVisible: true, isRequired: false, isMasked: false),
            new PortalFieldInfo("Personal", "LastName", "Last Name",                       isVisible: true, isRequired: true, isMasked: false, canChangeRequired: false),
            new PortalFieldInfo("Personal", "Birthdate", "Birthdate",                      isVisible: true, isRequired: true, isMasked: false, canChangeMasked : false),
            new PortalFieldInfo("Personal", "PersonCode", "Person Code",                   isVisible: true, isRequired: true, isMasked: false, titleIsLabel: true),
            new PortalFieldInfo("Personal", "WorkBasedHoursToDate", "Number of Work Based Hours to date", isVisible: true, isRequired: false, isMasked: false, canChangeMasked : false),
            new PortalFieldInfo("Personal", "FirstLanguage", "English Language Learner",   isVisible: true, isRequired: false, isMasked: false, canChangeRequired: false, canChangeMasked : false),
            new PortalFieldInfo("Address", "Street1", "Address 1",                         isVisible: true, isRequired: true, isMasked: false),
            new PortalFieldInfo("Address", "City", "City",                                 isVisible: true, isRequired: true, isMasked: false),
            new PortalFieldInfo("Address", "Country", "Country",                           isVisible: true, isRequired: true, isMasked: false, canChangeMasked : false),
            new PortalFieldInfo("Address", "Province", "Province",                         isVisible: true, isRequired: true, isMasked: false, canChangeMasked : false),
            new PortalFieldInfo("Address", "PostalCode", "Postal Code",                    isVisible: true, isRequired: true, isMasked: false),
            new PortalFieldInfo("Emergency Contact", "EmergencyContactName", "Name",       isVisible: true, isRequired: true, isMasked: false),
            new PortalFieldInfo("Emergency Contact", "EmergencyContactPhone", "Phone",     isVisible: true, isRequired: true, isMasked: false),
            new PortalFieldInfo("Emergency Contact", "EmergencyContactRelationship", "Relationship", isVisible: true, isRequired: false, isMasked: false),
            new PortalFieldInfo("Phone Numbers", "Phone", "Preferred",                     isVisible: true, isRequired: false, isMasked: false),
            new PortalFieldInfo("Phone Numbers", "PhoneHome", "Home",                      isVisible: true, isRequired: false, isMasked: false),
            new PortalFieldInfo("Phone Numbers", "PhoneWork", "Work",                      isVisible: true, isRequired: false, isMasked: false),
        ...
        public static readonly PortalFieldInfo[] LearnerDashboard = new[]
        {
            ...
            new PortalFieldInfo("Panels", "surveys", "Surveys", true, false, false)
        };
