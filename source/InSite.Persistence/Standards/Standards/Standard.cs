...
namespace InSite.Persistence
{
    ...
    public class Standard : IHasTimestamp
    {
        ...
        public Standard()
        {
            Children = new HashSet<Standard>();
            OutgoingConnections = new HashSet<StandardConnection>();
            IncomingConnections = new HashSet<StandardConnection>();
            ParentContainments = new HashSet<StandardContainment>();
            ChildContainments = new HashSet<StandardContainment>();
            Departments = new HashSet<TDepartmentStandard>();
            StandardValidations = new HashSet<StandardValidation>();
            StandardValidationChanges = new HashSet<StandardValidationChange>();
            StandardOrganizations = new HashSet<StandardOrganization>();
            DepartmentCompetencies = new HashSet<DepartmentProfileCompetency>();
