...
{
    public class VResponseFirstCommentConfiguration : EntityTypeConfiguration<VResponseFirstComment>
    {
        public VResponseFirstCommentConfiguration()
        {
            ToTable("VResponseFirstComment", "surveys");
