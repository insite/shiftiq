...
";
        ...
        public void Update(QuestionClassificationChanged e)
        {
            UpdateCursor(e, (db, bank) =>
            {
                ...
                query.QuestionTags = GetSerializedTags(e.Classification);
        ...
        private static string GetSerializedTags(QuestionClassification classification)
        {
            var tags = classification?.Tags;
            return tags != null && tags.Count > 0 ? JsonConvert.SerializeObject(tags) : null;
        }
        ...
        private static void BindQuestionQuery(InternalDbContext db, QBankQuestion query, BankState bank, Guid set, Question question)
        {
            ...
            query.QuestionTags = GetSerializedTags(question.Classification);
        ...
        private static void BindLikertRowQuery(QBankQuestion query, LikertRow row)
        {
            ...
            query.QuestionTags = GetSerializedTags(q.Classification);
