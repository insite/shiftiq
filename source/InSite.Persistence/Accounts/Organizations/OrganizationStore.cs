...
namespace InSite.Persistence
{
    public class OrganizationStore : IOrganizationStore
    {
        ...
        public void Update(OrganizationLogbookSettingsModified e) => UpdateOrganization(e, (entity, state) => { });
        ...
        public void Update(OrganizationIdentificationModified e) => UpdateOrganization(e, (entity, state) =>
        {
            ...
            entity.CustomerNumber = state.CustomerNumber.MaxLength(30);
            entity.CustomerCode = state.CustomerCode.MaxLength(30);
        });
