...
namespace InSite.Persistence
{
    public class QOrganizationConfiguration : EntityTypeConfiguration<QOrganization>
    {
        public QOrganizationConfiguration()
        {
            ...
            Property(x => x.CompanyName).IsRequired().IsUnicode(false).HasMaxLength(50);
            ...
            Property(x => x.CustomerCode).IsUnicode(false).HasMaxLength(30);
            Property(x => x.CustomerNumber).IsUnicode(false).HasMaxLength(30);
            Property(x => x.OrganizationCode).IsRequired().IsUnicode(false).HasMaxLength(30);
