...
namespace InSite
{
    internal class TimelineRegistry
    {
        ...
        static GuidCache<SnapshotRepository.CachedAggregate> _cachedAggregateCache;
        ...
        internal static void Initialize(Shift.Common.IJsonSerializer serializer)
        {
            ...
            _cachedAggregateCache = new GuidCache<SnapshotRepository.CachedAggregate>();
            ...
            TimelineServices.ServiceLocator.Instance.Register<TimelineServices.IGuidCache<SnapshotRepository.CachedAggregate>>(_cachedAggregateCache);
        }
    }
}
