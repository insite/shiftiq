...
namespace InSite.Persistence
{
    ...
    internal class InternalDbContext : DbContext
    {
        ...
        public DbSet<QSurveyRespondent> QSurveyRespondents { get; set; }
        ...
        public DbSet<TCourseUser> TCourseUsers { get; set; }
        ...
        public DbSet<TUnit> TUnits { get; set; }
        ...
        public static void AddConfigurations(DbModelBuilder builder)
        {
            ...
            builder.Configurations.Add(new QSurveyRespondentConfiguration());
            ...
            builder.Configurations.Add(new TCourseConfiguration());
            builder.Configurations.Add(new TCourseUserConfiguration());
            ...
            builder.Configurations.Add(new TUnitConfiguration());
