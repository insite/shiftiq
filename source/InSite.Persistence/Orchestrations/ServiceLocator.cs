...
namespace InSite
{
    public static class ServiceLocator
    {
        ...
        public static void InitializeAppSettings(AppSettings settings, StartupRequirements requirements, bool disableCertificateValidation = true, Func<IPartitionModel> partitionFactory = null)
        {
            ...
            Shift.Common.SubdomainConvention.Current = string.IsNullOrEmpty(settings.Application.SubdomainConvention)
                ? Shift.Common.SubdomainConvention.Shift
                : settings.Application.SubdomainConvention;
