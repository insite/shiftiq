...
{
    public class BillableUserSummaryConfiguration : EntityTypeConfiguration<BillableUserSummary>
    {
        public BillableUserSummaryConfiguration() : this("custom_cmds") { }

        public BillableUserSummaryConfiguration(string schema)
        {
            ToTable(schema + ".BillableUserSummary");
            ...
            Property(x => x.CompanyCount).IsOptional();
