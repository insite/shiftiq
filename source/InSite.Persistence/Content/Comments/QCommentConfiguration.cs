...
{
    public class QCommentConfiguration : EntityTypeConfiguration<QComment>
    {
        public QCommentConfiguration() : this("assets") { }

        public QCommentConfiguration(string schema)
        {
            ToTable(schema + ".QComment");
            ...
            Property(x => x.CommentPosted).IsOptional();
            ...
            Property(x => x.OriginText).IsOptional().IsUnicode(false).HasMaxLength(1200);
