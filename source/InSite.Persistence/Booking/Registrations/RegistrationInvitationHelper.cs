...
namespace InSite.Persistence
{
    public static class RegistrationInvitationHelper
    {
            ...
            )
        {
            ...
            send(new ChangeApproval(registration.RegistrationIdentifier, "Invitation Sent", null, null, registration.ApprovalStatus));
            ...
            )
        {
            ...
            foreach (var registration in registrations)
            {
                ...
                var command = new ChangeApproval(registration.RegistrationIdentifier, "Waitlisted", null, null, registration.ApprovalStatus);
                send(command);
        ...
        private static void SendInvitationExpiredAlert(string domain, EnvironmentModel environment, IAlertMailer mailer, QRegistration registration)
        {
            var classRegistrationLink = UrlHelper.GetAbsoluteUrl(
                ...
                OrganizationSearch.Select(registration.OrganizationIdentifier).OrganizationCode
            );
