...
";
        ...
        public void UpdateRecord(GradebookLocked c)
        {
            ...
            {
                x.IsLocked = true;
                x.GradebookLocked = c.ChangeTime;
            });
        }
        ...
        public void UpdateItem(GradeItemAchievementChanged2 c)
        {
            Update(c, (x, db) => { });
            ...
            using (var db = CreateContext())
            {
                ...
                if (item != null)
                {
                    ...
                    item.AchievementWhenPassCommand = c.Achievement?.WhenPassCommand.ToString();
                    item.AchievementWhenFailCommand = c.Achievement?.WhenFailCommand.ToString();
