...
namespace InSite.Persistence
{
    public class QGradeItemConfiguration : EntityTypeConfiguration<QGradeItem>
    {
        ...
        public QGradeItemConfiguration(string schema)
        {
            ...
            Property(x => x.AchievementWhenFailCommand).IsOptional().IsUnicode(false).HasMaxLength(20);
            Property(x => x.AchievementWhenPassCommand).IsOptional().IsUnicode(false).HasMaxLength(20);
