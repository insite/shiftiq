...
namespace InSite.Persistence
{
    public class TEntityConfiguration : EntityTypeConfiguration<TEntity>
    {
        public TEntityConfiguration()
        {
            ...
            Property(x => x.SubsystemType).IsRequired().IsUnicode(false).HasMaxLength(20);
            Property(x => x.SubsystemName).IsRequired().IsUnicode(false).HasMaxLength(30);
            Property(x => x.SubsystemComponent).IsRequired().IsUnicode(false).HasMaxLength(40);
