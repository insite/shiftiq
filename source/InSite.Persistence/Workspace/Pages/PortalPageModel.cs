...
namespace InSite.Persistence.Content
{
    public class PortalPageModel
    {
        ...
        {
            var icon = Icon ?? "far fa-book-alt fa-fw";
            var html = $"<i class='{icon} fa-fw text-body-secondary mt-2 me-2'></i>";

            if (Progress == "Launched")
                html = "<i class='far fa-check fa-fw text-success mt-2 me-2' title='Launched'></i>";

            else if (Progress == "Started")
                html = "<i class='far fa-hourglass fa-fw text-info mt-2 me-2' title='Started'></i>";

            else if (Progress == "Completed")
                html = "<i class='far fa-check fa-fw text-success mt-2 me-2' title='Completed'></i>";
